...
public partial class alglib
{
    public partial class apserv
    {
        ...
        *************************************************************************/
        public class squantilecounter : apobject
        {
            ...
            public override apobject make_copy()
            {
                var _result = new squantilecounter();
                _result.cnt = cnt;
        ...
        *************************************************************************/
        public static void seterrorflagdiff(ref bool flag, double val, double refval, double tol, double s, xparams _params)
        {
            ap.seterrorflag(ref flag, Math.Abs(val - refval) > tol * Math.Max(Math.Abs(refval), s), "apserv.ap:206");
        }
        ...
        *************************************************************************/
        ...
        variables).
          ...
          -- ALGLIB --
             Copyright 17.09.2012 by Bochkanov Sergey
        *************************************************************************/
        public static void touchboolean(ref bool a, xparams _params)
        {
        }
        ...
        variables).
          ...
          -- ALGLIB --
             Copyright 17.09.2012 by Bochkanov Sergey
        *************************************************************************/
        public static void touchint(ref int a, xparams _params)
        {
        }
        ...
        variables).
          ...
          -- ALGLIB --
             Copyright 17.09.2012 by Bochkanov Sergey
        *************************************************************************/
        public static void touchreal(ref double a, xparams _params)
        {
        }
        ...
        *************************************************************************/
        public static double coalesce(double a, double b, xparams _params)
        {
            double result = 0;
        ...
        NOTE: no check is performed for B<>0
          ...
          -- ALGLIB --
             Copyright 18.05.2015 by Bochkanov Sergey
        *************************************************************************/
        public static int coalescei(int a, int b, xparams _params)
        {
            var result = 0;
        ...
        The function convert integer value to real value.
          ...
          -- ALGLIB --
             Copyright 17.09.2012 by Bochkanov Sergey
        *************************************************************************/
        public static double inttoreal(int a, xparams _params)
        {
            double result = 0;
        ...
        NOTE: it costs twice as much as Ln(x)
          ...
          -- ALGLIB --
             Copyright 17.09.2012 by Bochkanov Sergey
        *************************************************************************/
        public static double logbase2(double x, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static bool approxequal(double a, double b, double tol, xparams _params)
        {
            var result = new bool();

            result = Math.Abs(a - b) <= tol;
            return result;
        }
        ...
        to errors as large as max(|a|,|b|)*tol.
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static bool approxequalrel(double a, double b, double tol, xparams _params)
        {
            var result = new bool();

            result = Math.Abs(a - b) <= Math.Max(Math.Abs(a), Math.Abs(b)) * tol;
            return result;
        }
        ...
        If N=1 then suborutine generates only one point at the middle of [A,B]
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void taskgenint1d(double a, double b, int n, ref double[] x, ref double[] y, xparams _params)
        {
            var i = 0;
            double h = 0;
        ...
        If N=1 then suborutine generates only one point at the middle of [A,B]
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void taskgenint1dequidist(double a, double b, int n, ref double[] x, ref double[] y, xparams _params)
        {
            var i = 0;
            double h = 0;
        ...
        If N=1 then suborutine generates only one point at the middle of [A,B]
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void taskgenint1dcheb1(double a, double b, int n, ref double[] x, ref double[] y, xparams _params)
        {
            var i = 0;
        ...
        If N=1 then suborutine generates only one point at the middle of [A,B]
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void taskgenint1dcheb2(double a, double b, int n, ref double[] x, ref double[] y, xparams _params)
        {
            var i = 0;
        ...
        * only at this stage actual comparison is done
        ...
        NOTE:
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static bool aredistinct(double[] x, int n, xparams _params)
        {
            var result = new bool();
            double a = 0;
            double b = 0;
        ...
        or both are False).
          ...
          -- ALGLIB --
             Copyright 02.12.2009 by Bochkanov Sergey
        *************************************************************************/
        public static bool aresameboolean(bool v1, bool v2, xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        public static void setlengthzero(ref double[] x, int n, xparams _params)
        {
            var i = 0;
        ...
        If Length(X)<N, resizes X
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void bvectorsetlengthatleast(ref bool[] x, int n, xparams _params)
        {
            if (ap.len(x) < n) x = new bool[n];
        }
        ...
        If Length(X)<N, resizes X
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void ivectorsetlengthatleast(ref int[] x, int n, xparams _params)
        {
            if (ap.len(x) < n) x = new int[n];
        }
        ...
        If Length(X)<N, resizes X
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rvectorsetlengthatleast(ref double[] x, int n, xparams _params)
        {
            if (ap.len(x) < n) x = new double[n];
        }
        ...
        If Cols(X)<N or Rows(X)<M, resizes X
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixsetlengthatleast(ref double[,] x, int m, int n, xparams _params)
        {
            if (m > 0 && n > 0)
        ...
        If Cols(X)<N or Rows(X)<M, resizes X
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void bmatrixsetlengthatleast(ref bool[,] x, int m, int n, xparams _params)
        {
            if (m > 0 && n > 0)
                if (ap.rows(x) < m || ap.cols(x) < n)
                    x = new bool[m, n];
        ...
        c) new size can be larger than N, so subsequent grow() calls can return
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void bvectorgrowto(ref bool[] x, int n, xparams _params)
        {
            var oldx = new bool[0];
            var i = 0;
            var n2 = 0;
        ...
        c) new size can be larger than N, so subsequent grow() calls can return
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void ivectorgrowto(ref int[] x, int n, xparams _params)
        {
            var oldx = new int[0];
            var i = 0;
            var n2 = 0;
        ...
        d) new matrix has at least MinCols columns (if less than specified amount
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixgrowrowsto(ref double[,] a, int n, int mincols, xparams _params)
        {
            ...
            // Enough place?
            //
            if (ap.rows(a) >= n && ap.cols(a) >= mincols) return;

            //
            // Sizes and metrics
            //
            if (ap.rows(a) < n) n = Math.Max(n, (int)Math.Round(1.8 * ap.rows(a) + 1));
        ...
        d) new matrix has at least MinRows row (if less than specified amount
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixgrowcolsto(ref double[,] a, int n, int minrows, xparams _params)
        {
            var olda = new double[0, 0];
            var i = 0;
            var j = 0;
            ...
            // Enough place?
            //
            if (ap.cols(a) >= n && ap.rows(a) >= minrows) return;

            //
            // Sizes and metrics
            //
            if (ap.cols(a) < n) n = Math.Max(n, (int)Math.Round(1.8 * ap.cols(a) + 1));
        ...
        c) new size can be larger than N, so subsequent grow() calls can return
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rvectorgrowto(ref double[] x, int n, xparams _params)
        {
        ...
        * fills new elements by zeros
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void ivectorresize(ref int[] x, int n, xparams _params)
        {
            var oldx = new int[0];
            var i = 0;
            var n2 = 0;
        ...
        * fills new elements by zeros
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rvectorresize(ref double[] x, int n, xparams _params)
        {
            var oldx = new double[0];
            var i = 0;
            var n2 = 0;
        ...
        * fills new elements by zeros
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixresize(ref double[,] x, int m, int n, xparams _params)
        {
        ...
        * fills new elements by zeros
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void imatrixresize(ref int[,] x, int m, int n, xparams _params)
        {
        ...
        appends element to X
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void ivectorappend(ref int[] x, int v, xparams _params)
        {
            var oldx = new int[0];
            var i = 0;
            var n = 0;
        ...
        *************************************************************************/
        public static bool isfinitevector(double[] x, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
            double v = 0;
            ...
            v = 0;
            for (i = 0; i <= n - 1; i++) v = 1 + 0.01 * v + x[i];
        ...
        X[] are finite or NANs
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool isfiniteornanvector(double[] x, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
            double v = 0;
        ...
        This function checks that first N values from X[] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool isfinitecvector(complex[] z, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
        ...
        X[0..M-1,0..N-1] are finite.
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool apservisfinitematrix(double[,] x, int m, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j = 0;
        ...
        This function checks that all values from X[0..M-1,0..N-1] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool apservisfinitecmatrix(complex[,] x, int m, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j = 0;
        ...
        This function checks that all values from X[0..M-1,0..N-1] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool isfinitecmatrix(complex[,] x, int m, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j = 0;
        ...
        upper/lower triangle of X[0..N-1,0..N-1] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool isfinitertrmatrix(double[,] x, int n, bool isupper, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j1 = 0;
        ...
        X[0..N-1,0..N-1] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool apservisfinitectrmatrix(complex[,] x, int n, bool isupper, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j1 = 0;
        ...
        X[0..N-1,0..N-1] are finite
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool isfinitectrmatrix(complex[,] x, int n, bool isupper, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j1 = 0;
        ...
        NaN's.
          ...
          -- ALGLIB --
             Copyright 18.06.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool apservisfiniteornanmatrix(double[,] x, int m, int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var j = 0;
        ...
        *************************************************************************/
        public static double safepythag2(double x, double y, xparams _params)
        {
            double result = 0;
            double w = 0;
            double xabs = 0;
        ...
        Safe sqrt(x^2+y^2)
          ...
          -- ALGLIB --
             Copyright by Bochkanov Sergey
        *************************************************************************/
        public static double safepythag3(double x, double y, double z, xparams _params)
        {
            double result = 0;
            double w = 0;
        ...
        * -1, if 0<abs(X/Y)<MinRealNumber - underflow-like situation
        ...
        No overflow is generated in any case.
          ...
          -- ALGLIB --
             Copyright by Bochkanov Sergey
        *************************************************************************/
        public static int saferdiv(double x, double y, ref double r, xparams _params)
        {
            var result = 0;
            ...
            if (y == 0)
            {
                ...
                if (x > 0) r = double.PositiveInfinity;

                if (x < 0) r = double.NegativeInfinity;
            ...
            {
                r = x / y;
                if (Math.Abs(r) <= math.minrealnumber)
                {
                    result = -1;
                    r = 0;
                }
            ...
            {
                if (Math.Abs(x) >= math.maxrealnumber * y)
                {
                    if (x > 0)
        ...
        No overflow is generated in any case.
          ...
          -- ALGLIB --
             Copyright by Bochkanov Sergey
        *************************************************************************/
        public static double safeminposrv(double x, double y, double v, xparams _params)
        {
            double result = 0;
            double r = 0;
        ...
        * T replaces X
          ...
          -- ALGLIB --
             Copyright by Bochkanov Sergey
        *************************************************************************/
        public static void apperiodicmap(ref double x, double a, double b, ref double k, xparams _params)
        {
            k = 0;

            ap.assert(a < b, "APPeriodicMap: internal error!");
        ...
        *************************************************************************/
        ...
        Reallocates array if its size is too short.
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void randomunit(int n, ref double[] x, xparams _params)
        {
            var i = 0;
            double v = 0;
            double vv = 0;
        ...
        *************************************************************************/
        public static void swapi(ref int v0, ref int v1, xparams _params)
        {
            var v = 0;
        ...
        *************************************************************************/
        public static void swapr(ref double v0, ref double v1, xparams _params)
        {
            double v = 0;
        ...
        *************************************************************************/
        public static void swaprows(double[,] a, int i0, int i1, int ncols, xparams _params)
        {
            var j = 0;
            double v = 0;
        ...
        determined from the matrix size.
        *************************************************************************/
        public static void swapcols(double[,] a, int j0, int j1, int nrows, xparams _params)
        {
            var i = 0;
            double v = 0;
        ...
        *************************************************************************/
        public static void swapentries(double[] a, int i0, int i1, int entrywidth, xparams _params)
        {
            var offs0 = 0;
            var offs1 = 0;
            var j = 0;
        ...
        from D-element entries
        *************************************************************************/
        public static void swapentriesb(bool[] a, int i0, int i1, int entrywidth, xparams _params)
        {
            var offs0 = 0;
            var offs1 = 0;
            var j = 0;
        ...
        *************************************************************************/
        public static void swapelements(double[] a, int i0, int i1, xparams _params)
        {
            double v = 0;
        ...
        This function is used to swap two elements of the vector
        *************************************************************************/
        public static void swapelementsi(int[] a, int i0, int i1, xparams _params)
        {
            var v = 0;
        ...
        *************************************************************************/
        public static double maxreal3(double v0, double v1, double v2, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static void inc(ref int v, xparams _params)
        {
            v = v + 1;
        }
        ...
        *************************************************************************/
        public static void dec(ref int v, xparams _params)
        {
            v = v - 1;
        }
        ...
        correctness)
        *************************************************************************/
        public static void threadunsafeinc(ref int v, xparams _params)
        {
            v = v + 1;
        }
        ...
        correctness)
        *************************************************************************/
        public static void threadunsafeincby(ref int v, int k, xparams _params)
        {
            v = v + k;
        }
        ...
        *************************************************************************/
        public static void threadunsafeset(ref int v, int x, xparams _params)
        {
            v = x;
        }
        ...
        correctness), although the library may try to use safe options, if available.
        *************************************************************************/
        public static int threadunsafeget(ref int v, xparams _params)
        {
            var result = 0;
        ...
        correctness)
        *************************************************************************/
        public static void rthreadunsafeincby(ref double v, double x, xparams _params)
        {
            v = v + x;
        }
        ...
        correctness), although the library may try to use safe options, if available.
        *************************************************************************/
        public static void rthreadunsafeset(ref double v, double x, xparams _params)
        {
            v = x;
        }
        ...
        correctness), although the library may try to use safe options, if available.
        *************************************************************************/
        public static double rthreadunsafeget(ref double v, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static int weakatomicfetchadd(ref int v, int n, xparams _params)
        {
            var result = 0;
            var provisional = 0;
            ...
            {
                provisional = v;
                result = Interlocked.CompareExchange(ref v, provisional + n, provisional);
                if (result == provisional) return result;
            }
        ...
        *************************************************************************/
        public static void weakatomicacquirelock(ref int v, int expected, int newval, xparams _params)
        {
            while (true)
            {
                while (Thread.VolatileRead(ref v) != expected)
                {
                }

                if (Interlocked.CompareExchange(ref v, newval, expected) == expected) return;
            }
        }
        ...
        Atomicity is guaranteed on C# targets and on C++ targets with AE_OS #defined.
        *************************************************************************/
        public static void weakatomicacquirelockv(int[] v, int idx, int expected, int newval, xparams _params)
        {
            while (true)
            {
                while (Thread.VolatileRead(ref v[idx]) != expected)
                {
                }

                if (Interlocked.CompareExchange(ref v[idx], newval, expected) == expected) return;
            }
        }
        ...
        *************************************************************************/
        public static void weakatomicwaitforv(int[] v, int idx, int expected, int waitfor, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= waitfor - 1; i++)
                if (Thread.VolatileRead(ref v[idx]) == expected)
                    return;
        }
        ...
        *************************************************************************/
        public static void countdown(ref int v, xparams _params)
        {
            if (v > 0)
                v = v - 1;
            else
        ...
        *************************************************************************/
        public static double possign(double x, xparams _params)
        {
            double result = 0;
        ...
        x=0 results in +1 being returned.
        *************************************************************************/
        public static int ipossign(double x, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static double rmul2(double v0, double v1, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static double rmul3(double v0, double v1, double v2, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static double rmul4(double v0, double v1, double v2, double v3, xparams _params)
        {
            double result = 0;
        ...
        does not check it.
        *************************************************************************/
        public static int idivup(int a, int b, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static int imin2(int i0, int i1, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static int imin3(int i0, int i1, int i2, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static int imin4(int i0, int i1, int i2, int i3, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static int imax2(int i0, int i1, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static int imax3(int i0, int i1, int i2, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static int imax4(int i0, int i1, int i2, int i3, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static double rmax3(double r0, double r1, double r2, xparams _params)
        {
            double result = 0;
        ...
        This function returns max(|r0|,|r1|,|r2|)
        *************************************************************************/
        public static double rmaxabs2(double r0, double r1, xparams _params)
        {
            double result = 0;
        ...
        This function returns max(|r0|,|r1|,|r2|)
        *************************************************************************/
        public static double rmaxabs3(double r0, double r1, double r2, xparams _params)
        {
            double result = 0;
        ...
        'bounds' value: maps X to [B1,B2]
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static double boundval(double x, double b1, double b2, xparams _params)
        {
            double result = 0;
        ...
        'bounds' value: maps X to [B1,B2]
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static int iboundval(int x, int b1, int b2, xparams _params)
        {
            var result = 0;
        ...
        'bounds' value: maps X to [B1,B2]
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static double rboundval(double x, double b1, double b2, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static bool bcase2(bool cond, bool v0, bool v1, xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        public static int icase2(bool cond, int v0, int v1, xparams _params)
        {
            var result = 0;
        ...
        *************************************************************************/
        public static double rcase2(bool cond, double v0, double v1, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        public static int countnz1(double[] v, int n, xparams _params)
        {
            var result = 0;
            var i = 0;
        ...
        Returns number of non-zeros
        *************************************************************************/
        public static int countnz2(double[,] v, int m, int n, xparams _params)
        {
            var result = 0;
            var i = 0;
            var j = 0;
        ...
        *************************************************************************/
        public static void alloccomplex(serializer s, complex v, xparams _params)
        {
            s.alloc_entry();
            s.alloc_entry();
        }
        ...
        *************************************************************************/
        public static void serializecomplex(serializer s, complex v, xparams _params)
        {
        ...
        *************************************************************************/
        public static complex unserializecomplex(serializer s, xparams _params)
        {
            complex result = 0;
        ...
        *************************************************************************/
        public static void allocrealarray(serializer s, double[] v, int n, xparams _params)
        {
            var i = 0;
        ...
        *************************************************************************/
        public static void allocbooleanarray(serializer s, bool[] v, int n, xparams _params)
        {
            var i = 0;
        ...
        Serialization: complex value
        *************************************************************************/
        public static void serializerealarray(serializer s, double[] v, int n, xparams _params)
        {
            var i = 0;
            ...
            s.serialize_int(n);
            for (i = 0; i <= n - 1; i++) s.serialize_double(v[i]);
        }
        ...
        *************************************************************************/
        public static void serializebooleanarray(serializer s, bool[] v, int n, xparams _params)
        {
            var i = 0;
            ...
            s.serialize_int(n);
            for (i = 0; i <= n - 1; i++) s.serialize_bool(v[i]);
        }
        ...
        Unserialization: complex value
        *************************************************************************/
        public static void unserializerealarray(serializer s, ref double[] v, xparams _params)
        {
            var n = 0;
            var i = 0;
            double t = 0;
        ...
        *************************************************************************/
        public static void unserializebooleanarray(serializer s, ref bool[] v, xparams _params)
        {
            var n = 0;
            var i = 0;
            var t = new bool();
        ...
        *************************************************************************/
        public static void allocintegerarray(serializer s, int[] v, int n, xparams _params)
        {
            var i = 0;
        ...
        *************************************************************************/
        public static void serializeintegerarray(serializer s, int[] v, int n, xparams _params)
        {
            var i = 0;
            ...
            s.serialize_int(n);
            for (i = 0; i <= n - 1; i++) s.serialize_int(v[i]);
        }
        ...
        Unserialization: complex value
        *************************************************************************/
        public static void unserializeintegerarray(serializer s, ref int[] v, xparams _params)
        {
            var n = 0;
            var i = 0;
            var t = 0;
        ...
        *************************************************************************/
        public static void allocrealmatrix(serializer s, double[,] v, int n0, int n1, xparams _params)
        {
            var i = 0;
            var j = 0;

            if (n0 < 0) n0 = ap.rows(v);

            if (n1 < 0) n1 = ap.cols(v);
        ...
        Serialization: complex value
        *************************************************************************/
        public static void serializerealmatrix(serializer s, double[,] v, int n0, int n1, xparams _params)
        {
            var i = 0;
            var j = 0;
        ...
        Unserialization: complex value
        *************************************************************************/
        public static void unserializerealmatrix(serializer s, ref double[,] v, xparams _params)
        {
            var i = 0;
            var j = 0;
            var n0 = 0;
        ...
        Copy boolean array
        *************************************************************************/
        public static void copybooleanarray(bool[] src, ref bool[] dst, xparams _params)
        {
            var i = 0;
            ...
            if (ap.len(src) > 0)
            {
                ...
                for (i = 0; i <= ap.len(src) - 1; i++) dst[i] = src[i];
            }
        }
        ...
        Copy integer array
        *************************************************************************/
        public static void copyintegerarray(int[] src, ref int[] dst, xparams _params)
        {
            var i = 0;
        ...
        Copy real array
        *************************************************************************/
        public static void copyrealarray(double[] src, ref double[] dst, xparams _params)
        {
            var i = 0;
        ...
        Copy real matrix
        *************************************************************************/
        public static void copyrealmatrix(double[,] src, ref double[,] dst, xparams _params)
        {
            var i = 0;
            var j = 0;
        ...
        *************************************************************************/
        public static void unsetintegerarray(ref int[] a, xparams _params)
        {
            a = new int[0];
        ...
        Clears real array
        *************************************************************************/
        public static void unsetrealarray(ref double[] a, xparams _params)
        {
            a = new double[0];
        ...
        Clears real matrix
        *************************************************************************/
        public static void unsetrealmatrix(ref double[,] a, xparams _params)
        {
            a = new double[0, 0];
        ...
        *************************************************************************/
        public static void tiledsplit(int tasksize, int tilesize, ref int task0, ref int task1, xparams _params)
        {
            var cc = 0;
        ...
        *************************************************************************/
        public static int ibinarysearchlft(int[] a, int i0, int i1, int v, xparams _params)
        {
            var result = 0;
            var m = 0;
        ...
        The range [I0,I1) is searched.
          ...
          -- ALGLIB --
             Copyright 11.06.2024 by Bochkanov Sergey
        *************************************************************************/
        public static int ibinarysearchexisting(int[] a, int i0, int i1, int v, xparams _params)
        {
            var result = 0;
            var ori1 = 0;
            var m = 0;
            ...
            ap.assert(i0 < ori1 && a[i0] == v, "iBinarySearchExisting: the element is not found");
            result = i0;
            return result;
        }
        ...
        The range [I0,I1) is searched.
          ...
          -- ALGLIB --
             Copyright 11.06.2024 by Bochkanov Sergey
        *************************************************************************/
        public static bool ilinearsearchispresent(int[] a, int i0, int i1, int v, xparams _params)
        {
            var result = new bool();
            var i = 0;
        ...
        The range [I0,I1) is searched.
          ...
          -- ALGLIB --
             Copyright 11.06.2024 by Bochkanov Sergey
        *************************************************************************/
        public static bool ibinarysearchispresent(int[] a, int i0, int i1, int v, xparams _params)
        {
            var result = new bool();
            var ori1 = 0;
            var m = 0;
        ...
        *************************************************************************/
        public static int recsearch(int[] a, int nrec, int nheader, int i0, int i1, int[] b, xparams _params)
        {
            var result = 0;
            var mididx = 0;
            var cflag = 0;
        ...
        * in case TaskSize is even, Task0 and Task1 are approximately TaskSize/2
          ...
          -- ALGLIB --
             Copyright 07.04.2013 by Bochkanov Sergey
        *************************************************************************/
        public static void splitlengtheven(int tasksize, ref int task0, ref int task1, xparams _params)
        {
            task0 = 0;
            task1 = 0;
        ...
        *************************************************************************/
        public static int chunkscount(int tasksize, int chunksize, xparams _params)
        {
            var result = 0;
            ...
            if (tasksize % chunksize != 0) result = result + 1;
        ...
        * in case TaskSize>ChunkSize, Task0 is always divisible by ChunkSize
          ...
          -- ALGLIB --
             Copyright 07.04.2013 by Bochkanov Sergey
        *************************************************************************/
        public static void splitlength(int tasksize, int chunksize, ref int task0, ref int task1, xparams _params)
        {
            task0 = 0;
            task1 = 0;
            ...
            task0 = tasksize / 2;
            if (task0 > chunksize && task0 % chunksize != 0) task0 = task0 - task0 % chunksize;
        ...
        *************************************************************************/
        public static void tracevectorautoprec(double[] a, int i0, int i1, xparams _params)
        {
            var i = 0;
            var prectouse = 0;
            ...
            //
            prectouse = 0;
            if (ap.istraceenabled("PREC.E15", _params)) prectouse = 1;

            if (ap.istraceenabled("PREC.F6", _params)) prectouse = 2;
            ...
            for (i = i0; i <= i1 - 1; i++)
            {
                if (prectouse == 0) ap.trace(string.Format("{0,14:E6}", a[i]));

                if (prectouse == 1) ap.trace(string.Format("{0,23:E15}", a[i]));

                if (prectouse == 2) ap.trace(string.Format("{0,13:F6}", a[i]));
        ...
        This function checks trace flags every time it is called.
        *************************************************************************/
        public static void tracerowautoprec(double[,] a, int i, int j0, int j1, xparams _params)
        {
            var j = 0;
            var prectouse = 0;
            ...
            for (j = j0; j <= j1 - 1; j++)
            {
                if (prectouse == 0) ap.trace(string.Format("{0,14:E6}", a[i, j]));

                if (prectouse == 1) ap.trace(string.Format("{0,23:E15}", a[i, j]));

                if (prectouse == 2) ap.trace(string.Format("{0,13:F6}", a[i, j]));
        ...
        *************************************************************************/
        public static void tracevectorunscaledunshiftedautoprec(double[] x, int n, double[] scl, bool applyscl, double[] sft, bool applysft,
            xparams _params)
        {
            var i = 0;
            var prectouse = 0;
            ...
            {
                v = x[i];
                if (applyscl) v = v * scl[i];

                if (applysft) v = v + sft[i];

                if (prectouse == 0) ap.trace(string.Format("{0,14:E6}", v));

                if (prectouse == 1) ap.trace(string.Format("{0,23:E15}", v));

                if (prectouse == 2) ap.trace(string.Format("{0,13:F6}", v));
        ...
        This function checks trace flags every time it is called.
        *************************************************************************/
        public static void tracerownrm1autoprec(double[,] a, int i0, int i1, int j0, int j1, xparams _params)
        {
            var i = 0;
            var j = 0;
            double v = 0;
            ...
            {
                v = 0;
                for (j = j0; j <= j1 - 1; j++) v = Math.Max(v, Math.Abs(a[i, j]));
        ...
        *************************************************************************/
        public static void tracevectore3(double[] a, int i0, int i1, xparams _params)
        {
            var i = 0;
            ...
            for (i = i0; i <= i1 - 1; i++)
            {
                ap.trace(string.Format("{0,11:E3}", a[i]));
                if (i < i1 - 1) ap.trace(" ");
            }
        ...
        *************************************************************************/
        public static void tracevectore6(double[] a, int i0, int i1, xparams _params)
        {
            var i = 0;
            ...
            for (i = i0; i <= i1 - 1; i++)
            {
                ap.trace(string.Format("{0,14:E6}", a[i]));
                if (i < i1 - 1) ap.trace(" ");
            }
        ...
        *************************************************************************/
        public static void tracevectore615(double[] a, int i0, int i1, bool usee15, xparams _params)
        {
            var i = 0;
            ...
            {
                if (usee15)
                    ap.trace(string.Format("{0,23:E15}", a[i]));
                else
                    ap.trace(string.Format("{0,14:E6}", a[i]));
        ...
        *************************************************************************/
        public static void tracerownrm1e6(double[,] a, int i0, int i1, int j0, int j1, xparams _params)
        {
            var i = 0;
            var j = 0;
            double v = 0;
            ...
            for (i = i0; i <= i1 - 1; i++)
            {
                ...
                ap.trace(string.Format("{0,14:E6}", v));
                if (i < i1 - 1) ap.trace(" ");
            }
        ...
        *************************************************************************/
        public static void tracespaces(int cnt, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= cnt - 1; i++) ap.trace(" ");
        }
        ...
        *************************************************************************/
        public static void traceangles(int cnt, xparams _params)
        {
            var i = 0;
        ...
        *************************************************************************/
        public static void savgcounterinit(savgcounter c, double priorvalue, xparams _params)
        {
            c.rsum = 0;
            c.rcnt = 0;
            c.prior = priorvalue;
        ...
        *************************************************************************/
        public static void savgcounterenqueue(savgcounter c, double v, xparams _params)
        {
            c.rsum = c.rsum + v;
            c.rcnt = c.rcnt + 1;
        }
        ...
        Enqueue value into SAvgCounter
        *************************************************************************/
        public static double savgcounterget(savgcounter c, xparams _params)
        {
            double result = 0;
        ...
        Prior value is a value that is returned when no values are in the buffer
        *************************************************************************/
        public static void squantilecounterinit(squantilecounter c, double priorvalue, xparams _params)
        {
            c.cnt = 0;
            c.prior = priorvalue;
        }
        ...
        *************************************************************************/
        public static void squantilecounterenqueue(squantilecounter c, double v, xparams _params)
        {
            if (ap.len(c.elems) == c.cnt) rvectorresize(ref c.elems, 2 * c.cnt + 1, _params);
        ...
        0<=Q<=1.
        *************************************************************************/
        public static double squantilecounterget(squantilecounter c, double q, xparams _params)
        {
            double result = 0;
            var left = 0;
            var right = 0;
            ...
            ap.assert(q >= 0 && q <= 1, "SQuantileCounterGet: incorrect Q");
            if (c.cnt == 0)
            {
                result = c.prior;
                return result;
        ...
        Initialize timer
        *************************************************************************/
        public static void stimerinit(stimer t, xparams _params)
        {
            t.ttotal = 0;
            t.isrunning = false;
        }
        ...
        cost.
        *************************************************************************/
        public static void stimerstart(stimer t, xparams _params)
        {
            ap.assert(!t.isrunning, "STimerStart: attempt to start already started timer");
            t.isrunning = true;
            t.tcurrent = unchecked((int)(DateTime.UtcNow.Ticks / 10000));
        }
        ...
        cost.
        *************************************************************************/
        public static void stimerstop(stimer t, xparams _params)
        {
            var tc = 0;

            ap.assert(t.isrunning, "STimerStop: attempt to stop already stopped timer");
            t.isrunning = false;
            tc = unchecked((int)(DateTime.UtcNow.Ticks / 10000));
            if (tc >= t.tcurrent)
                tc = tc - t.tcurrent;
            else
                tc = t.tcurrent - tc;
        ...
        when Cond is False.
        *************************************************************************/
        public static void stimerstartcond(stimer t, bool cond, xparams _params)
        {
            if (!cond) return;
        ...
        when Cond is False.
        *************************************************************************/
        public static void stimerstopcond(stimer t, bool cond, xparams _params)
        {
            var tc = 0;
        ...
        *************************************************************************/
        public static double stimergetms(stimer t, xparams _params)
        {
            double result = 0;

            ap.assert(!t.isrunning, "STimerGetMS: attempt to get time from the running timer");
            result = t.ttotal;
            return result;
        }
        ...
        *************************************************************************/
        public static double stimergetmsrunning(stimer t, xparams _params)
        {
            double result = 0;
            var tc = 0;
    ...
    public partial class ablasf
    {
        ...
        *************************************************************************/
        ...
        RESULT:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void raddvc(int n, double alpha, double[] y, double[,] x, int colidx, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= n - 1; i++) x[i, colidx] = x[i, colidx] + alpha * y[i];
        }
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void csetv(int n, complex v, complex[] x, xparams _params)
        {
            var j = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void isetm(int m, int n, int v, int[,] a, xparams _params)
        {
            var i = 0;
            var j = 0;
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rsetallocv(int n, double v, ref double[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new double[n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void isetallocm(int m, int n, int v, ref int[,] a, xparams _params)
        {
            if (ap.rows(a) < m || ap.cols(a) < n) a = new int[m, n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rsetallocm(int m, int n, double v, ref double[,] a, xparams _params)
        {
            if (ap.rows(a) < m || ap.cols(a) < n) a = new double[m, n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rallocv(int n, ref double[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new double[n];
        }
        ...
        *************************************************************************/
        public static void callocv(int n, ref complex[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new complex[n];
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void iallocv(int n, ref int[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new int[n];
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void ballocv(int n, ref bool[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new bool[n];
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rallocm(int m, int n, ref double[,] a, xparams _params)
        {
            if (ap.rows(a) < m || ap.cols(a) < n) a = new double[m, n];
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void isetallocv(int n, int v, ref int[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new int[n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void bsetallocv(int n, bool v, ref bool[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new bool[n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void csetallocv(int n, complex v, ref complex[] x, xparams _params)
        {
            if (ap.len(x) < n) x = new complex[n];
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rsetc(int n, double v, double[,] a, int j, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= n - 1; i++) a[i, j] = v;
        }
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rcopyallocv(int n, double[] x, ref double[] y, xparams _params)
        {
            if (ap.len(y) < n) y = new double[n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rcopym(int m, int n, double[,] x, double[,] y, xparams _params)
        {
            var i = 0;
            var j = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rcopyallocm(int m, int n, double[,] x, ref double[,] y, xparams _params)
        {
            if (m == 0 || n == 0) return;

            if (ap.rows(y) < m || ap.cols(y) < n) y = new double[Math.Max(m, ap.rows(y)), Math.Max(n, ap.cols(y))];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void icopyallocv(int n, int[] x, ref int[] y, xparams _params)
        {
            if (ap.len(y) < n) y = new int[n];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void bcopyallocv(int n, bool[] x, ref bool[] y, xparams _params)
        {
            if (ap.len(y) < n) y = new bool[n];
        ...
        *************************************************************************/
        ...
        c) actual size can be larger than N, so subsequent grow() calls can return
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void igrowv(int newn, ref int[] x, xparams _params)
        {
            //
        ...
        c) actual size can be larger than N, so subsequent grow() calls can return
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void bgrowv(int newn, ref bool[] x, xparams _params)
        {
            //
            // If no growth is required, exit. Call worker function otherwise.
            //
        ...
        *************************************************************************/
        public static void rgrowv(int newn, ref double[] x, xparams _params)
        {
            //
            // If no growth is required, exit. Call worker function otherwise.
            //
        ...
        *************************************************************************/
        public static void rgrowappendv(int newn, ref double[] x, double v, xparams _params)
        {
        ...
        value
          ...
          -- ALGLIB --
             Copyright 07.09.2024 by Bochkanov Sergey
        *************************************************************************/
        public static void igrowappendv(int newn, ref int[] x, int v, xparams _params)
        {
        ...
        value
          ...
          -- ALGLIB --
             Copyright 07.09.2024 by Bochkanov Sergey
        *************************************************************************/
        public static void bgrowappendv(int newn, ref bool[] x, bool v, xparams _params)
        {
        ...
        b) if cols(A)<>ColsCnt (including cols(A)>ColsCnt), then the matrix is
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rgrowrowsfixedcolsm(int m, int colscnt, ref double[,] a, xparams _params)
        {
            if (ap.cols(a) != colscnt)
            {
                a = new double[(int)Math.Round(1.25 * m + 8), colscnt];
                return;
            }

            if (ap.rows(a) < m) rincreaserowsfixedcolsminternal(m, ref a, _params);
        }
        ...
        c) if cols(A)<>ColsCnt (including cols(A)>ColsCnt) AND N<>0, an  exception
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void rappendrowfixedcolsm(int n, int colscnt, ref double[,] a, xparams _params)
        {
            if (ap.cols(a) != colscnt)
            {
                if (n != 0) ap.assert(false, "APSERV: integrity check 3225 failed");

                a = new double[8, colscnt];
                return;
            }

            if (ap.rows(a) < n) ap.assert(false, "APSERV: integrity check 3827 failed");

            if (ap.rows(a) == n) rincreaserowsfixedcolsminternal(n + 1, ref a, _params);
        }
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rcopymulvc(int n, double v, double[] x, double[,] y, int cidx, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= n - 1; i++) y[i, cidx] = v * x[i];
        }
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rcopyvc(int n, double[] x, double[,] a, int j, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= n - 1; i++) a[i, j] = x[i];
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.01.2020 by Bochkanov Sergey
        *************************************************************************/
        public static void rcopycv(int n, double[,] a, int j, double[] x, xparams _params)
        {
            var i = 0;

            for (i = 0; i <= n - 1; i++) x[i] = a[i, j];
        }
        ...
        *************************************************************************/
        ...
        Fast kernel
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixgerf(int m, int n, double[,] a, int ia, int ja, double ralpha, double[] u, int iu, double[] v, int iv,
            xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        ...
        Fast kernel
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixrank1f(int m, int n, double[,] a, int ia, int ja, double[] u, int iu, double[] v, int iv, xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
            ...
            int optypeb, complex beta, complex[,] c, int ic, int jc, xparams _params)
        {
            ...
            // Try optimized code
            //
            if (cmatrixgemmf(m, n, k, alpha, a, ia, ja, optypea, b, ib, jb, optypeb, beta, c, ic, jc, _params)) return;
                        ...
                        for (jk = j0; jk <= j1; jk++)
                        {
                            ...
                            else
                            {
                                ...
                                if (optypea == 0 && optypeb == 0)
                                {
                                    i1_ = ib - ja;
                                    v = 0.0;
                                    for (i_ = ja; i_ <= ja + k - 1; i_++) v += a[ia + ik, i_] * b[i_ + i1_, jb + jk];
                                }
                                ...
                                if (optypea == 0 && optypeb == 1)
                                {
                                    i1_ = jb - ja;
                                    v = 0.0;
                                    for (i_ = ja; i_ <= ja + k - 1; i_++) v += a[ia + ik, i_] * b[ib + jk, i_ + i1_];
                                }
                                ...
                                if (optypea == 1 && optypeb == 0)
                                {
                                    i1_ = ib - ia;
                                    v = 0.0;
                                    for (i_ = ia; i_ <= ia + k - 1; i_++) v += a[i_, ja + ik] * b[i_ + i1_, jb + jk];
                                }
                                ...
                                if (optypea == 1 && optypeb == 1)
                                {
                                    i1_ = jb - ia;
                                    v = 0.0;
                                    for (i_ = ia; i_ <= ia + k - 1; i_++) v += a[i_, ja + ik] * b[ib + jk, i_ + i1_];
                                }
        ...
        *************************************************************************/
            ...
            int optypeb, double beta, double[,] c, int ic, int jc, xparams _params)
        {
            ...
            // Try optimized code
            //
            if (rgemm32basecase(m, n, k, alpha, a, ia, ja, optypea, b, ib, jb, optypeb, beta, c, ic, jc, _params)) return;
        ...
        *************************************************************************/
            ...
            double[,] c, int ic, int jc, xparams _params)
        {
            ...
            ap.assert(alpha != 0, "RMatrixGEMMK44V00: internal error (Alpha=0)");
        ...
        *************************************************************************/
        ...
        Internal function that actually works with dynamic arrays.
          ...
          -- ALGLIB --
             Copyright 07.06.2023 by Bochkanov Sergey
        *************************************************************************/
        private static void igrowvinternal(int newn, ref int[] x, xparams _params)
        {
            var oldx = new int[0];
            var oldn = 0;
        ...
        Internal function that actually works with dynamic arrays.
          ...
          -- ALGLIB --
             Copyright 07.06.2023 by Bochkanov Sergey
        *************************************************************************/
        private static void bgrowvinternal(int newn, ref bool[] x, xparams _params)
        {
            var oldx = new bool[0];
            var oldn = 0;
        ...
        Internal function which actually works with dynamic arrays
          ...
          -- ALGLIB --
             Copyright 07.06.2023 by Bochkanov Sergey
        *************************************************************************/
        private static void rgrowvinternal(int newn, ref double[] x, xparams _params)
        {
            var oldx = new double[0];
            var oldn = 0;
        ...
        a local dynamically allocated variable.
          ...
          -- ALGLIB --
             Copyright 20.03.2009 by Bochkanov Sergey
        *************************************************************************/
        private static void rincreaserowsfixedcolsminternal(int newrows, ref double[,] a, xparams _params)
        {
            var olda = new double[0, 0];

            ap.swap(ref a, ref olda);
            a = new double[(int)Math.Round(Math.Max(1.8 * ap.rows(olda) + 8, 1.25 * newrows)), ap.cols(olda)];
            rcopym(ap.rows(olda), ap.cols(olda), olda, a, _params);
        }
    ...
    public class hblas
    {
            ...
            xparams _params)
        {
            ...
            // Calculate D*x first
            //
            for (i = i1; i <= i2; i++) y[i - i1 + 1] = a[i, i] * x[i - i1 + 1];
            ...
            if (isupper)
            {
                for (i = i1; i <= i2 - 1; i++)
                {
                    ...
                    i1_ = ba1 - bx1;
                    v = 0.0;
                    for (i_ = bx1; i_ <= bx2; i_++) v += x[i_] * a[i, i_ + i1_];
            ...
            xparams _params)
        {
            ...
            if (isupper)
            {
                for (i = i1; i <= i2; i++)
                {
                    ...
                    tp2 = i2 - i1 + 1;
                    v = alpha * x[i + 1 - i1];
                    for (i_ = tp1; i_ <= tp2; i_++) t[i_] = v * math.conj(y[i_]);

                    v = math.conj(alpha) * y[i + 1 - i1];
                    for (i_ = tp1; i_ <= tp2; i_++) t[i_] = t[i_] + v * math.conj(x[i_]);
    ...
    public class creflections
    {
        ...
        handle errors when intermediate results cause an overflow.
          ...
          -- LAPACK auxiliary routine (version 3.0) --
             ...
             September 30, 1994
        *************************************************************************/
        public static void complexgeneratereflection(ref complex[] x, int n, ref complex tau, xparams _params)
        {
            var j = 0;
            complex alpha = 0;
            double alphi = 0;
            ...
            //
            mx = 0;
            for (j = 1; j <= n; j++) mx = Math.Max(math.abscomplex(x[j]), mx);
            ...
            alpha = x[1];
            mx = 0;
            for (j = 2; j <= n; j++) mx = Math.Max(math.abscomplex(x[j]), mx);
        ...
        Output parameters:
          ...
          -- LAPACK auxiliary routine (version 3.0) --
             ...
             September 30, 1994
        *************************************************************************/
        public static void complexapplyreflectionfromtheleft(complex[,] c, complex tau, complex[] v, int m1, int m2, int n1, int n2,
            ref complex[] work, xparams _params)
        {
            complex t = 0;
            var i = 0;
            var i_ = 0;

            if (tau == 0 || n1 > n2 || m1 > m2) return;

            //
            // w := C^T * conj(v)
            //
            for (i = n1; i <= n2; i++) work[i] = 0;

            for (i = m1; i <= m2; i++)
            {
                t = math.conj(v[i + 1 - m1]);
                for (i_ = n1; i_ <= n2; i_++) work[i_] = work[i_] + t * c[i, i_];
            }
            ...
            {
                t = v[i - m1 + 1] * tau;
                for (i_ = n1; i_ <= n2; i_++) c[i, i_] = c[i, i_] - t * work[i_];
            }
        }
        ...
        Output parameters:
          ...
          -- LAPACK auxiliary routine (version 3.0) --
             ...
             September 30, 1994
        *************************************************************************/
        public static void complexapplyreflectionfromtheright(complex[,] c, complex tau, complex[] v, int m1, int m2, int n1, int n2,
            ref complex[] work, xparams _params)
        {
            complex t = 0;
            var i = 0;
            ...
            for (i = m1; i <= m2; i++)
            {
                i1_ = 1 - n1;
                t = 0.0;
                for (i_ = n1; i_ <= n2; i_++) t += c[i, i_] * v[i_ + i1_];
            ...
            // C := C - w * conj(v^T)
            //
            for (i_ = 1; i_ <= vm; i_++) v[i_] = math.conj(v[i_]);

            for (i = m1; i <= m2; i++)
            {
                t = work[i] * tau;
                i1_ = 1 - n1;
                for (i_ = n1; i_ <= n2; i_++) c[i, i_] = c[i, i_] - t * v[i_ + i1_];
            }
            ...
            xparams _params)
        {
            ...
            if (isupper)
            {
                for (i = i1; i <= i2; i++)
                {
                    ...
                    tp2 = i2 - i1 + 1;
                    v = x[i + 1 - i1];
                    for (i_ = tp1; i_ <= tp2; i_++) t[i_] = v * y[i_];

                    v = y[i + 1 - i1];
                    for (i_ = tp1; i_ <= tp2; i_++) t[i_] = t[i_] + v * x[i_];

                    for (i_ = tp1; i_ <= tp2; i_++) t[i_] = alpha * t[i_];
    ...
    public class ablasmkl
    {
        ...
        MKL-based kernel
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixgermkl(int m, int n, double[,] a, int ia, int ja, double alpha, double[] u, int iu, double[] v, int iv,
            xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        ...
        MKL-based kernel
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool cmatrixmvmkl(int m, int n, complex[,] a, int ia, int ja, int opa, complex[] x, int ix, complex[] y, int iy,
            xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        ...
        MKL-based kernel
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixgemvmkl(int m, int n, double alpha, double[,] a, int ia, int ja, int opa, double[] x, int ix, double beta,
        ...
        MKL-based kernel
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixtrsvmkl(int n, double[,] a, int ia, int ja, bool isupper, bool isunit, int optype, double[] x, int ix,
            xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        ...
        (True on succeess).
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool spdmatrixcholeskymkl(double[,] a, int offs, int n, bool isupper, ref bool cholresult, xparams _params)
        {
            var result = new bool();
        ...
        MKL-based kernel.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixplumkl(double[,] a, int offs, int m, int n, ref int[] pivots, xparams _params)
        {
            var result = new bool();
        ...
        NOTE: this function needs preallocated output/temporary arrays.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixbdmkl(double[,] a, int m, int n, double[] d, double[] e, double[] tauq, double[] taup, xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        ...
        NOTE: Tau must be preallocated array with at least N-1 elements.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixhessenbergmkl(double[,] a, int n, double[] tau, xparams _params)
        {
            var result = new bool();
        ...
        NOTE: Q must be preallocated N*N array
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixhessenbergunpackqmkl(double[,] a, int n, double[] tau, double[,] q, xparams _params)
        {
            var result = new bool();
        ...
        NOTE: Tau, D, E must be preallocated arrays;
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool smatrixtdmkl(double[,] a, int n, bool isupper, double[] tau, double[] d, double[] e, xparams _params)
        {
            var result = new bool();
        ...
        NOTE: Q must be preallocated N*N array
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool smatrixtdunpackqmkl(double[,] a, int n, bool isupper, double[] tau, double[,] q, xparams _params)
        {
            var result = new bool();
        ...
        NOTE: Tau, D, E must be preallocated arrays;
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool hmatrixtdmkl(complex[,] a, int n, bool isupper, complex[] tau, double[] d, double[] e, xparams _params)
        {
            var result = new bool();
        ...
        NOTE: Q must be preallocated N*N array
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool hmatrixtdunpackqmkl(complex[,] a, int n, bool isupper, complex[] tau, complex[,] q, xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        ...
        EVDResult is modified if and only if MKL is present.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool smatrixtdevdmkl(double[] d, double[] e, int n, int zneeded, double[,] z, ref bool evdresult, xparams _params)
        {
            var result = new bool();
    ...
    public class tsort
    {
        ...
        *************************************************************************/
        public static void tagsort(ref double[] a, int n, ref int[] p1, ref int[] p2, xparams _params)
        {
        ...
        additional allocations can lead to severe performance degradation
          ...
          -- ALGLIB --
             Copyright 14.05.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortbuf(ref double[] a, int n, ref int[] p1, ref int[] p2, apserv.apbuffers buf, xparams _params)
        {
            var i = 0;
            var lv = 0;
            var lp = 0;
        ...
        *************************************************************************/
        public static void tagsortfasti(ref double[] a, ref int[] b, ref double[] bufa, ref int[] bufb, int n, xparams _params)
        {
            var i = 0;
            var j = 0;
            ...
            // General case
            //
            if (ap.len(bufa) < n) bufa = new double[n];

            if (ap.len(bufb) < n) bufb = new int[n];
        ...
        2.  this function uses two buffers, BufA and BufB, each is N elements large.
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortfastr(ref double[] a, ref double[] b, ref double[] bufa, ref double[] bufb, int n, xparams _params)
        {
            var i = 0;
            var j = 0;
            var isascending = new bool();
            ...
            if (ap.len(bufb) < n) bufb = new double[n];
        ...
        2.  this function uses buffer, BufA, which is N elements large. It may be
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortfast(ref double[] a, ref double[] bufa, int n, xparams _params)
        {
            var i = 0;
            var j = 0;
            var isascending = new bool();
        ...
        NOTES:
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortmiddleir(ref int[] a, ref double[] b, int offset, int n, xparams _params)
        {
            var i = 0;
            var k = 0;
            var t = 0;
            ...
            isascending = true;
            for (i = 1; i <= n - 1; i++) isascending = isascending && a[offset + i] >= a[offset + i - 1];
        ...
        *************************************************************************/
        public static void tagsortmiddleirr(int[] a, double[] b, double[] c, int offset, int n, xparams _params)
        {
            var i = 0;
            var k = 0;
            var t = 0;
        ...
        NOTES:
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortmiddleri(double[] a, int[] b, int offset, int n, xparams _params)
        {
            var i = 0;
            var k = 0;
            var t = 0;
        ...
        NOTES:
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortmiddleii(ref int[] a, ref int[] b, int offset, int n, xparams _params)
        {
            var i = 0;
            var k = 0;
            var t = 0;
        ...
        NOTES:
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void tagsortmiddlei(ref int[] a, int offset, int n, xparams _params)
        {
            var i = 0;
            var k = 0;
            var t = 0;
        ...
        be used to sort middle of the array
          ...
          -- ALGLIB --
             Copyright 11.12.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void sortmiddlei(int[] a, int offset, int n, xparams _params)
        {
            var i = 0;
            var k = 0;
            var t = 0;
        ...
        *************************************************************************/
        public static void tagheappushi(ref double[] a, ref int[] b, ref int n, double va, int vb, xparams _params)
        {
            var j = 0;
            var k = 0;
            double v = 0;
        ...
        PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.02.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void tagheapreplacetopi(ref double[] a, ref int[] b, int n, double va, int vb, xparams _params)
        {
            var j = 0;
            var k1 = 0;
            var k2 = 0;
        ...
        decreased by 1.
          ...
          -- ALGLIB --
             Copyright 28.02.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void tagheappopi(ref double[] a, ref int[] b, ref int n, xparams _params)
        {
            double va = 0;
            var vb = 0;
        ...
        *************************************************************************/
        public static int lowerbound(double[] a, int n, double t, xparams _params)
        {
            var result = 0;
            var l = 0;
            var half = 0;
        ...
        In the case when there aren't such elements, returns N.
        *************************************************************************/
        public static int upperbound(double[] a, int n, double t, xparams _params)
        {
            var result = 0;
            var l = 0;
            var half = 0;
        ...
        *************************************************************************/
        private static void tagsortfastirec(ref double[] a, ref int[] b, ref double[] bufa, ref int[] bufb, int i1, int i2, xparams _params)
        {
            var i = 0;
            var j = 0;
            var k = 0;
        ...
        *************************************************************************/
        ...
        applies same permutations to B.
          ...
          -- ALGLIB --
             Copyright 06.09.2010 by Bochkanov Sergey
        *************************************************************************/
        private static void tagsortfastrec(ref double[] a, ref double[] bufa, int i1, int i2, xparams _params)
        {
            var cntless = 0;
            var cnteq = 0;
            var cntgreater = 0;
    ...
    public class blas
    {
        public static double vectornorm2(double[] x, int i1, int i2, xparams _params)
        {
            double result = 0;
            var n = 0;
            var ix = 0;
        ...
        public static int vectoridxabsmax(double[] x, int i1, int i2, xparams _params)
        {
            var result = 0;
            var i = 0;
        ...
        public static int columnidxabsmax(double[,] x, int i1, int i2, int j, xparams _params)
        {
            var result = 0;
            var i = 0;
        ...
        public static int rowidxabsmax(double[,] x, int j1, int j2, int i, xparams _params)
        {
            var result = 0;
            var j = 0;
        ...
        public static double upperhessenberg1norm(double[,] a, int i1, int i2, int j1, int j2, ref double[] work, xparams _params)
        {
            double result = 0;
            var i = 0;
            var j = 0;
            ...
            result = 0;
            for (j = j1; j <= j2; j++) result = Math.Max(result, work[j]);

            return result;
        }


        public static void copymatrix(double[,] a, int is1, int is2, int js1, int js2, ref double[,] b, int id1, int id2, int jd1, int jd2,
            xparams _params)
        {
            var isrc = 0;
            var idst = 0;
            ...
            for (isrc = is1; isrc <= is2; isrc++)
            {
                idst = isrc - is1 + id1;
                i1_ = js1 - jd1;
                for (i_ = jd1; i_ <= jd2; i_++) b[idst, i_] = a[isrc, i_ + i1_];
            }
        }


        public static void inplacetranspose(ref double[,] a, int i1, int i2, int j1, int j2, ref double[] work, xparams _params)
        {
            var i = 0;
            var j = 0;
            var ips = 0;
            ...
            for (i = i1; i <= i2 - 1; i++)
            {
                ...
                l = i2 - i;
                i1_ = ips - 1;
                for (i_ = 1; i_ <= l; i_++) work[i_] = a[i_ + i1_, j];

                i1_ = jps - ips;
                for (i_ = ips; i_ <= i2; i_++) a[i_, j] = a[i, i_ + i1_];

                i1_ = 1 - jps;
                for (i_ = jps; i_ <= j2; i_++) a[i, i_] = work[i_ + i1_];
            }
        }
            ...
            xparams _params)
        {
            ...
            for (isrc = is1; isrc <= is2; isrc++)
            {
                jdst = isrc - is1 + jd1;
                i1_ = js1 - id1;
                for (i_ = id1; i_ <= id2; i_++) b[i_, jdst] = a[isrc, i_ + i1_];
            }
        }
            ...
            ref double[] y, int iy1, int iy2, double beta, xparams _params)
        {
            ...
            if (!trans)
            {
                ...
                for (i = i1; i <= i2; i++)
                {
                    i1_ = ix1 - j1;
                    v = 0.0;
                    for (i_ = j1; i_ <= j2; i_++) v += a[i, i_] * x[i_ + i1_];
            ...
            else
            {
                ...
                for (i = i1; i <= i2; i++)
                {
                    v = alpha * x[ix1 + i - i1];
                    i1_ = j1 - iy1;
                    for (i_ = iy1; i_ <= iy2; i_++) y[i_] = y[i_] + v * a[i, i_ + i1_];
                }
            }
        }


        public static double pythag2(double x, double y, xparams _params)
        {
            double result = 0;
            double w = 0;
            double xabs = 0;
            ...
            int bj2, bool transb, double alpha, ref double[,] c, int ci1, int ci2, int cj1, int cj2, double beta, ref double[] work, xparams _params)
        {
            ...
            if (arows <= 0 || acols <= 0 || brows <= 0 || bcols <= 0) return;
            ...
            if (!transa && !transb)
            {
                ...
                for (r = bi1; r <= bi2; r++)
                {
                    ...
                    k = ci1 + l - ai1;
                    i1_ = bj1 - cj1;
                    for (i_ = cj1; i_ <= cj2; i_++) c[k, i_] = c[k, i_] + v * b[r, i_ + i1_];
                }
            ...
            if (!transa && transb)
            {
                if (arows * acols < brows * bcols)
                {
                    ...
                    for (l = ai1; l <= ai2; l++)
                    {
                        i1_ = bj1 - aj1;
                        v = 0.0;
                        for (i_ = aj1; i_ <= aj2; i_++) v += a[l, i_] * b[r, i_ + i1_];
            ...
            if (transa && transb)
            {
                if (arows * acols < brows * bcols)
                {
                    ...
                    {
                        k = cj1 + r - bi1;
                        for (i = 1; i <= crows; i++) work[i] = 0.0;

                        for (l = ai1; l <= ai2; l++)
                        {
                            v = alpha * b[r, bj1 + l - ai1];
                            i1_ = aj1 - 1;
                            for (i_ = 1; i_ <= crows; i_++) work[i_] = work[i_] + v * a[l, i_ + i1_];
                        }
                ...
                else
                {
                    for (l = aj1; l <= aj2; l++)
                    {
                        k = ai2 - ai1 + 1;
                        i1_ = ai1 - 1;
                        for (i_ = 1; i_ <= k; i_++) work[i_] = a[i_ + i1_, l];

                        for (r = bi1; r <= bi2; r++)
                        {
                            i1_ = bj1 - 1;
                            v = 0.0;
                            for (i_ = 1; i_ <= k; i_++) v += work[i_] * b[r, i_ + i1_];
    ...
    public class rotations
    {
        ...
        Utility subroutine.
        *************************************************************************/
        public static void applyrotationsfromtheleft(bool isforward, int m1, int m2, int n1, int n2, double[] c, double[] s, double[,] a,
            double[] work, xparams _params)
        {
            var j = 0;
            var jp1 = 0;
            double ctemp = 0;
        ...
        Utility subroutine.
        *************************************************************************/
        public static void applyrotationsfromtheright(bool isforward, int m1, int m2, int n1, int n2, double[] c, double[] s, double[,] a,
            double[] work, xparams _params)
        {
            var j = 0;
            var jp1 = 0;
            ...
            if (isforward)
            {
                if (m1 != m2)
                {
                    ...
                    for (j = n1; j <= n2 - 1; j++)
                    {
                        ...
                        {
                            jp1 = j + 1;
                            for (i_ = m1; i_ <= m2; i_++) work[i_] = ctemp * a[i_, jp1];

                            for (i_ = m1; i_ <= m2; i_++) work[i_] = work[i_] - stemp * a[i_, j];

                            for (i_ = m1; i_ <= m2; i_++) a[i_, j] = ctemp * a[i_, j];

                            for (i_ = m1; i_ <= m2; i_++) a[i_, j] = a[i_, j] + stemp * a[i_, jp1];
        ...
        CS**2 + SN**2 = 1
        *************************************************************************/
        public static void generaterotation(double f, double g, ref double cs, ref double sn, ref double r, xparams _params)
        {
            double f1 = 0;
            double g1 = 0;
    ...
    public class basicstatops
    {
        ...
        NOTE: when IsCentered is True and all X[] are equal, this  function  fills
              ...
              equal to zero).
        *************************************************************************/
        public static void rankx(double[] x, int n, bool iscentered, apserv.apbuffers buf, xparams _params)
        {
            var i = 0;
            var j = 0;
            var k = 0;
            ...
            if (ap.len(buf.ra1) < n) buf.ra1 = new double[n];

            if (ap.len(buf.ia1) < n) buf.ia1 = new int[n];
            ...
            while (i <= n - 1)
            {
                ...
                while (j <= n - 1)
                {
                    if (buf.ra1[j] != buf.ra1[i]) break;

                    j = j + 1;
                }

                for (k = i; k <= j - 1; k++) buf.ra1[k] = (i + j - 1) / (double)2;
            ...
            for (i = 0; i <= n - 1; i++) x[buf.ia1[i]] = buf.ra1[i] - voffs;
        }
        ...
        *************************************************************************/
        public static void rankxuntied(double[] x, int n, apserv.apbuffers buf, xparams _params)
        {
            var i = 0;
    ...
    public class apstruct
    {
        ...
        *************************************************************************/
        public static void nisinitemptyslow(int n, niset sa, xparams _params)
        {
            sa.n = n;
            sa.nstored = 0;
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void niscopy(niset ssrc, niset sdst, xparams _params)
        {
            var ns = 0;
            var i = 0;
            var k = 0;
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void nisaddelement(niset sa, int k, xparams _params)
        {
            var ns = 0;

            if (sa.locationof[k] >= 0) return;
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void nissubtract1(niset sa, niset src, xparams _params)
        {
            var i = 0;
            var j = 0;
            var loc = 0;
        ...
        INPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void nisclear(niset sa, xparams _params)
        {
            var i = 0;
            var ns = 0;

            ns = sa.nstored;
            for (i = 0; i <= ns - 1; i++) sa.locationof[sa.items[i]] = -1;
        ...
        RESULT
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static int niscount(niset sa, xparams _params)
        {
            var result = 0;
        ...
        RESULT
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static bool nisequal(niset s0, niset s1, xparams _params)
        {
            var result = new bool();
            var i = 0;
            var ns0 = 0;
            ...
            result = false;
            if (s0.n != s1.n) return result;

            if (s0.nstored != s1.nstored) return result;
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void nisstartenumeration(niset sa, xparams _params)
        {
            sa.iteridx = 0;
        }
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static bool nisenumerate(niset sa, ref int i, xparams _params)
        {
            var result = new bool();
            var k = 0;
        ...
        INPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void kniscompressstorage(kniset sa, xparams _params)
        {
            var i = 0;
            var blocklen = 0;
            var setidx = 0;
            ...
            ap.assert(sa.storagemode == 0, "knisCompressStorage: unexpected storage mode");
            srcoffs = 0;
            dstoffs = 0;
            while (srcoffs < sa.dataused)
            {
                ...
                ap.assert(blocklen >= knisheadersize, "knisCompressStorage: integrity check 6385 failed");
                if (setidx < 0)
                {
                ...
                if (srcoffs != dstoffs)
                {
                    for (i = 0; i <= blocklen - 1; i++) sa.data[dstoffs + i] = sa.data[srcoffs + i];
            ...
            ap.assert(srcoffs == sa.dataused, "knisCompressStorage: integrity check 9464 failed");
            sa.dataused = dstoffs;
        }
        ...
        INPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void knisreallocate(kniset sa, int setidx, int newallocated, xparams _params)
        {
            var oldbegin = 0;
            var oldcnt = 0;
            var newbegin = 0;
            ...
            ap.assert(sa.storagemode == 0, "knisReallocate: unexpected storage mode");
            if (ap.len(sa.data) < sa.dataused + knisheadersize + newallocated)
            {
            ...
            for (j = 0; j <= oldcnt - 1; j++) sa.data[newbegin + j] = sa.data[oldbegin + j];
        }
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void knisinitunsorted(int k, int n, int kprealloc, kniset sa, xparams _params)
        {
            var i = 0;

            ap.assert(k > 0, "knisInitUnsorted: K<=0");
            ap.assert(n >= 0, "knisInitUnsorted: N<0");
            ap.assert(kprealloc >= 0, "knisInitUnsorted: kPrealloc<0");
            sa.storagemode = 0;
            sa.k = k;
            sa.n = n;
            ...
            for (i = 1; i <= k - 1; i++) sa.vbegin[i] = sa.vbegin[i - 1] + sa.vallocated[i - 1] + knisheadersize;
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void knisdirectaccess(kniset sa, int k, ref int idxbegin, ref int idxend, xparams _params)
        {
            idxbegin = 0;
            idxend = 0;

            ap.assert(sa.storagemode == 0, "knisDirectAccess: unexpected storage mode");
        ...
        RESULT:
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static int knispoplast(kniset sa, int k, xparams _params)
        {
            var result = 0;
            var c = 0;

            ap.assert(sa.storagemode == 0, "knisPopLast: unexpected storage mode");
            c = sa.vcnt[k];
            ap.assert(c > 0, "knisDirectAccess: K-th set is empty");
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void knisaddnewelement(kniset sa, int i, int k, xparams _params)
        {
            var cnt = 0;

            ap.assert(sa.storagemode == 0, "knisAddNewElement: unexpected storage mode");
            cnt = sa.vcnt[i];
            if (cnt == sa.vallocated[i]) knisreallocate(sa, i, 2 * sa.vallocated[i] + 1, _params);
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void knisclearkthnoreclaim(kniset sa, int k, xparams _params)
        {
            ap.assert(sa.storagemode == 0, "knisClearKthNoReclaim: unexpected storage mode");
            sa.vcnt[k] = 0;
        }
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static void knisclearkthreclaim(kniset sa, int k, xparams _params)
        {
            var idxbegin = 0;
            var allocated = 0;

            ap.assert(sa.storagemode == 0, "knisClearKthReclaim: unexpected storage mode");
            idxbegin = sa.vbegin[k];
        ...
        RESULT
          ...
          -- ALGLIB PROJECT --
             Copyright 05.10.2020 by Bochkanov Sergey.
        *************************************************************************/
        public static int kniscountkth(kniset s0, int k, xparams _params)
        {
            var result = 0;

            ap.assert(s0.storagemode == 0, "knisCountKth: unexpected storage mode");
            result = s0.vcnt[k];
            return result;
        }
    ...
    public class trlinsolve
    {
        ...
        Output parameters:
          ...
          -- LAPACK auxiliary routine (version 3.0) --
             ...
             June 30, 1992
        *************************************************************************/
        public static void rmatrixtrsafesolve(double[,] a, int n, ref double[] x, ref double s, bool isupper, bool istrans, bool isunit,
            xparams _params)
        {
            var normin = new bool();
            ...
            {
                i1_ = 0 - 1;
                for (i_ = 1; i_ <= n; i_++) a1[i, i_] = a[i - 1, i_ + i1_];
            }

            i1_ = 0 - 1;
            for (i_ = 1; i_ <= n; i_++) x1[i_] = x[i_ + i1_];
            ...
            //
            i1_ = 1 - 0;
            for (i_ = 0; i_ <= n - 1; i_++) x[i_] = x1[i_ + i1_];
        }
            ...
            ref double[] cnorm, xparams _params)
        {
            ...
            if (!normin)
            {
                ...
                if (upper)
                {
                    ...
                    {
                        v = 0;
                        for (k = 1; k <= j - 1; k++) v = v + Math.Abs(a[k, j]);
                ...
                else
                {
                    ...
                    {
                        v = 0;
                        for (k = j + 1; k <= n; k++) v = v + Math.Abs(a[k, j]);
            ...
            {
                tscal = 1 / (smlnum * tmax);
                for (i_ = 1; i_ <= n; i_++) cnorm[i_] = tscal * cnorm[i_];
            }
                ...
                else
                {
                    if (nounit)
                    {
                        ...
                        while ((jinc > 0 && j <= jlast) || (jinc < 0 && j >= jlast))
                        {
                            ...
                            if (j == jlast) grow = Math.Min(grow, xbnd);
            ...
            if (grow * tscal > smlnum)
            {
                ...
                if ((upper && notran) || (!upper && !notran))
                {
                    ...
                    for (i = n - 1; i >= 1; i--)
                    {
                        ...
                        {
                            v = 0.0;
                            for (i_ = ip1; i_ <= n; i_++) v += a[i, i_] * x[i_];
                        }
                        else
                        {
                            v = 0.0;
                            for (i_ = ip1; i_ <= n; i_++) v += a[i_, i] * x[i_];
                        }
                ...
                else
                {
                    ...
                    for (i = 2; i <= n; i++)
                    {
                        ...
                        {
                            v = 0.0;
                            for (i_ = 1; i_ <= im1; i_++) v += a[i_, i] * x[i_];
                        }
                        else
                        {
                            v = 0.0;
                            for (i_ = 1; i_ <= im1; i_++) v += a[i, i_] * x[i_];
                        }
                    ...
                    while ((jinc > 0 && j <= jlast) || (jinc < 0 && j >= jlast))
                    {
                        ...
                        else
                        {
                            if (xj * cnorm[j] > bignum - xmax)
                            {
                                ...
                                // Scale x by 1/2.
                                //
                                for (i_ = 1; i_ <= n; i_++) x[i_] = 0.5 * x[i_];
                        ...
                        if (upper)
                        {
                            if (j > 1)
                            {
                                ...
                                v = x[j] * tscal;
                                jm1 = j - 1;
                                for (i_ = 1; i_ <= jm1; i_++) x[i_] = x[i_] - v * a[i_, j];
                        ...
                        else
                        {
                            if (j < n)
                            {
                                ...
                                jp1 = j + 1;
                                v = x[j] * tscal;
                                for (i_ = jp1; i_ <= n; i_++) x[i_] = x[i_] - v * a[i_, j];
                        ...
                        if (uscal == 1)
                        {
                            ...
                            else
                            {
                                if (j < n)
                                {
                                    jp1 = j + 1;
                                    sumj = 0.0;
                                    for (i_ = jp1; i_ <= n; i_++) sumj += a[i_, j] * x[i_];
                                }
                            }
                        }
                        else
            ...
            {
                v = 1 / tscal;
                for (i_ = 1; i_ <= n; i_++) cnorm[i_] = v * cnorm[i_];
            }
        }
    }
    ...
    public class safesolve
    {
        ...
        Real implementation of CMatrixScaledTRSafeSolve
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool rmatrixscaledtrsafesolve(double[,] a, double sa, int n, ref double[] x, bool isupper, int trans, bool isunit,
            double maxgrowth, xparams _params)
        {
            var result = new bool();
            double lnmax = 0;
            double nrmb = 0;
            ...
            //
            nrmb = 0;
            for (i = 0; i <= n - 1; i++) nrmb = Math.Max(nrmb, Math.Abs(x[i]));
            ...
            if (isupper && trans == 0)
            {
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    if (i < n - 1)
                    {
                        for (i_ = i + 1; i_ <= n - 1; i_++) tmp[i_] = sa * a[i, i_];

                        vr = 0.0;
                        for (i_ = i + 1; i_ <= n - 1; i_++) vr += tmp[i_] * x[i_];
            ...
            if (!isupper && trans == 0)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    if (i > 0)
                    {
                        for (i_ = 0; i_ <= i - 1; i_++) tmp[i_] = sa * a[i, i_];

                        vr = 0.0;
                        for (i_ = 0; i_ <= i - 1; i_++) vr += tmp[i_] * x[i_];
            ...
            if (isupper && trans == 1)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    if (i < n - 1)
                    {
                        ...
                        for (i_ = i + 1; i_ <= n - 1; i_++) x[i_] = x[i_] - vr * tmp[i_];
                    }
                }
            ...
            if (!isupper && trans == 1)
            {
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        for (i_ = 0; i_ <= i - 1; i_++) x[i_] = x[i_] - vr * tmp[i_];
                    }
                }
        ...
        as MaxGrowth is significantly less than MaxRealNumber/norm(b).
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        public static bool cmatrixscaledtrsafesolve(complex[,] a, double sa, int n, ref complex[] x, bool isupper, int trans, bool isunit,
            double maxgrowth, xparams _params)
        {
            var result = new bool();
            double lnmax = 0;
            ...
            //
            nrmb = 0;
            for (i = 0; i <= n - 1; i++) nrmb = Math.Max(nrmb, math.abscomplex(x[i]));
            ...
            if (isupper && trans == 0)
            {
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    if (i < n - 1)
                    {
                        ...
                        vc = 0.0;
                        for (i_ = i + 1; i_ <= n - 1; i_++) vc += tmp[i_] * x[i_];
            ...
            if (!isupper && trans == 0)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        vc = 0.0;
                        for (i_ = 0; i_ <= i - 1; i_++) vc += tmp[i_] * x[i_];
            ...
            if (isupper && trans == 1)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    if (i < n - 1)
                    {
                        ...
                        for (i_ = i + 1; i_ <= n - 1; i_++) x[i_] = x[i_] - vc * tmp[i_];
                    }
                }
            ...
            if (!isupper && trans == 1)
            {
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    if (i > 0)
                    {
                        ...
                        for (i_ = 0; i_ <= i - 1; i_++) x[i_] = x[i_] - vc * tmp[i_];
                    }
                }
            ...
            if (isupper && trans == 2)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    if (i < n - 1)
                    {
                        for (i_ = i + 1; i_ <= n - 1; i_++) tmp[i_] = sa * math.conj(a[i, i_]);
            ...
            if (!isupper && trans == 2)
            {
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    if (i > 0)
                    {
                        for (i_ = 0; i_ <= i - 1; i_++) tmp[i_] = sa * math.conj(a[i, i_]);
        ...
        *************************************************************************/
            ...
            ref complex x, xparams _params)
        {
            ...
            if (xnorm > maxgrowth * bnorm) return result;
    ...
    public class xblas
    {
        ...
        *************************************************************************/
        public static void xdot(double[] a, double[] b, int n, ref double[] temp, ref double r, ref double rerr, xparams _params)
        {
            var i = 0;
            double mx = 0;
            double v = 0;
        ...
        *************************************************************************/
        public static void xcdot(complex[] a, complex[] b, int n, ref double[] temp, ref complex r, ref double rerr, xparams _params)
        {
            var i = 0;
            double mx = 0;
            double v = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 24.08.2009 by Bochkanov Sergey
        *************************************************************************/
        private static void xsum(ref double[] w, double mx, int n, ref double r, ref double rerr, xparams _params)
        {
            var i = 0;
            var k = 0;
            var ks = 0;
            ...
            if (!math.isfinite(s))
            {
                ...
                r = 0;
                rerr = mx * math.machineepsilon;
                for (i = 0; i <= n - 1; i++) r = r + w[i];

                return;
            }

            while (s * mx >= 1) s = 0.5 * s;

            while (s * mx < 0.5) s = 2 * s;

            for (i_ = 0; i_ <= n - 1; i_++) w[i_] = s * w[i_];
            ...
            //
            k = (int)(Math.Log(536870912 / (double)n) / ln2);
            ...
            //
            r = 0;
            for (i_ = 0; i_ <= n - 1; i_++) w[i_] = chunk * w[i_];
        ...
        Fast Pow
          ...
          -- ALGLIB --
             Copyright 24.08.2009 by Bochkanov Sergey
        *************************************************************************/
        private static double xfastpow(double r, int n, xparams _params)
        {
            double result = 0;
            ...
            if (n < 0) result = xfastpow(1 / r, -n, _params);
    ...
    public class linmin
    {
        ...
        *************************************************************************/
        public static void linminnormalized(ref double[] d, ref double stp, int n, xparams _params)
        {
            double mx = 0;
            double s = 0;
            var i = 0;
            ...
            //
            mx = 0;
            for (i = 0; i <= n - 1; i++) mx = Math.Max(mx, Math.Abs(d[i]));

            if (mx == 0) return;

            s = 1 / mx;
            for (i_ = 0; i_ <= n - 1; i_++) d[i_] = s * d[i_];
            ...
            //
            s = 0.0;
            for (i_ = 0; i_ <= n - 1; i_++) s += d[i_] * d[i_];
            ...
            ref int info, ref int nfev, ref double[] wa, linminstate state, ref int stage, xparams _params)
        {
            ...
            while (true)
            {
                ...
                if (stage == 2)
                {
                    ...
                    //
                    v = 0.0;
                    for (i_ = 0; i_ <= n - 1; i_++) v += g[i_] * s[i_];
                ...
                if (stage == 3)
                {
                    ...
                    //
                    if ((state.brackt && (stp <= state.stmin || stp >= state.stmax))
                        || nfev >= maxfev - 1
                        || state.infoc == 0
                    ...
                    //
                    for (i_ = 0; i_ <= n - 1; i_++) x[i_] = wa[i_];

                    for (i_ = 0; i_ <= n - 1; i_++) x[i_] = x[i_] + stp * s[i_];
                ...
                if (stage == 4)
                {
                    ...
                    //
                    if ((state.brackt && (stp <= state.stmin || stp >= state.stmax)) || state.infoc == 0) info = 6;

                    if (stp == stpmax && f < state.finit && f <= state.ftest1 && state.dg <= state.dgtest)
                        info = 5;

                    if (stp == stpmin && (f >= state.finit || f > state.ftest1 || state.dg >= state.dgtest))
                        info = 4;

                    if (nfev >= maxfev) info = 3;

                    if (state.brackt && state.stmax - state.stmin <= xtol * state.stmax) info = 2;

                    if (f < state.finit && f <= state.ftest1 && Math.Abs(state.dg) <= -(gtol * state.dginit))
                        info = 1;
                    ...
                    if (info != 0)
                    {
                        ...
                        {
                            v = 0.0;
                            for (i = 0; i <= n - 1; i++) v = v + (wa[i] - x[i]) * (wa[i] - x[i]);

                            if (f >= state.finit || v == 0.0) info = 6;
                        }
        ...
        *************************************************************************/
        public static void armijocreate(int n, double[] x, double f, double[] s, double stp, double stpmax, int fmax, armijostate state,
            xparams _params)
        {
            var i_ = 0;

            if (ap.len(state.x) < n) state.x = new double[n];

            if (ap.len(state.xbase) < n) state.xbase = new double[n];

            if (ap.len(state.s) < n) state.s = new double[n];
            ...
            state.fcur = f;
            state.n = n;
            for (i_ = 0; i_ <= n - 1; i_++) state.xbase[i_] = x[i_];

            for (i_ = 0; i_ <= n - 1; i_++) state.s[i_] = s[i_];
        ...
        This is rcomm-based search function
          ...
          -- ALGLIB --
             Copyright 05.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static bool armijoiteration(armijostate state, xparams _params)
        {
            var result = new bool();
            double v = 0;
            var n = 0;
            ...
            // Routine body
            //
            if (state.stplen <= 0 || state.stpmax < 0 || state.fmax < 2)
            {
                state.info = 0;
                result = false;
                return result;
            ...
            // Bound StpLen
            //
            if (state.stplen > state.stpmax && state.stpmax != 0) state.stplen = state.stpmax;

            //
            // Increase length
            //
            v = state.stplen * armijofactor;
            if (v > state.stpmax && state.stpmax != 0) v = state.stpmax;

            for (i_ = 0; i_ <= n - 1; i_++) state.x[i_] = state.xbase[i_];

            for (i_ = 0; i_ <= n - 1; i_++) state.x[i_] = state.x[i_] + v * state.s[i_];

            state.rstate.stage = 0;
            goto lbl_rcomm;
            lbl_0:
            state.nfev = state.nfev + 1;
            if (state.f >= state.fcur) goto lbl_4;
            ...
            lbl_2:
            state.nfev = state.nfev + 1;
            if (state.f >= state.fcur) goto lbl_8;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 05.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void armijoresults(armijostate state, ref int info, ref double stp, ref double f, xparams _params)
        {
            info = state.info;
            stp = state.stplen;
            f = state.fcur;
    ...
    {
        public static double nulog1p(double x, xparams _params)
        {
            double result = 0;
            double z = 0;
            double lp = 0;
        ...
        public static double nuexpm1(double x, xparams _params)
        {
            double result = 0;
            double r = 0;
            double xx = 0;
        ...
        public static double nucosm1(double x, xparams _params)
        {
            double result = 0;
            double xx = 0;
            double c = 0;

            if (x < -(0.25 * Math.PI) || x > 0.25 * Math.PI)
            {
                result = Math.Cos(x) - 1;
                return result;
            }
    ...
    {
        public static void findprimitiverootandinverse(int n, ref int proot, ref int invproot, xparams _params)
        {
            var candroot = 0;
            var phin = 0;
            var q = 0;
        ...
        private static bool isprime(int n, xparams _params)
        {
            var result = new bool();
            var p = 0;
        ...
        private static int modmul(int a, int b, int n, xparams _params)
        {
            var result = 0;
            var t = 0;
            double ra = 0;
        ...
        private static int modexp(int a, int b, int n, xparams _params)
        {
            var result = 0;
            var t = 0;
    ...
    public class ftbase
    {
        ...
        *************************************************************************/
        public static void ftcomplexfftplan(int n, int k, fasttransformplan plan, xparams _params)
        {
            ...
            if (precrsize > 0) plan.precr = new double[precrsize];

            if (precisize > 0) plan.preci = new double[precisize];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 05.04.2013 by Bochkanov Sergey
        *************************************************************************/
        public static void ftapplyplan(fasttransformplan plan, double[] a, int offsa, int repcnt, xparams _params)
        {
            var plansize = 0;
            var i = 0;
        ...
        *************************************************************************/
        public static void ftbasefactorize(int n, int tasktype, ref int n1, ref int n2, xparams _params)
        {
            var j = 0;
        ...
        Is number smooth?
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static bool ftbaseissmooth(int n, xparams _params)
        {
            var result = new bool();
            var i = 0;
        ...
        than or equal to max(N,2)
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static int ftbasefindsmooth(int n, xparams _params)
        {
            var result = 0;
            var best = 0;
        ...
        greater than or equal to max(N,2)
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static int ftbasefindsmootheven(int n, xparams _params)
        {
            var result = 0;
            var best = 0;
        ...
        N should be power of 2, estimates are badly wrong for non-power-of-2 N's.
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static double ftbasegetflopestimate(int n, xparams _params)
        {
            double result = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 05.04.2013 by Bochkanov Sergey
        *************************************************************************/
        private static void ftdeterminespacerequirements(int n, ref int precrsize, ref int precisize, xparams _params)
        {
            var ncur = 0;
            var f = 0;
            var i = 0;
        ...
        NOTE: in case TopmostPlan is True, ChildPlan is also must be True.
          ...
          -- ALGLIB --
             Copyright 05.04.2013 by Bochkanov Sergey
        *************************************************************************/
        private static void ftcomplexfftplanrec(int n, int k, bool childplan, bool topmostplan, ref int rowptr, ref int bluesteinsize,
            ref int precrptr, ref int preciptr, fasttransformplan plan, xparams _params)
        {
        ...
        *************************************************************************/
            ...
            while (plan.entries[rowidx, coltype] != opend)
            {
                ...
                if (operation == opbluesteinsfft)
                {
                    ...
                    ftbluesteinsfft(
                        ...
                        operandscnt,
                        operandsize,
                        plan.entries[rowidx, colparam0],
                        plan.entries[rowidx, colparam2],
                        rowidx + plan.entries[rowidx, colparam1],
                        bufa.val,
                        bufb.val,
                        bufc.val,
                        bufd.val,
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 05.04.2013 by Bochkanov Sergey
        *************************************************************************/
        private static void ftapplycomplexreffft(double[] a, int offs, int operandscnt, int operandsize, int microvectorsize, double[] buf,
            xparams _params)
        {
            var opidx = 0;
            var i = 0;
            ...
            for (opidx = 0; opidx <= operandscnt - 1; opidx++)
            {
                ...
                for (i = 0; i <= operandsize * 2 - 1; i++) a[offs + opidx * operandsize * 2 + i] = buf[i];
            }
        }
        ...
        *************************************************************************/
        private static void ftprecomputebluesteinsfft(int n, int m, double[] precr, int offs, xparams _params)
        {
            var i = 0;
            double bx = 0;
            double by = 0;
            ...
            //
            for (i = 0; i <= 2 * m - 1; i++) precr[offs + i] = 0;
            ...
            for (i = 0; i <= 2 * m - 1; i++) precr[offs + 2 * m + i] = precr[offs + i];
        ...
        *************************************************************************/
        ...
        NOTE: this function performs internal (N-1)-point FFT. It allocates temporary
          ...
          -- ALGLIB --
             Copyright 08.05.2013 by Bochkanov Sergey
        *************************************************************************/
        private static void ftprecomputeradersfft(int n, int rq, int riq, double[] precr, int offs, xparams _params)
        {
            var q = 0;
            var plan = new fasttransformplan();
            var kiq = 0;
        ...
        *************************************************************************/
        private static void ftfactorize(int n, bool isroot, ref int n1, ref int n2, xparams _params)
        {
            var j = 0;
            var k = 0;
        ...
        NOTE: If FFT cost is less than 1 UNIT, it will return 0 as result.
          ...
          -- ALGLIB --
             Copyright 08.04.2013 by Bochkanov Sergey
        *************************************************************************/
        private static int ftoptimisticestimate(int n, xparams _params)
        {
            var result = 0;
        ...
        Twiddle factors calculation
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        private static void ffttwcalc(double[] a, int aoffset, int n1, int n2, xparams _params)
        {
            var i = 0;
            var j2 = 0;
            var n = 0;
        ...
        Linear transpose: transpose complex matrix stored in 1-dimensional array
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        private static void internalcomplexlintranspose(double[] a, int m, int n, int astart, double[] buf, xparams _params)
        {
            var i_ = 0;
            var i1_ = 0;
            ...
            i1_ = 0 - astart;
            for (i_ = astart; i_ <= astart + 2 * m * n - 1; i_++) a[i_] = buf[i_ + i1_];
        }
        ...
        *************************************************************************/
        ...
        recurrent subroutine for FFTFindSmoothRec
          ...
          -- ALGLIB --
             Copyright 01.05.2009 by Bochkanov Sergey
        *************************************************************************/
        private static void ftbasefindsmoothrec(int n, int seed, int leastfactor, ref int best, xparams _params)
        {
            ...
            if (leastfactor <= 2) ftbasefindsmoothrec(n, seed * 2, 2, ref best, _params);

            if (leastfactor <= 3) ftbasefindsmoothrec(n, seed * 3, 3, ref best, _params);

            if (leastfactor <= 5) ftbasefindsmoothrec(n, seed * 5, 5, ref best, _params);
        }
    ...
    public class hpccores
    {
        ...
        *************************************************************************/
        public static void hpcpreparechunkedgradient(double[] weights, int wcount, int ntotal, int nin, int nout, mlpbuffers buf, xparams _params)
        {
            ...
            if (ap.len(buf.x) < nin) buf.x = new double[nin];

            if (ap.len(buf.y) < nout) buf.y = new double[nout];

            if (ap.len(buf.desiredy) < nout) buf.desiredy = new double[nout];

            if (ap.len(buf.batch4buf) < batch4size) buf.batch4buf = new double[batch4size];

            if (ap.len(buf.hpcbuf) < wcount) buf.hpcbuf = new double[wcount];

            if (ap.len(buf.g) < wcount) buf.g = new double[wcount];
        ...
        *************************************************************************/
        public static void hpcfinalizechunkedgradient(mlpbuffers buf, double[] grad, xparams _params)
        {
            var i = 0;
        ...
        *************************************************************************/
        public static bool hpcchunkedgradient(double[] weights, int[] structinfo, double[] columnmeans, double[] columnsigmas, double[,] xy,
            int cstart, int csize, double[] batch4buf, double[] hpcbuf, ref double e, bool naturalerrorfunc, xparams _params)
        {
            var result = new bool();
        ...
        *************************************************************************/
        public static bool hpcchunkedprocess(double[] weights, int[] structinfo, double[] columnmeans, double[] columnsigmas, double[,] xy,
            int cstart, int csize, double[] batch4buf, double[] hpcbuf, xparams _params)
        {
            var result = new bool();
        ...
        Stub function.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        private static bool hpcpreparechunkedgradientx(double[] weights, int wcount, double[] hpcbuf, xparams _params)
        {
            var result = new bool();
        ...
        Stub function.
          ...
          -- ALGLIB routine --
             ...
             Bochkanov Sergey
        *************************************************************************/
        private static bool hpcfinalizechunkedgradientx(double[] buf, int wcount, double[] grad, xparams _params)
        {
            var result = new bool();
