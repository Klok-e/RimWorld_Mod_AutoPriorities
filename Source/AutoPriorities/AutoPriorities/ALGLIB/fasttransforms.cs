...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void fftc1d(complex[] a, int n, xparams _params)
    {
    ...
    public static void fftc1d(complex[] a, xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void fftc1dinv(complex[] a, int n, xparams _params)
    {
    ...
    public static void fftc1dinv(complex[] a, xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void fftr1dbuf(double[] a, int n, ref complex[] f, xparams _params)
    {
    ...
    public static void fftr1dbuf(double[] a, ref complex[] f, xparams _params)
    {
        int n;
    ...
    *************************************************************************/
    ...
    public static void fftr1dinvbuf(complex[] f, int n, ref double[] a, xparams _params)
    {
    ...
    public static void fftr1dinvbuf(complex[] f, ref double[] a, xparams _params)
    {
        int n;
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void fhtr1d(double[] a, int n, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void fhtr1dinv(double[] a, int n, xparams _params)
    {
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void convc1dbuf(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convc1dinvbuf(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convc1dcircularbuf(complex[] s, int m, complex[] r, int n, ref complex[] c, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convc1dcircularinvbuf(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convr1dbuf(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convr1dinvbuf(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convr1dcircularbuf(double[] s, int m, double[] r, int n, ref double[] c, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void convr1dcircularinvbuf(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
    {
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void corrc1dbuf(complex[] signal, int n, complex[] pattern, int m, ref complex[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void corrc1dcircularbuf(complex[] signal, int m, complex[] pattern, int n, ref complex[] c, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void corrr1dbuf(double[] signal, int n, double[] pattern, int m, ref double[] r, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void corrr1dcircularbuf(double[] signal, int m, double[] pattern, int n, ref double[] c, xparams _params)
    {
    ...
    public class fft
    {
        ...
        *************************************************************************/
        ...
        other FFT-related subroutines.
          ...
          -- ALGLIB --
             Copyright 01.06.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void fftr1d(double[] a, int n, ref complex[] f, xparams _params)
        {
            f = new complex[0];
        ...
        *************************************************************************/
        public static void fftr1dbuf(double[] a, int n, ref complex[] f, xparams _params)
        {
            ...
            ap.assert(n > 0, "FFTR1DBuf: incorrect N!");
            ap.assert(ap.len(a) >= n, "FFTR1DBuf: Length(A)<N!");
            ap.assert(apserv.isfinitevector(a, n, _params), "FFTR1DBuf: A contains infinite or NAN values!");
            ...
            if (n % 2 == 0)
            {
                ...
                n2 = n / 2;
                buf = new double[n];
                for (i_ = 0; i_ <= n - 1; i_++) buf[i_] = a[i_];
                ...
                for (i = n2 + 1; i <= n - 1; i++) f[i] = math.conj(f[n - i]);
            }
            else
            {
                //
        ...
        not used) because array size is used to automatically determine FFT length
          ...
          -- ALGLIB --
             Copyright 01.06.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void fftr1dinv(complex[] f, int n, ref double[] a, xparams _params)
        {
            var i = 0;
            var h = new double[0];
            ...
            ap.assert(ap.len(f) >= (int)Math.Floor(n / (double)2) + 1, "FFTR1DInv: Length(F)<Floor(N/2)+1!");
            ap.assert(math.isfinite(f[0].x), "FFTR1DInv: F contains infinite or NAN values!");
            for (i = 1; i <= (int)Math.Floor(n / (double)2) - 1; i++)
        ...
        *************************************************************************/
        public static void fftr1dinvbuf(complex[] f, int n, ref double[] a, xparams _params)
        {
            ...
            ap.assert(n > 0, "FFTR1DInvBuf: incorrect N!");
            ap.assert(ap.len(f) >= (int)Math.Floor(n / (double)2) + 1, "FFTR1DInvBuf: Length(F)<Floor(N/2)+1!");
            ap.assert(math.isfinite(f[0].x), "FFTR1DInvBuf: F contains infinite or NAN values!");
            for (i = 1; i <= (int)Math.Floor(n / (double)2) - 1; i++)
            ...
            else
            {
                ...
                h[(int)Math.Floor(n / (double)2) + 1] = f[(int)Math.Floor(n / (double)2)].x + f[(int)Math.Floor(n / (double)2)].y;
            }

            fftr1d(h, n, ref fh, _params);
            for (i = 0; i <= n - 1; i++) a[i] = (fh[i].x - fh[i].y) / n;
        }
        ...
        Internal subroutine. Never call it directly!
          ...
          -- ALGLIB --
             Copyright 01.06.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void fftr1dinternaleven(ref double[] a, int n, ref double[] buf, ftbase.fasttransformplan plan, xparams _params)
        {
            double x = 0;
            double y = 0;
            var i = 0;
        ...
        Internal subroutine. Never call it directly!
          ...
          -- ALGLIB --
             Copyright 01.06.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void fftr1dinvinternaleven(ref double[] a, int n, ref double[] buf, ftbase.fasttransformplan plan, xparams _params)
        {
            double x = 0;
            double y = 0;
            double t = 0;
    ...
    public class fht
    {
        ...
        *************************************************************************/
        public static void fhtr1d(double[] a, int n, xparams _params)
        {
            ...
            for (i = 0; i <= n - 1; i++) a[i] = fa[i].x - fa[i].y;
        }
    ...
    public class conv
    {
        ...
        NOTE: there is a buffered version of this  function,  ConvC1DBuf(),  which
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convc1d(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
        {
            r = new complex[0];
        ...
        *************************************************************************/
        public static void convc1dbuf(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
        {
            ap.assert(n > 0 && m > 0, "ConvC1DBuf: incorrect N or M!");
        ...
        NOTE: there is a buffered version of this  function,  ConvC1DInvBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convc1dinv(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
        {
            r = new complex[0];
        ...
        *************************************************************************/
        public static void convc1dinvbuf(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
        {
            ...
            ap.assert(n > 0 && m > 0 && n <= m, "ConvC1DInvBuf: incorrect N or M!");
        ...
        NOTE: there is a buffered version of this  function,  ConvC1DCircularBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convc1dcircular(complex[] s, int m, complex[] r, int n, ref complex[] c, xparams _params)
        {
            c = new complex[0];
        ...
        *************************************************************************/
        public static void convc1dcircularbuf(complex[] s, int m, complex[] r, int n, ref complex[] c, xparams _params)
        {
            ...
            if (m < n)
            {
                ...
                while (i1 < n)
                {
                    ...
                    j2 = i2 - i1;
                    i1_ = i1 - 0;
                    for (i_ = 0; i_ <= j2; i_++) buf[i_] = buf[i_] + r[i_ + i1_];
        ...
        NOTE: there is a buffered version of this  function,  ConvC1DCircularInvBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convc1dcircularinv(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
        {
            r = new complex[0];
        ...
        *************************************************************************/
        public static void convc1dcircularinvbuf(complex[] a, int m, complex[] b, int n, ref complex[] r, xparams _params)
        {
            ...
            if (m < n)
            {
                ...
                while (i1 < n)
                {
                    ...
                    j2 = i2 - i1;
                    i1_ = i1 - 0;
                    for (i_ = 0; i_ <= j2; i_++) cbuf[i_] = cbuf[i_] + b[i_ + i1_];
        ...
        NOTE: there is a buffered version of this  function,  ConvR1DBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convr1d(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
        {
            r = new double[0];
        ...
        *************************************************************************/
        public static void convr1dbuf(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
        {
            ap.assert(n > 0 && m > 0, "ConvR1DBuf: incorrect N or M!");
        ...
        NOTE: there is a buffered version of this  function,  ConvR1DInvBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convr1dinv(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
        {
            r = new double[0];
        ...
        *************************************************************************/
        public static void convr1dinvbuf(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
        {
            ...
            ap.assert(n > 0 && m > 0 && n <= m, "ConvR1DInvBuf: incorrect N or M!");
            p = ftbase.ftbasefindsmootheven(m, _params);
            buf = new double[p];
            for (i_ = 0; i_ <= m - 1; i_++) buf[i_] = a[i_];

            for (i = m; i <= p - 1; i++) buf[i] = 0;

            buf2 = new double[p];
            for (i_ = 0; i_ <= n - 1; i_++) buf2[i_] = b[i_];

            for (i = n; i <= p - 1; i++) buf2[i] = 0;
            ...
            for (i_ = 0; i_ <= m - n; i_++) r[i_] = buf[i_];
        }
        ...
        NOTE: there is a buffered version of this  function,  ConvR1DCurcularBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convr1dcircular(double[] s, int m, double[] r, int n, ref double[] c, xparams _params)
        {
            c = new double[0];
        ...
        *************************************************************************/
        public static void convr1dcircularbuf(double[] s, int m, double[] r, int n, ref double[] c, xparams _params)
        {
            ...
            ap.assert(n > 0 && m > 0, "ConvC1DCircularBuf: incorrect N or M!");
        ...
        correspondingly.
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convr1dcircularinv(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
        {
            r = new double[0];
        ...
        *************************************************************************/
        public static void convr1dcircularinvbuf(double[] a, int m, double[] b, int n, ref double[] r, xparams _params)
        {
            ...
            if (m < n)
            {
                ...
                while (i1 < n)
                {
                    ...
                    j2 = i2 - i1;
                    i1_ = i1 - 0;
                    for (i_ = 0; i_ <= j2; i_++) buf[i_] = buf[i_] + b[i_ + i1_];
            ...
            if (m % 2 == 0)
            {
                ...
                for (i_ = 0; i_ <= m - 1; i_++) r[i_] = buf[i_];
            }
            else
            {
                //
                ...
                for (i = 0; i <= (int)Math.Floor(m / (double)2); i++) cbuf[i] = cbuf[i] / cbuf2[i];
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convc1dx(complex[] a, int m, complex[] b, int n, bool circular, int alg, int q, ref complex[] r, xparams _params)
        {
            var i = 0;
            var j = 0;
            var p = 0;
            ...
            if (alg == -1 || alg == -2)
            {
                ...
                q = 1;
                ptotal = 1;
                while (ptotal < n) ptotal = ptotal * 2;

                while (ptotal <= m + n - 1)
                {
                    p = ptotal - n + 1;
                    flopcand = (int)Math.Ceiling(m / (double)p) * (2 * ftbase.ftbasegetflopestimate(ptotal, _params) + 8 * ptotal);
                    if (flopcand < flopbest)
                    {
                        flopbest = flopcand;
                        algbest = 2;
            ...
            if (alg == 0)
            {
                ...
                if (n == 1)
                {
                    ablasf.callocv(m, ref r, _params);
                    v = b[0];
                    for (i_ = 0; i_ <= m - 1; i_++) r[i_] = v * a[i_];
                ...
                if (circular)
                {
                    ...
                    for (i = 1; i <= n - 1; i++)
                    {
                        ...
                        j2 = m - 1;
                        i1_ = j1 - i1;
                        for (i_ = i1; i_ <= i2; i_++) r[i_] = r[i_] + v * a[i_ + i1_];
                ...
                else
                {
                    ...
                    //
                    ablasf.callocv(m + n - 1, ref r, _params);
                    for (i = 0; i <= m + n - 2; i++) r[i] = 0;

                    for (i = 0; i <= n - 1; i++)
                    {
                        v = b[i];
                        i1_ = 0 - i;
                        for (i_ = i; i_ <= i + m - 1; i_++) r[i_] = r[i_] + v * a[i_ + i1_];
                    }
                }
            ...
            if (alg == 2)
            {
                ...
                for (i_ = 0; i_ <= n - 1; i_++) bbuf[i_] = b[i_];

                for (j = n; j <= q + n - 2; j++) bbuf[j] = 0;
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void convr1dx(double[] a, int m, double[] b, int n, bool circular, int alg, int q, ref double[] r, xparams _params)
        {
            double v = 0;
            var i = 0;
            var j = 0;
            ...
            ap.assert(n > 0 && m > 0, "ConvR1DX: incorrect N or M!");
            ap.assert(n <= m, "ConvR1DX: N<M assumption is false!");

            //
            // handle special cases
            //
            if (Math.Min(m, n) <= 2) alg = 0;
            ...
            if (alg < 0)
            {
                ...
                if (alg == -1)
                {
                    if (circular && ftbase.ftbaseissmooth(m, _params) && m % 2 == 0)
                    {
                        ...
                        // special code for circular convolution of a sequence with a smooth length
                        //
                        flopcand = 3 * ftbase.ftbasegetflopestimate(m / 2, _params) + 6 * m / (double)2;
                        if (flopcand < flopbest)
                        {
                            algbest = 1;
                            flopbest = flopcand;
                    ...
                    else
                    {
                        ...
                        flopcand = 3 * ftbase.ftbasegetflopestimate(p / 2, _params) + 6 * p / (double)2;
                        if (flopcand < flopbest)
                        {
                            algbest = 1;
                            flopbest = flopcand;
            ...
            if (alg == 1)
            {
                ...
                else
                {
                    ...
                    if (circular)
                    {
                        ...
                        {
                            i1_ = m - 0;
                            for (i_ = 0; i_ <= n - 2; i_++) r[i_] = r[i_] + buf[i_ + i1_];
                        }
                    }
                    else
                    {
                        ...
                        //
                        ablasf.rallocv(m + n - 1, ref r, _params);
                        for (i_ = 0; i_ <= m + n - 2; i_++) r[i_] = buf[i_];
                    }
                }
            ...
            if (alg == 2)
            {
                ...
                while (i <= m - 1)
                {
                    p = Math.Min(q, m - i);
                    i1_ = i - 0;
                    for (i_ = 0; i_ <= p - 1; i_++) buf[i_] = a[i_ + i1_];

                    for (j = p; j <= q + n - 2; j++) buf[j] = 0;
                    ...
                    i1_ = 0 - i;
                    for (i_ = i; i_ <= i + j1; i_++) r[i_] = r[i_] + buf[i_ + i1_];

                    if (p + n - 2 >= j2)
                    {
                        i1_ = j2 - 0;
                        for (i_ = 0; i_ <= p + n - 2 - j2; i_++) r[i_] = r[i_] + buf[i_ + i1_];
                    }
    ...
    public class corr
    {
        ...
        NOTE: there is a buffered version of this  function,  CorrC1DBuf(), which
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void corrc1d(complex[] signal, int n, complex[] pattern, int m, ref complex[] r, xparams _params)
        {
            r = new complex[0];
        ...
        *************************************************************************/
        public static void corrc1dbuf(complex[] signal, int n, complex[] pattern, int m, ref complex[] r, xparams _params)
        {
            ...
            ap.assert(n > 0 && m > 0, "CorrC1DBuf: incorrect N or M!");
            p = new complex[m];
            for (i = 0; i <= m - 1; i++) p[m - 1 - i] = math.conj(pattern[i]);

            conv.convc1d(p, m, signal, n, ref b, _params);
            ablasf.callocv(m + n - 1, ref r, _params);
            i1_ = m - 1 - 0;
            for (i_ = 0; i_ <= n - 1; i_++) r[i_] = b[i_ + i1_];

            if (m + n - 2 >= n)
            {
                i1_ = 0 - n;
                for (i_ = n; i_ <= m + n - 2; i_++) r[i_] = b[i_ + i1_];
            }
        }
        ...
        NOTE: there is a buffered version of this  function,  CorrC1DCircular(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void corrc1dcircular(complex[] signal, int m, complex[] pattern, int n, ref complex[] c, xparams _params)
        {
            var p = new complex[0];
            var b = new complex[0];
            var i1 = 0;
            ...
            if (m < n)
            {
                ...
                while (i1 < n)
                {
                    ...
                    j2 = i2 - i1;
                    i1_ = i1 - 0;
                    for (i_ = 0; i_ <= j2; i_++) b[i_] = b[i_] + pattern[i_ + i1_];
            ...
            //
            p = new complex[n];
            for (i = 0; i <= n - 1; i++) p[n - 1 - i] = math.conj(pattern[i]);

            conv.convc1dcircular(signal, m, p, n, ref b, _params);
            c = new complex[m];
            i1_ = n - 1 - 0;
            for (i_ = 0; i_ <= m - n; i_++) c[i_] = b[i_ + i1_];

            if (m - n + 1 <= m - 1)
            {
                i1_ = 0 - (m - n + 1);
                for (i_ = m - n + 1; i_ <= m - 1; i_++) c[i_] = b[i_ + i1_];
            }
        }
        ...
        *************************************************************************/
        ...
        NOTE: there is a buffered version of this  function,  CorrR1DBuf(),  which
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void corrr1d(double[] signal, int n, double[] pattern, int m, ref double[] r, xparams _params)
        {
            r = new double[0];
        ...
        *************************************************************************/
        public static void corrr1dbuf(double[] signal, int n, double[] pattern, int m, ref double[] r, xparams _params)
        {
            ...
            ap.assert(n > 0 && m > 0, "CorrR1DBuf: incorrect N or M!");
            p = new double[m];
            for (i = 0; i <= m - 1; i++) p[m - 1 - i] = pattern[i];
        ...
        NOTE: there is a buffered version of this  function,  CorrR1DCircularBuf(),
          ...
          -- ALGLIB --
             Copyright 21.07.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void corrr1dcircular(double[] signal, int m, double[] pattern, int n, ref double[] c, xparams _params)
        {
            c = new double[0];
        ...
        *************************************************************************/
        public static void corrr1dcircularbuf(double[] signal, int m, double[] pattern, int n, ref double[] c, xparams _params)
        {
            ...
            //
            p = new double[n];
            for (i = 0; i <= n - 1; i++) p[n - 1 - i] = pattern[i];
