...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    OUTPUT PARAMETERS:
      ...
      -- ALGLIB --
         Copyright 2005-2009 by Bochkanov Sergey
    *************************************************************************/
    public static void gqgenerategaussradaurec(double[] alpha, double[] beta, double mu0, double a, int n, out int info, out double[] x,
        out double[] w)
    {
        info = 0;
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausslegendre(int n, out int info, out double[] x, out double[] w, xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausslaguerre(int n, double alpha, out int info, out double[] x, out double[] w, xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gqgenerategausshermite(int n, out int info, out double[] x, out double[] w, xparams _params)
    {
        info = 0;
        x = new double[0];
        w = new double[0];
...
public partial class alglib
{
    ...
    *************************************************************************/
    public static void gkqgeneraterec(double[] alpha, double[] beta, double mu0, int n, out int info, out double[] x, out double[] wkronrod,
        out double[] wgauss)
    {
        info = 0;
        x = new double[0];
    ...
    public static void gkqgeneraterec(double[] alpha, double[] beta, double mu0, int n, out int info, out double[] x, out double[] wkronrod,
        out double[] wgauss, xparams _params)
    {
        info = 0;
        x = new double[0];
        wkronrod = new double[0];
    ...
    *************************************************************************/
    ...
    OUTPUT PARAMETERS:
      ...
      -- ALGLIB --
         Copyright 12.05.2009 by Bochkanov Sergey
    *************************************************************************/
    public static void gkqgenerategaussjacobi(int n, double alpha, double beta, out int info, out double[] x, out double[] wkronrod,
        out double[] wgauss)
    {
        info = 0;
        x = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gkqlegendrecalc(int n, out int info, out double[] x, out double[] wkronrod, out double[] wgauss, xparams _params)
    {
        info = 0;
        x = new double[0];
        wkronrod = new double[0];
    ...
    *************************************************************************/
    ...
    public static void gkqlegendretbl(int n, out double[] x, out double[] wkronrod, out double[] wgauss, out double eps, xparams _params)
    {
        x = new double[0];
        wkronrod = new double[0];
        wgauss = new double[0];
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void autogksmooth(double a, double b, out autogkstate state, xparams _params)
    {
        state = new autogkstate();
    ...
    *************************************************************************/
    ...
    public static void autogksmoothw(double a, double b, double xwidth, out autogkstate state, xparams _params)
    {
        state = new autogkstate();
    ...
    *************************************************************************/
    ...
    public static void autogksingular(double a, double b, double alpha, double beta, out autogkstate state, xparams _params)
    {
        state = new autogkstate();
    ...
    *************************************************************************/
    ...
    public static bool autogkiteration(autogkstate state, xparams _params)
    {
    ...
    *************************************************************************/
    ...
    public static void autogkintegrate(autogkstate state, integrator1_func func, object obj, xparams _params)
    {
        if (func == null)
            throw new alglibexception("ALGLIB: error in 'autogkintegrate()' (func is null)");
        while (autogkiteration(state, _params))
        {
            if (state.needf)
            {
    ...
    *************************************************************************/
    ...
    public static void autogkresults(autogkstate state, out double v, out autogkreport rep, xparams _params)
    {
        v = 0;
        rep = new autogkreport();
    ...
    *************************************************************************/
    public class autogkreport : alglibobject
    {
        ...
        public autogkreport()
        {
            innerobj = new autogk.autogkreport();
        }
        ...
        {
            get => innerobj.nfev;
            set => innerobj.nfev = value;
        }

        public int nintervals
        {
            get => innerobj.nintervals;
            set => innerobj.nintervals = value;
        }

        public autogk.autogkreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new autogkreport((autogk.autogkreport)innerobj.make_copy());
        }
    }
    ...
    *************************************************************************/
    public class autogkstate : alglibobject
    {
        ...
        public autogkstate()
        {
            innerobj = new autogk.autogkstate();
        }
        ...
        {
            get => innerobj.x;
            set => innerobj.x = value;
        }

        public double xminusa
        {
            get => innerobj.xminusa;
            set => innerobj.xminusa = value;
        }

        public double bminusx
        {
            get => innerobj.bminusx;
            set => innerobj.bminusx = value;
        }
        ...
        public autogk.autogkstate innerobj { get; }

        public override alglibobject make_copy()
        {
            return new autogkstate((autogk.autogkstate)innerobj.make_copy());
        }
    }
}
    ...
    public class gq
    {
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 2005-2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gqgeneraterec(double[] alpha, double[] beta, double mu0, int n, ref int info, ref double[] x, ref double[] w,
            xparams _params)
        {
            var i = 0;
            var d = new double[0];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 2005-2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gqgenerategausslobattorec(double[] alpha, double[] beta, double mu0, double a, double b, int n, ref int info,
            ref double[] x, ref double[] w, xparams _params)
        {
            var i = 0;
            var d = new double[0];
            var e = new double[0];
            ...
            d = new double[n + 2];
            e = new double[n + 1];
            for (i = 1; i <= n + 1; i++) d[i - 1] = alpha[i - 1];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 2005-2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gqgenerategaussradaurec(double[] alpha, double[] beta, double mu0, double a, int n, ref int info, ref double[] x,
            ref double[] w, xparams _params)
        {
            var i = 0;
            var d = new double[0];
            var e = new double[0];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 12.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gqgenerategausslegendre(int n, ref int info, ref double[] x, ref double[] w, xparams _params)
        {
            var alpha = new double[0];
            var beta = new double[0];
            var i = 0;
            ...
            alpha = new double[n];
            beta = new double[n];
            for (i = 0; i <= n - 1; i++) alpha[i] = 0;

            beta[0] = 2;
            for (i = 1; i <= n - 1; i++) beta[i] = 1 / (4 - 1 / math.sqr(i));
        ...
        *************************************************************************/
        public static void gqgenerategaussjacobi(int n, double alpha, double beta, ref int info, ref double[] x, ref double[] w, xparams _params)
        {
            ...
            if (t > Math.Log(math.maxrealnumber))
            {
                info = -4;
                return;
            }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 12.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gqgenerategausslaguerre(int n, double alpha, ref int info, ref double[] x, ref double[] w, xparams _params)
        {
            var a = new double[0];
            var b = new double[0];
            double t = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 12.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gqgenerategausshermite(int n, ref int info, ref double[] x, ref double[] w, xparams _params)
        {
            var a = new double[0];
            var b = new double[0];
            var i = 0;
    ...
    public class gkq
    {
        ...
        *************************************************************************/
            ...
            ref double[] wgauss, xparams _params)
        {
            ...
            var l = 0;
            var k = 0;
            var xgtmp = new double[0];
            var wgtmp = new double[0];
            var i_ = 0;
            ...
            for (i = 0; i <= (int)Math.Ceiling(3 * (n / 2) / (double)2); i++)
                if (beta[i] <= 0)
                {
                    info = -2;
                    return;
            ...
            //
            ta = new double[(int)Math.Floor(3 * n / (double)2) + 1];
            for (i_ = 0; i_ <= (int)Math.Floor(3 * n / (double)2); i_++) ta[i_] = alpha[i_];

            alpha = new double[2 * n + 1];
            for (i_ = 0; i_ <= (int)Math.Floor(3 * n / (double)2); i_++) alpha[i_] = ta[i_];

            for (i = (int)Math.Floor(3 * n / (double)2) + 1; i <= 2 * n; i++) alpha[i] = 0;

            ta = new double[(int)Math.Ceiling(3 * n / (double)2) + 1];
            for (i_ = 0; i_ <= (int)Math.Ceiling(3 * n / (double)2); i_++) ta[i_] = beta[i_];

            beta = new double[2 * n + 1];
            for (i_ = 0; i_ <= (int)Math.Ceiling(3 * n / (double)2); i_++) beta[i_] = ta[i_];

            for (i = (int)Math.Ceiling(3 * n / (double)2) + 1; i <= 2 * n; i++) beta[i] = 0;
            ...
            for (m = 0; m <= n - 2; m++)
            {
                ...
                for (i_ = 0; i_ <= wlen - 1; i_++) ta[i_] = t[i_];

                for (i_ = 0; i_ <= wlen - 1; i_++) t[i_] = s[i_];

                for (i_ = 0; i_ <= wlen - 1; i_++) s[i_] = ta[i_];
            }

            for (j = n / 2; j >= 0; j--) s[woffs + j] = s[woffs + j - 1];
            ...
            for (i = 0; i <= 2 * n; i++) wgauss[i] = 0;

            for (i = 0; i <= n - 1; i++) wgauss[2 * i + 1] = wgtmp[i];
        }
        ...
        *************************************************************************/
        public static void gkqgenerategausslegendre(int n, ref int info, ref double[] x, ref double[] wkronrod, ref double[] wgauss, xparams _params)
        {
            ...
            if (math.machineepsilon > 1.0E-32 && (n == 15 || n == 21 || n == 31 || n == 41 || n == 51 || n == 61))
            {
                info = 1;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 12.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gkqgenerategaussjacobi(int n, double alpha, double beta, ref int info, ref double[] x, ref double[] wkronrod,
            ref double[] wgauss, xparams _params)
        {
            var clen = 0;
            var a = new double[0];
            ...
            clen = (int)Math.Ceiling(3 * (n / 2) / (double)2) + 1;
            a = new double[clen];
            b = new double[clen];
            for (i = 0; i <= clen - 1; i++) a[i] = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 12.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void gkqlegendrecalc(int n, ref int info, ref double[] x, ref double[] wkronrod, ref double[] wgauss, xparams _params)
        {
            var alpha = new double[0];
            var beta = new double[0];
            var alen = 0;
            ...
            mu0 = 2;
            alen = (int)Math.Floor(3 * (n / 2) / (double)2) + 1;
            blen = (int)Math.Ceiling(3 * (n / 2) / (double)2) + 1;
            alpha = new double[alen];
            beta = new double[blen];
            for (k = 0; k <= alen - 1; k++) alpha[k] = 0;

            beta[0] = 2;
            for (k = 1; k <= blen - 1; k++) beta[k] = 1 / (4 - 1 / math.sqr(k));
        ...
        *************************************************************************/
        public static void gkqlegendretbl(int n, ref double[] x, ref double[] wkronrod, ref double[] wgauss, ref double eps, xparams _params)
        {
            ...
            // Process
            //
            ap.assert(n == 15 || n == 21 || n == 31 || n == 41 || n == 51 || n == 61, "GKQNodesTbl: incorrect N!");
            x = new double[n];
            ...
            // copy nodes
            //
            for (i = n - 1; i >= n / 2; i--) x[i] = -x[n - 1 - i];

            //
            // copy Kronrod weights
            //
            for (i = n - 1; i >= n / 2; i--) wkronrod[i] = wkronrod[n - 1 - i];
    ...
    public class autogk
    {
        ...
        SEE ALSO
          ...
          -- ALGLIB --
             Copyright 06.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void autogksmooth(double a, double b, autogkstate state, xparams _params)
        {
        ...
        SEE ALSO
          ...
          -- ALGLIB --
             Copyright 06.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void autogksmoothw(double a, double b, double xwidth, autogkstate state, xparams _params)
        {
        ...
        SEE ALSO
          ...
          -- ALGLIB --
             Copyright 06.05.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void autogksingular(double a, double b, double alpha, double beta, autogkstate state, xparams _params)
        {
        ...
        *************************************************************************/
        public static bool autogkiteration(autogkstate state, xparams _params)
        {
            ...
            //
            if (state.wrappermode != 0) goto lbl_3;
            ...
            lbl_5:
            if (!autogkinternaliteration(state.internalstate, _params)) goto lbl_6;
            ...
            //
            if (state.wrappermode != 1) goto lbl_7;
            ...
            lbl_9:
            if (!autogkinternaliteration(state.internalstate, _params)) goto lbl_10;
            ...
            lbl_11:
            if (!autogkinternaliteration(state.internalstate, _params)) goto lbl_12;
        ...
        Output parameters:
          ...
          -- ALGLIB --
             Copyright 14.11.2007 by Bochkanov Sergey
        *************************************************************************/
        public static void autogkresults(autogkstate state, ref double v, autogkreport rep, xparams _params)
        {
            v = 0;
        ...
        *************************************************************************/
        private static void autogkinternalprepare(double a, double b, double eps, double xwidth, autogkinternalstate state, xparams _params)
        {
            //
            // Save settings
            //
        ...
        Internal AutoGK subroutine
        *************************************************************************/
        private static bool autogkinternaliteration(autogkinternalstate state, xparams _params)
        {
            var result = new bool();
            double c1 = 0;
            double c2 = 0;
            ...
            state.info = 1;
            if (state.eps == 0) state.eps = 100000 * math.machineepsilon;
            ...
            if (i % 2 == 1) intg = intg + v * state.wg[i];
            ...
            {
                state.r = 0;
                for (j = 0; j <= state.heapused - 1; j++) state.r = state.r + state.heap[j, 1];
            ...
            j = state.heapused - 1;
            lbl_16:
            if (j > state.heapused) goto lbl_18;
        ...
        private static void mheappop(ref double[,] heap, int heapsize, int heapwidth, xparams _params)
        {
            var i = 0;
            var p = 0;
            double t = 0;
        ...
        private static void mheappush(ref double[,] heap, int heapsize, int heapwidth, xparams _params)
        {
            var i = 0;
            var p = 0;
            double t = 0;
        ...
        private static void mheapresize(ref double[,] heap, ref int heapsize, int newheapsize, int heapwidth, xparams _params)
        {
            var tmp = new double[0, 0];
            var i = 0;
            var i_ = 0;
        ...
        *************************************************************************/
        ...
        public class autogkinternalstate : apobject
        {
            ...
            public override apobject make_copy()
            {
                var _result = new autogkinternalstate();
                _result.a = a;
                _result.b = b;
                _result.eps = eps;
