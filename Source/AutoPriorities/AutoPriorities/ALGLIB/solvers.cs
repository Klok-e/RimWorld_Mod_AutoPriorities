...
public partial class alglib
{
    ...
    *************************************************************************/
    public class polynomialsolverreport : alglibobject
    {
        ...
        {
            innerobj = new polynomialsolver.polynomialsolverreport();
        }
        ...
        {
            get => innerobj.maxerr;
            set => innerobj.maxerr = value;
        }

        public polynomialsolver.polynomialsolverreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new polynomialsolverreport((polynomialsolver.polynomialsolverreport)innerobj.make_copy());
        }
    }
}
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolve(double[,] a, int n, double[] b, out double[] x, out densesolverreport rep, xparams _params)
    {
        x = new double[0];
        rep = new densesolverreport();
    ...
    public static void rmatrixsolve(double[,] a, double[] b, out double[] x, out densesolverreport rep, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'rmatrixsolve': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static bool rmatrixsolvefast(double[,] a, int n, double[] b, xparams _params)
    {
    ...
    public static bool rmatrixsolvefast(double[,] a, double[] b)
    {
        ...
        n = ap.rows(a);
        var result = directdensesolvers.rmatrixsolvefast(a, n, b, null);

        return result;
    }

    public static bool rmatrixsolvefast(double[,] a, double[] b, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'rmatrixsolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(a);
        var result = directdensesolvers.rmatrixsolvefast(a, n, b, _params);
    ...
    *************************************************************************/
    ...
    public static void rmatrixsolvem(double[,] a, double[,] b, bool rfs, out double[,] x, out densesolverreport rep, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
    ...
    *************************************************************************/
    ...
    public static bool rmatrixsolvemfast(double[,] a, int n, double[,] b, int m, xparams _params)
    {
    ...
    public static bool rmatrixsolvemfast(double[,] a, double[,] b)
    {
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.rmatrixsolvemfast(a, n, b, m, null);

        return result;
    }

    public static bool rmatrixsolvemfast(double[,] a, double[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.rmatrixsolvemfast(a, n, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static void rmatrixlusolve(double[,] lua, int[] p, int n, double[] b, out double[] x, out densesolverreport rep, xparams _params)
    {
        x = new double[0];
        rep = new densesolverreport();
    ...
    public static void rmatrixlusolve(double[,] lua, int[] p, double[] b, out double[] x, out densesolverreport rep, xparams _params)
    {
        int n;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p) || ap.rows(lua) != ap.len(b))
            throw new alglibexception("Error while calling 'rmatrixlusolve': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static bool rmatrixlusolvefast(double[,] lua, int[] p, int n, double[] b, xparams _params)
    {
    ...
    public static bool rmatrixlusolvefast(double[,] lua, int[] p, double[] b)
    {
        ...
        n = ap.rows(lua);
        var result = directdensesolvers.rmatrixlusolvefast(lua, p, n, b, null);

        return result;
    }

    public static bool rmatrixlusolvefast(double[,] lua, int[] p, double[] b, xparams _params)
    {
        int n;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p))
            throw new alglibexception("Error while calling 'rmatrixlusolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(lua);
        var result = directdensesolvers.rmatrixlusolvefast(lua, p, n, b, _params);
    ...
    *************************************************************************/
    ...
    public static void rmatrixlusolvem(double[,] lua, int[] p, double[,] b, out double[,] x, out densesolverreport rep, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p) || ap.rows(lua) != ap.rows(b))
    ...
    *************************************************************************/
    ...
    public static bool rmatrixlusolvemfast(double[,] lua, int[] p, int n, double[,] b, int m, xparams _params)
    {
    ...
    public static bool rmatrixlusolvemfast(double[,] lua, int[] p, double[,] b)
    {
        ...
        n = ap.rows(lua);
        m = ap.cols(b);
        var result = directdensesolvers.rmatrixlusolvemfast(lua, p, n, b, m, null);

        return result;
    }

    public static bool rmatrixlusolvemfast(double[,] lua, int[] p, double[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p) || ap.rows(lua) != ap.rows(b))
        ...
        n = ap.rows(lua);
        m = ap.cols(b);
        var result = directdensesolvers.rmatrixlusolvemfast(lua, p, n, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static void rmatrixmixedsolve(double[,] a, double[,] lua, int[] p, double[] b, out double[] x, out densesolverreport rep)
    {
        ...
        if (ap.rows(a) != ap.cols(a)
            || ap.rows(a) != ap.rows(lua)
            || ap.rows(a) != ap.cols(lua)
            || ap.rows(a) != ap.len(p)
            || ap.rows(a) != ap.len(b))
    ...
    *************************************************************************/
    ...
    public static void cmatrixsolvem(complex[,] a, complex[,] b, bool rfs, out complex[,] x, out densesolverreport rep, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
    ...
    *************************************************************************/
    ...
    public static bool cmatrixsolvemfast(complex[,] a, int n, complex[,] b, int m, xparams _params)
    {
    ...
    public static bool cmatrixsolvemfast(complex[,] a, complex[,] b)
    {
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.cmatrixsolvemfast(a, n, b, m, null);

        return result;
    }

    public static bool cmatrixsolvemfast(complex[,] a, complex[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.cmatrixsolvemfast(a, n, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static void cmatrixsolve(complex[,] a, int n, complex[] b, out complex[] x, out densesolverreport rep, xparams _params)
    {
        x = new complex[0];
        rep = new densesolverreport();
    ...
    public static void cmatrixsolve(complex[,] a, complex[] b, out complex[] x, out densesolverreport rep, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'cmatrixsolve': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static bool cmatrixsolvefast(complex[,] a, int n, complex[] b, xparams _params)
    {
    ...
    public static bool cmatrixsolvefast(complex[,] a, complex[] b)
    {
        ...
        n = ap.rows(a);
        var result = directdensesolvers.cmatrixsolvefast(a, n, b, null);

        return result;
    }

    public static bool cmatrixsolvefast(complex[,] a, complex[] b, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'cmatrixsolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(a);
        var result = directdensesolvers.cmatrixsolvefast(a, n, b, _params);
    ...
    *************************************************************************/
    ...
    public static void cmatrixlusolvem(complex[,] lua, int[] p, complex[,] b, out complex[,] x, out densesolverreport rep, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p) || ap.rows(lua) != ap.rows(b))
    ...
    *************************************************************************/
    ...
    public static bool cmatrixlusolvemfast(complex[,] lua, int[] p, int n, complex[,] b, int m, xparams _params)
    {
    ...
    public static bool cmatrixlusolvemfast(complex[,] lua, int[] p, complex[,] b)
    {
        ...
        n = ap.rows(lua);
        m = ap.cols(b);
        var result = directdensesolvers.cmatrixlusolvemfast(lua, p, n, b, m, null);

        return result;
    }

    public static bool cmatrixlusolvemfast(complex[,] lua, int[] p, complex[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p) || ap.rows(lua) != ap.rows(b))
        ...
        n = ap.rows(lua);
        m = ap.cols(b);
        var result = directdensesolvers.cmatrixlusolvemfast(lua, p, n, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static void cmatrixlusolve(complex[,] lua, int[] p, complex[] b, out complex[] x, out densesolverreport rep, xparams _params)
    {
        int n;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p) || ap.rows(lua) != ap.len(b))
            throw new alglibexception("Error while calling 'cmatrixlusolve': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static bool cmatrixlusolvefast(complex[,] lua, int[] p, int n, complex[] b, xparams _params)
    {
    ...
    public static bool cmatrixlusolvefast(complex[,] lua, int[] p, complex[] b)
    {
        ...
        n = ap.rows(lua);
        var result = directdensesolvers.cmatrixlusolvefast(lua, p, n, b, null);

        return result;
    }

    public static bool cmatrixlusolvefast(complex[,] lua, int[] p, complex[] b, xparams _params)
    {
        int n;
        if (ap.rows(lua) != ap.cols(lua) || ap.rows(lua) != ap.len(p))
            throw new alglibexception("Error while calling 'cmatrixlusolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(lua);
        var result = directdensesolvers.cmatrixlusolvefast(lua, p, n, b, _params);
    ...
    * O(M*N^2) complexity
    ...
    OUTPUT PARAMETERS
      ...
      -- ALGLIB --
         Copyright 27.01.2010 by Bochkanov Sergey
    *************************************************************************/
    public static void cmatrixmixedsolvem(complex[,] a, complex[,] lua, int[] p, int n, complex[,] b, int m, out complex[,] x,
    ...
    *************************************************************************/
    ...
    public static void spdmatrixsolvem(double[,] a, bool isupper, double[,] b, out double[,] x, out densesolverreport rep, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
    ...
    *************************************************************************/
    ...
    public static bool spdmatrixsolvemfast(double[,] a, int n, bool isupper, double[,] b, int m, xparams _params)
    {
    ...
    public static bool spdmatrixsolvemfast(double[,] a, bool isupper, double[,] b)
    {
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.spdmatrixsolvemfast(a, n, isupper, b, m, null);

        return result;
    }

    public static bool spdmatrixsolvemfast(double[,] a, bool isupper, double[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.spdmatrixsolvemfast(a, n, isupper, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static void spdmatrixsolve(double[,] a, bool isupper, double[] b, out double[] x, out densesolverreport rep, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'spdmatrixsolve': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static bool spdmatrixsolvefast(double[,] a, int n, bool isupper, double[] b, xparams _params)
    {
    ...
    public static bool spdmatrixsolvefast(double[,] a, bool isupper, double[] b)
    {
        ...
        n = ap.rows(a);
        var result = directdensesolvers.spdmatrixsolvefast(a, n, isupper, b, null);

        return result;
    }

    public static bool spdmatrixsolvefast(double[,] a, bool isupper, double[] b, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'spdmatrixsolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(a);
        var result = directdensesolvers.spdmatrixsolvefast(a, n, isupper, b, _params);
    ...
    *************************************************************************/
    ...
    public static bool spdmatrixcholeskysolvemfast(double[,] cha, int n, bool isupper, double[,] b, int m, xparams _params)
    {
    ...
    public static bool spdmatrixcholeskysolvemfast(double[,] cha, bool isupper, double[,] b)
    {
        ...
        n = ap.rows(cha);
        m = ap.cols(b);
        var result = directdensesolvers.spdmatrixcholeskysolvemfast(cha, n, isupper, b, m, null);

        return result;
    }

    public static bool spdmatrixcholeskysolvemfast(double[,] cha, bool isupper, double[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(cha) != ap.cols(cha) || ap.rows(cha) != ap.rows(b))
        ...
        n = ap.rows(cha);
        m = ap.cols(b);
        var result = directdensesolvers.spdmatrixcholeskysolvemfast(cha, n, isupper, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static bool spdmatrixcholeskysolvefast(double[,] cha, int n, bool isupper, double[] b, xparams _params)
    {
    ...
    public static bool spdmatrixcholeskysolvefast(double[,] cha, bool isupper, double[] b)
    {
        ...
        n = ap.rows(cha);
        var result = directdensesolvers.spdmatrixcholeskysolvefast(cha, n, isupper, b, null);

        return result;
    }

    public static bool spdmatrixcholeskysolvefast(double[,] cha, bool isupper, double[] b, xparams _params)
    {
        int n;
        if (ap.rows(cha) != ap.cols(cha) || ap.rows(cha) != ap.len(b))
            throw new alglibexception("Error while calling 'spdmatrixcholeskysolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(cha);
        var result = directdensesolvers.spdmatrixcholeskysolvefast(cha, n, isupper, b, _params);
    ...
    *************************************************************************/
    ...
    public static bool hpdmatrixsolvemfast(complex[,] a, int n, bool isupper, complex[,] b, int m, xparams _params)
    {
    ...
    public static bool hpdmatrixsolvemfast(complex[,] a, bool isupper, complex[,] b)
    {
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.hpdmatrixsolvemfast(a, n, isupper, b, m, null);

        return result;
    }

    public static bool hpdmatrixsolvemfast(complex[,] a, bool isupper, complex[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.rows(b))
        ...
        n = ap.rows(a);
        m = ap.cols(b);
        var result = directdensesolvers.hpdmatrixsolvemfast(a, n, isupper, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static void hpdmatrixsolve(complex[,] a, bool isupper, complex[] b, out complex[] x, out densesolverreport rep, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'hpdmatrixsolve': looks like one of arguments has wrong size");
    ...
    *************************************************************************/
    ...
    public static bool hpdmatrixsolvefast(complex[,] a, int n, bool isupper, complex[] b, xparams _params)
    {
    ...
    public static bool hpdmatrixsolvefast(complex[,] a, bool isupper, complex[] b)
    {
        ...
        n = ap.rows(a);
        var result = directdensesolvers.hpdmatrixsolvefast(a, n, isupper, b, null);

        return result;
    }

    public static bool hpdmatrixsolvefast(complex[,] a, bool isupper, complex[] b, xparams _params)
    {
        int n;
        if (ap.rows(a) != ap.cols(a) || ap.rows(a) != ap.len(b))
            throw new alglibexception("Error while calling 'hpdmatrixsolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(a);
        var result = directdensesolvers.hpdmatrixsolvefast(a, n, isupper, b, _params);
    ...
    *************************************************************************/
    ...
    public static bool hpdmatrixcholeskysolvemfast(complex[,] cha, int n, bool isupper, complex[,] b, int m, xparams _params)
    {
    ...
    public static bool hpdmatrixcholeskysolvemfast(complex[,] cha, bool isupper, complex[,] b)
    {
        ...
        n = ap.rows(cha);
        m = ap.cols(b);
        var result = directdensesolvers.hpdmatrixcholeskysolvemfast(cha, n, isupper, b, m, null);

        return result;
    }

    public static bool hpdmatrixcholeskysolvemfast(complex[,] cha, bool isupper, complex[,] b, xparams _params)
    {
        int n;
        int m;
        if (ap.rows(cha) != ap.cols(cha) || ap.rows(cha) != ap.rows(b))
        ...
        n = ap.rows(cha);
        m = ap.cols(b);
        var result = directdensesolvers.hpdmatrixcholeskysolvemfast(cha, n, isupper, b, m, _params);
    ...
    *************************************************************************/
    ...
    public static bool hpdmatrixcholeskysolvefast(complex[,] cha, int n, bool isupper, complex[] b, xparams _params)
    {
    ...
    public static bool hpdmatrixcholeskysolvefast(complex[,] cha, bool isupper, complex[] b)
    {
        ...
        n = ap.rows(cha);
        var result = directdensesolvers.hpdmatrixcholeskysolvefast(cha, n, isupper, b, null);

        return result;
    }

    public static bool hpdmatrixcholeskysolvefast(complex[,] cha, bool isupper, complex[] b, xparams _params)
    {
        int n;
        if (ap.rows(cha) != ap.cols(cha) || ap.rows(cha) != ap.len(b))
            throw new alglibexception("Error while calling 'hpdmatrixcholeskysolvefast': looks like one of arguments has wrong size");
        ...
        n = ap.rows(cha);
        var result = directdensesolvers.hpdmatrixcholeskysolvefast(cha, n, isupper, b, _params);
    ...
    *************************************************************************/
    public class densesolverreport : alglibobject
    {
        ...
        {
            innerobj = new directdensesolvers.densesolverreport();
        }
        ...
        {
            get => innerobj.terminationtype;
            set => innerobj.terminationtype = value;
        }

        public double r1
        {
            get => innerobj.r1;
            set => innerobj.r1 = value;
        }

        public double rinf
        {
            get => innerobj.rinf;
            set => innerobj.rinf = value;
        }

        public directdensesolvers.densesolverreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new densesolverreport((directdensesolvers.densesolverreport)innerobj.make_copy());
        }
    }
    ...
    *************************************************************************/
    public class densesolverlsreport : alglibobject
    {
        ...
        {
            innerobj = new directdensesolvers.densesolverlsreport();
        }
        ...
        {
            get => innerobj.r2;
            set => innerobj.r2 = value;
        }

        public double[,] cx
        {
            get => innerobj.cx;
            set => innerobj.cx = value;
        }

        public int n
        {
            get => innerobj.n;
            set => innerobj.n = value;
        }

        public int k
        {
            get => innerobj.k;
            set => innerobj.k = value;
        }

        public directdensesolvers.densesolverlsreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new densesolverlsreport((directdensesolvers.densesolverlsreport)innerobj.make_copy());
        }
    }
}
...
public partial class alglib
{
    ...
    *************************************************************************/
    public static void sparsesolvesymmetricgmres(sparsematrix a, bool isupper, double[] b, int k, double epsf, int maxits, out double[] x,
    ...
    *************************************************************************/
    public class sparsesolverreport : alglibobject
    {
        ...
        {
            innerobj = new iterativesparse.sparsesolverreport();
        }
        ...
        {
            get => innerobj.nmv;
            set => innerobj.nmv = value;
        }

        public int iterationscount
        {
            get => innerobj.iterationscount;
            set => innerobj.iterationscount = value;
        }
        ...
        public iterativesparse.sparsesolverreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new sparsesolverreport((iterativesparse.sparsesolverreport)innerobj.make_copy());
        }
    }
    ...
    *************************************************************************/
    public class sparsesolverstate : alglibobject
    {
        ...
        {
            innerobj = new iterativesparse.sparsesolverstate();
        }
        ...
        public iterativesparse.sparsesolverstate innerobj { get; }

        public override alglibobject make_copy()
        {
            return new sparsesolverstate((iterativesparse.sparsesolverstate)innerobj.make_copy());
        }
    }
}
...
public partial class alglib
{
    ...
    *************************************************************************/
    public class lincgstate : alglibobject
    {
        ...
        public lincg.lincgstate innerobj { get; }

        public override alglibobject make_copy()
        {
            return new lincgstate((lincg.lincgstate)innerobj.make_copy());
        }
    }
    ...
    *************************************************************************/
    public class lincgreport : alglibobject
    {
        ...
        public lincgreport()
        {
            innerobj = new lincg.lincgreport();
        }
        ...
        public lincg.lincgreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new lincgreport((lincg.lincgreport)innerobj.make_copy());
        }
    }
}
...
public partial class alglib
{
    ...
    *************************************************************************/
    public class linlsqrstate : alglibobject
    {
        ...
        public linlsqrstate()
        {
            innerobj = new linlsqr.linlsqrstate();
        }
        ...
        public linlsqr.linlsqrstate innerobj { get; }

        public override alglibobject make_copy()
        {
            return new linlsqrstate((linlsqr.linlsqrstate)innerobj.make_copy());
        }
    }
    ...
    *************************************************************************/
    public class linlsqrreport : alglibobject
    {
        ...
        {
            innerobj = new linlsqr.linlsqrreport();
        }
        ...
        public linlsqr.linlsqrreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new linlsqrreport((linlsqr.linlsqrreport)innerobj.make_copy());
        }
    }
}
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void sparsesolve(sparsematrix a, double[] b, int solvertype, out double[] x, out sparsesolverreport rep, xparams _params)
    {
        x = new double[0];
        rep = new sparsesolverreport();
    ...
    *************************************************************************/
    ...
    public static void sparsesolvelsreg(sparsematrix a, double[] b, double reg, out double[] x, out sparsesolverreport rep, xparams _params)
    {
        int solvertype;
...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void nleqsolve(nleqstate state, ndimensional_func func, ndimensional_jac jac, ndimensional_rep rep, object obj, xparams _params)
    {
        ...
        nleq.nleqsetprotocolv1(state.innerobj, _params);
        while (nleqiteration(state, _params))
        {
            if (state.needf)
            {
    ...
    *************************************************************************/
    public class nleqstate : alglibobject
    {
        ...
        {
            get => innerobj.needf;
            set => innerobj.needf = value;
        }

        public bool needfij
        {
            get => innerobj.needfij;
            set => innerobj.needfij = value;
        }

        public bool xupdated
        {
            get => innerobj.xupdated;
            set => innerobj.xupdated = value;
        }

        public double f
        {
            get => innerobj.f;
            set => innerobj.f = value;
        }

        public double[] fi => innerobj.fi;

        public double[,] j => innerobj.j;

        public double[] x => innerobj.x;

        public nleq.nleqstate innerobj { get; }

        public override alglibobject make_copy()
        {
            return new nleqstate((nleq.nleqstate)innerobj.make_copy());
        }
    }
    ...
    *************************************************************************/
    public class nleqreport : alglibobject
    {
        ...
        {
            get => innerobj.nfunc;
            set => innerobj.nfunc = value;
        }

        public int njac
        {
            get => innerobj.njac;
            set => innerobj.njac = value;
        }
        ...
        public nleq.nleqreport innerobj { get; }

        public override alglibobject make_copy()
        {
            return new nleqreport((nleq.nleqreport)innerobj.make_copy());
        }
    }
}
    ...
    public class polynomialsolver
    {
        ...
        NOTE:   roots are not "polished" and  no  matrix  balancing  is  performed
          ...
          -- ALGLIB --
             Copyright 24.02.2014 by Bochkanov Sergey
        *************************************************************************/
        public static void polynomialsolve(double[] a, int n, ref complex[] x, polynomialsolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "PolynomialSolve: N<=0");
            ap.assert(ap.len(a) >= n + 1, "PolynomialSolve: Length(A)<N+1");
            ap.assert(apserv.isfinitevector(a, n + 1, _params), "PolynomialSolve: A contains infitite numbers");
            ap.assert(a[n] != 0, "PolynomialSolve: A[N]=0");
            ...
            //
            nz = 0;
            while (nz < n && a[nz] == 0) nz = nz + 1;

            ne = n - nz;
            for (i = nz; i <= n; i++) a[i - nz] = a[i] / a[n];
            ...
            if (ne > 0)
            {
                ...
                ap.assert(status, "PolynomialSolve: inernal error - EVD solver failed");
                for (i = 0; i <= ne - 1; i++)
                {
                    x[i].x = wr[i];
                    x[i].y = wi[i];
    ...
    public class directdensesolvers
    {
        ...
        * O(N^3) complexity
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixsolve(double[,] a, int n, double[] b, ref double[] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixSolve: N<=0");
            ap.assert(ap.rows(a) >= n, "RMatrixSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "RMatrixSolve: cols(A)<N");
            ap.assert(ap.len(b) >= n, "RMatrixSolve: length(B)<N");
            ap.assert(apserv.apservisfinitematrix(a, n, n, _params), "RMatrixSolve: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitevector(b, n, _params), "RMatrixSolve: B contains infinite or NaN values!");
            bm = new double[n, 1];
        ...
        *************************************************************************/
        public static bool rmatrixsolvefast(double[,] a, int n, double[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixSolveFast: N<=0");
            ap.assert(ap.rows(a) >= n, "RMatrixSolveFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "RMatrixSolveFast: cols(A)<N");
            ap.assert(ap.len(b) >= n, "RMatrixSolveFast: length(B)<N");
            ap.assert(apserv.apservisfinitematrix(a, n, n, _params), "RMatrixSolveFast: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitevector(b, n, _params), "RMatrixSolveFast: B contains infinite or NaN values!");
            result = true;
            trfac.rmatrixlu(a, n, n, ref p, _params);
            for (i = 0; i <= n - 1; i++)
                if (a[i, i] == 0)
                {
                    for (j = 0; j <= n - 1; j++) b[j] = 0.0;
        ...
        *************************************************************************/
        public static void rmatrixsolvem(double[,] a, int n, double[,] b, int m, bool rfs, ref double[,] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixSolveM: N<=0");
            ap.assert(m > 0, "RMatrixSolveM: M<=0");
            ap.assert(ap.rows(a) >= n, "RMatrixSolveM: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "RMatrixSolveM: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "RMatrixSolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "RMatrixSolveM: cols(B)<M");
            ap.assert(apserv.apservisfinitematrix(a, n, n, _params), "RMatrixSolveM: A contains infinite or NaN values!");
            ap.assert(apserv.apservisfinitematrix(b, n, m, _params), "RMatrixSolveM: B contains infinite or NaN values!");
            da = new double[n, n];
        ...
        *************************************************************************/
        public static bool rmatrixsolvemfast(double[,] a, int n, double[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixSolveMFast: N<=0");
            ap.assert(m > 0, "RMatrixSolveMFast: M<=0");
            ap.assert(ap.rows(a) >= n, "RMatrixSolveMFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "RMatrixSolveMFast: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "RMatrixSolveMFast: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "RMatrixSolveMFast: cols(B)<M");
            ap.assert(apserv.apservisfinitematrix(a, n, n, _params), "RMatrixSolveMFast: A contains infinite or NaN values!");
            ap.assert(apserv.apservisfinitematrix(b, n, m, _params), "RMatrixSolveMFast: B contains infinite or NaN values!");
            result = true;
            trfac.rmatrixlu(a, n, n, ref p, _params);
            for (i = 0; i <= n - 1; i++)
                if (a[i, i] == 0)
        ...
        * condition number estimation
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixlusolve(double[,] lua, int[] p, int n, double[] b, ref double[] x, densesolverreport rep, xparams _params)
        {
            var bm = new double[0, 0];
            var xm = new double[0, 0];
            var i = 0;
            ...
            ap.assert(n > 0, "RMatrixLUSolve: N<=0");
            ap.assert(ap.rows(lua) >= n, "RMatrixLUSolve: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "RMatrixLUSolve: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "RMatrixLUSolve: length(P)<N");
        ...
        *************************************************************************/
        public static bool rmatrixlusolvefast(double[,] lua, int[] p, int n, double[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixLUSolveFast: N<=0");
            ap.assert(ap.rows(lua) >= n, "RMatrixLUSolveFast: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "RMatrixLUSolveFast: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "RMatrixLUSolveFast: length(P)<N");
        ...
        *************************************************************************/
        public static void rmatrixlusolvem(double[,] lua, int[] p, int n, double[,] b, int m, ref double[,] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixLUSolveM: N<=0");
            ap.assert(m > 0, "RMatrixLUSolveM: M<=0");
            ap.assert(ap.rows(lua) >= n, "RMatrixLUSolveM: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "RMatrixLUSolveM: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "RMatrixLUSolveM: length(P)<N");
            ap.assert(ap.rows(b) >= n, "RMatrixLUSolveM: rows(B)<N");
        ...
        *************************************************************************/
        public static bool rmatrixlusolvemfast(double[,] lua, int[] p, int n, double[,] b, int m, xparams _params)
        {
            ...
            //
            ap.assert(n > 0, "RMatrixLUSolveMFast: N<=0");
            ap.assert(m > 0, "RMatrixLUSolveMFast: M<=0");
            ap.assert(ap.rows(lua) >= n, "RMatrixLUSolveMFast: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "RMatrixLUSolveMFast: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "RMatrixLUSolveMFast: length(P)<N");
            ap.assert(ap.rows(b) >= n, "RMatrixLUSolveMFast: rows(B)<N");
        ...
        * O(N^2) complexity
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void rmatrixmixedsolve(double[,] a, double[,] lua, int[] p, int n, double[] b, ref double[] x, densesolverreport rep,
            xparams _params)
        {
            var bm = new double[0, 0];
            var xm = new double[0, 0];
            ...
            ap.assert(n > 0, "RMatrixMixedSolve: N<=0");
            ap.assert(ap.rows(a) >= n, "RMatrixMixedSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "RMatrixMixedSolve: cols(A)<N");
            ap.assert(ap.rows(lua) >= n, "RMatrixMixedSolve: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "RMatrixMixedSolve: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "RMatrixMixedSolve: length(P)<N");
            ap.assert(ap.len(b) >= n, "RMatrixMixedSolve: length(B)<N");
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            ap.assert(n > 0, "RMatrixMixedSolveM: N<=0");
            ap.assert(m > 0, "RMatrixMixedSolveM: M<=0");
            ap.assert(ap.rows(a) >= n, "RMatrixMixedSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "RMatrixMixedSolve: cols(A)<N");
            ap.assert(ap.rows(lua) >= n, "RMatrixMixedSolve: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "RMatrixMixedSolve: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "RMatrixMixedSolve: length(P)<N");
            ap.assert(ap.rows(b) >= n, "RMatrixMixedSolve: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "RMatrixMixedSolve: cols(B)<M");
            ap.assert(apserv.apservisfinitematrix(a, n, n, _params), "RMatrixMixedSolve: A contains infinite or NaN values!");
            ap.assert(apserv.apservisfinitematrix(lua, n, n, _params), "RMatrixMixedSolve: LUA contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static void cmatrixsolvem(complex[,] a, int n, complex[,] b, int m, bool rfs, ref complex[,] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixSolveM: N<=0");
            ap.assert(m > 0, "CMatrixSolveM: M<=0");
            ap.assert(ap.rows(a) >= n, "CMatrixSolveM: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "CMatrixSolveM: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "CMatrixSolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "CMatrixSolveM: cols(B)<M");
            ap.assert(apserv.isfinitecmatrix(a, n, n, _params), "CMatrixSolveM: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecmatrix(b, n, m, _params), "CMatrixSolveM: B contains infinite or NaN values!");
            da = new complex[n, n];
        ...
        *************************************************************************/
        public static bool cmatrixsolvemfast(complex[,] a, int n, complex[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixSolveMFast: N<=0");
            ap.assert(m > 0, "CMatrixSolveMFast: M<=0");
            ap.assert(ap.rows(a) >= n, "CMatrixSolveMFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "CMatrixSolveMFast: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "CMatrixSolveMFast: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "CMatrixSolveMFast: cols(B)<M");
            ap.assert(apserv.isfinitecmatrix(a, n, n, _params), "CMatrixSolveMFast: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecmatrix(b, n, m, _params), "CMatrixSolveMFast: B contains infinite or NaN values!");
        ...
        * O(N^3) complexity
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void cmatrixsolve(complex[,] a, int n, complex[] b, ref complex[] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixSolve: N<=0");
            ap.assert(ap.rows(a) >= n, "CMatrixSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "CMatrixSolve: cols(A)<N");
            ap.assert(ap.len(b) >= n, "CMatrixSolve: length(B)<N");
            ap.assert(apserv.isfinitecmatrix(a, n, n, _params), "CMatrixSolve: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecvector(b, n, _params), "CMatrixSolve: B contains infinite or NaN values!");
            bm = new complex[n, 1];
            for (i_ = 0; i_ <= n - 1; i_++) bm[i_, 0] = b[i_];

            cmatrixsolvem(a, n, bm, 1, true, ref xm, rep, _params);
            x = new complex[n];
            for (i_ = 0; i_ <= n - 1; i_++) x[i_] = xm[i_, 0];
        }
        ...
        *************************************************************************/
        public static bool cmatrixsolvefast(complex[,] a, int n, complex[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixSolveFast: N<=0");
            ap.assert(ap.rows(a) >= n, "CMatrixSolveFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "CMatrixSolveFast: cols(A)<N");
            ap.assert(ap.len(b) >= n, "CMatrixSolveFast: length(B)<N");
            ap.assert(apserv.isfinitecmatrix(a, n, n, _params), "CMatrixSolveFast: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecvector(b, n, _params), "CMatrixSolveFast: B contains infinite or NaN values!");
            trfac.cmatrixlu(a, n, n, ref p, _params);
            for (i = 0; i <= n - 1; i++)
                if (a[i, i] == 0)
                {
        ...
        * condition number estimation
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void cmatrixlusolvem(complex[,] lua, int[] p, int n, complex[,] b, int m, ref complex[,] x, densesolverreport rep,
            xparams _params)
        {
            var emptya = new complex[0, 0];
            var i = 0;
            ...
            ap.assert(n > 0, "CMatrixLUSolveM: N<=0");
            ap.assert(m > 0, "CMatrixLUSolveM: M<=0");
            ap.assert(ap.rows(lua) >= n, "CMatrixLUSolveM: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "CMatrixLUSolveM: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "CMatrixLUSolveM: length(P)<N");
            ap.assert(ap.rows(b) >= n, "CMatrixLUSolveM: rows(B)<N");
        ...
        *************************************************************************/
        public static bool cmatrixlusolvemfast(complex[,] lua, int[] p, int n, complex[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixLUSolveMFast: N<=0");
            ap.assert(m > 0, "CMatrixLUSolveMFast: M<=0");
            ap.assert(ap.rows(lua) >= n, "CMatrixLUSolveMFast: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "CMatrixLUSolveMFast: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "CMatrixLUSolveMFast: length(P)<N");
            ap.assert(ap.rows(b) >= n, "CMatrixLUSolveMFast: rows(B)<N");
        ...
        *************************************************************************/
        public static void cmatrixlusolve(complex[,] lua, int[] p, int n, complex[] b, ref complex[] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixLUSolve: N<=0");
            ap.assert(ap.rows(lua) >= n, "CMatrixLUSolve: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "CMatrixLUSolve: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "CMatrixLUSolve: length(P)<N");
        ...
        *************************************************************************/
        public static bool cmatrixlusolvefast(complex[,] lua, int[] p, int n, complex[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixLUSolveFast: N<=0");
            ap.assert(ap.rows(lua) >= n, "CMatrixLUSolveFast: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "CMatrixLUSolveFast: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "CMatrixLUSolveFast: length(P)<N");
        ...
        * O(M*N^2) complexity
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void cmatrixmixedsolvem(complex[,] a, complex[,] lua, int[] p, int n, complex[,] b, int m, ref complex[,] x,
            densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixMixedSolveM: N<=0");
            ap.assert(m > 0, "CMatrixMixedSolveM: M<=0");
            ap.assert(ap.rows(a) >= n, "CMatrixMixedSolveM: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "CMatrixMixedSolveM: cols(A)<N");
            ap.assert(ap.rows(lua) >= n, "CMatrixMixedSolveM: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "CMatrixMixedSolveM: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "CMatrixMixedSolveM: length(P)<N");
            ap.assert(ap.rows(b) >= n, "CMatrixMixedSolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "CMatrixMixedSolveM: cols(B)<M");
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            ap.assert(n > 0, "CMatrixMixedSolve: N<=0");
            ap.assert(ap.rows(a) >= n, "CMatrixMixedSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "CMatrixMixedSolve: cols(A)<N");
            ap.assert(ap.rows(lua) >= n, "CMatrixMixedSolve: rows(LUA)<N");
            ap.assert(ap.cols(lua) >= n, "CMatrixMixedSolve: cols(LUA)<N");
            ap.assert(ap.len(p) >= n, "CMatrixMixedSolve: length(P)<N");
            ap.assert(ap.len(b) >= n, "CMatrixMixedSolve: length(B)<N");
        ...
        * matrix is represented by its upper or lower triangle
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void spdmatrixsolvem(double[,] a, int n, bool isupper, double[,] b, int m, ref double[,] x, densesolverreport rep,
            xparams _params)
        {
            var da = new double[0, 0];
            var i = 0;
            ...
            ap.assert(n > 0, "SPDMatrixSolveM: N<=0");
            ap.assert(m > 0, "SPDMatrixSolveM: M<=0");
            ap.assert(ap.rows(a) >= n, "SPDMatrixSolveM: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "SPDMatrixSolveM: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "SPDMatrixSolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "SPDMatrixSolveM: cols(B)<M");
            ap.assert(apserv.isfinitertrmatrix(a, n, isupper, _params), "SPDMatrixSolveM: A contains infinite or NaN values!");
            ap.assert(apserv.apservisfinitematrix(b, n, m, _params), "SPDMatrixSolveM: B contains infinite or NaN values!");
            da = new double[n, n];
            ...
            for (i = 0; i <= n - 1; i++)
            {
                ...
                for (i_ = j1; i_ <= j2; i_++) da[i, i_] = a[i, i_];
            }
        ...
        *************************************************************************/
        public static bool spdmatrixsolvemfast(double[,] a, int n, bool isupper, double[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "SPDMatrixSolveMFast: N<=0");
            ap.assert(ap.rows(a) >= n, "SPDMatrixSolveMFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "SPDMatrixSolveMFast: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "SPDMatrixSolveMFast: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "SPDMatrixSolveMFast: cols(B)<M");
            ap.assert(apserv.isfinitertrmatrix(a, n, isupper, _params), "SPDMatrixSolveMFast: A contains infinite or NaN values!");
            ap.assert(apserv.apservisfinitematrix(b, n, m, _params), "SPDMatrixSolveMFast: B contains infinite or NaN values!");
            result = true;
        ...
        *************************************************************************/
        public static void spdmatrixsolve(double[,] a, int n, bool isupper, double[] b, ref double[] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "SPDMatrixSolve: N<=0");
            ap.assert(ap.rows(a) >= n, "SPDMatrixSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "SPDMatrixSolve: cols(A)<N");
            ap.assert(ap.len(b) >= n, "SPDMatrixSolve: length(B)<N");
            ap.assert(apserv.isfinitertrmatrix(a, n, isupper, _params), "SPDMatrixSolve: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitevector(b, n, _params), "SPDMatrixSolve: B contains infinite or NaN values!");
            bm = new double[n, 1];
            for (i_ = 0; i_ <= n - 1; i_++) bm[i_, 0] = b[i_];
        ...
        *************************************************************************/
        public static bool spdmatrixsolvefast(double[,] a, int n, bool isupper, double[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "SPDMatrixSolveFast: N<=0");
            ap.assert(ap.rows(a) >= n, "SPDMatrixSolveFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "SPDMatrixSolveFast: cols(A)<N");
            ap.assert(ap.len(b) >= n, "SPDMatrixSolveFast: length(B)<N");
            ap.assert(apserv.isfinitertrmatrix(a, n, isupper, _params), "SPDMatrixSolveFast: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitevector(b, n, _params), "SPDMatrixSolveFast: B contains infinite or NaN values!");
            result = true;
            if (!trfac.spdmatrixcholesky(a, n, isupper, _params))
            {
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            ap.assert(n > 0, "SPDMatrixCholeskySolveM: N<=0");
            ap.assert(m > 0, "SPDMatrixCholeskySolveM: M<=0");
            ap.assert(ap.rows(cha) >= n, "SPDMatrixCholeskySolveM: rows(CHA)<N");
            ap.assert(ap.cols(cha) >= n, "SPDMatrixCholeskySolveM: cols(CHA)<N");
            ap.assert(ap.rows(b) >= n, "SPDMatrixCholeskySolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "SPDMatrixCholeskySolveM: cols(B)<M");
            ap.assert(apserv.isfinitertrmatrix(cha, n, isupper, _params), "SPDMatrixCholeskySolveM: LUA contains infinite or NaN values!");
            ap.assert(apserv.apservisfinitematrix(b, n, m, _params), "SPDMatrixCholeskySolveM: LUA contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static bool spdmatrixcholeskysolvemfast(double[,] cha, int n, bool isupper, double[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "SPDMatrixCholeskySolveMFast: N<=0");
            ap.assert(m > 0, "SPDMatrixCholeskySolveMFast: M<=0");
            ap.assert(ap.rows(cha) >= n, "SPDMatrixCholeskySolveMFast: rows(CHA)<N");
        ...
        * matrix is represented by its upper or lower triangle
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void spdmatrixcholeskysolve(double[,] cha, int n, bool isupper, double[] b, ref double[] x, densesolverreport rep,
            xparams _params)
        {
            var bm = new double[0, 0];
            var xm = new double[0, 0];
            ...
            ap.assert(n > 0, "SPDMatrixCholeskySolve: N<=0");
            ap.assert(ap.rows(cha) >= n, "SPDMatrixCholeskySolve: rows(CHA)<N");
            ap.assert(ap.cols(cha) >= n, "SPDMatrixCholeskySolve: cols(CHA)<N");
            ap.assert(ap.len(b) >= n, "SPDMatrixCholeskySolve: length(B)<N");
            ap.assert(apserv.isfinitertrmatrix(cha, n, isupper, _params), "SPDMatrixCholeskySolve: LUA contains infinite or NaN values!");
            ap.assert(apserv.isfinitevector(b, n, _params), "SPDMatrixCholeskySolve: B contains infinite or NaN values!");
            bm = new double[n, 1];
            for (i_ = 0; i_ <= n - 1; i_++) bm[i_, 0] = b[i_];
        ...
        *************************************************************************/
        public static bool spdmatrixcholeskysolvefast(double[,] cha, int n, bool isupper, double[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "SPDMatrixCholeskySolveFast: N<=0");
        ...
        * matrix is represented by its upper or lower triangle
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void hpdmatrixsolvem(complex[,] a, int n, bool isupper, complex[,] b, int m, ref complex[,] x, densesolverreport rep,
            xparams _params)
        {
            var da = new complex[0, 0];
            var i = 0;
            ...
            ap.assert(n > 0, "HPDMatrixSolveM: N<=0");
            ap.assert(m > 0, "HPDMatrixSolveM: M<=0");
            ap.assert(ap.rows(a) >= n, "HPDMatrixSolveM: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "HPDMatrixSolveM: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "HPDMatrixSolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "HPDMatrixSolveM: cols(B)<M");
            ap.assert(apserv.isfinitectrmatrix(a, n, isupper, _params), "HPDMatrixSolveM: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecmatrix(b, n, m, _params), "HPDMatrixSolveM: B contains infinite or NaN values!");
            da = new complex[n, n];
        ...
        *************************************************************************/
        public static bool hpdmatrixsolvemfast(complex[,] a, int n, bool isupper, complex[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "HPDMatrixSolveMFast: N<=0");
            ap.assert(ap.rows(a) >= n, "HPDMatrixSolveMFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "HPDMatrixSolveMFast: cols(A)<N");
            ap.assert(ap.rows(b) >= n, "HPDMatrixSolveMFast: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "HPDMatrixSolveMFast: cols(B)<M");
            ap.assert(apserv.isfinitectrmatrix(a, n, isupper, _params), "HPDMatrixSolveMFast: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecmatrix(b, n, m, _params), "HPDMatrixSolveMFast: B contains infinite or NaN values!");
            result = true;
        ...
        *************************************************************************/
        public static void hpdmatrixsolve(complex[,] a, int n, bool isupper, complex[] b, ref complex[] x, densesolverreport rep, xparams _params)
        {
            ...
            ap.assert(n > 0, "HPDMatrixSolve: N<=0");
            ap.assert(ap.rows(a) >= n, "HPDMatrixSolve: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "HPDMatrixSolve: cols(A)<N");
            ap.assert(ap.len(b) >= n, "HPDMatrixSolve: length(B)<N");
            ap.assert(apserv.isfinitectrmatrix(a, n, isupper, _params), "HPDMatrixSolve: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecvector(b, n, _params), "HPDMatrixSolve: B contains infinite or NaN values!");
            bm = new complex[n, 1];
            for (i_ = 0; i_ <= n - 1; i_++) bm[i_, 0] = b[i_];
        ...
        *************************************************************************/
        public static bool hpdmatrixsolvefast(complex[,] a, int n, bool isupper, complex[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "HPDMatrixSolveFast: N<=0");
            ap.assert(ap.rows(a) >= n, "HPDMatrixSolveFast: rows(A)<N");
            ap.assert(ap.cols(a) >= n, "HPDMatrixSolveFast: cols(A)<N");
            ap.assert(ap.len(b) >= n, "HPDMatrixSolveFast: length(B)<N");
            ap.assert(apserv.isfinitectrmatrix(a, n, isupper, _params), "HPDMatrixSolveFast: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitecvector(b, n, _params), "HPDMatrixSolveFast: B contains infinite or NaN values!");
            result = true;
            if (!trfac.hpdmatrixcholesky(a, n, isupper, _params))
            {
                for (i = 0; i <= n - 1; i++) b[i] = 0.0;
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            ap.assert(n > 0, "HPDMatrixCholeskySolveM: N<=0");
            ap.assert(m > 0, "HPDMatrixCholeskySolveM: M<=0");
            ap.assert(ap.rows(cha) >= n, "HPDMatrixCholeskySolveM: rows(CHA)<N");
            ap.assert(ap.cols(cha) >= n, "HPDMatrixCholeskySolveM: cols(CHA)<N");
            ap.assert(ap.rows(b) >= n, "HPDMatrixCholeskySolveM: rows(B)<N");
            ap.assert(ap.cols(b) >= m, "HPDMatrixCholeskySolveM: cols(B)<M");
            ap.assert(apserv.isfinitectrmatrix(cha, n, isupper, _params), "HPDMatrixCholeskySolveM: LUA contains infinite or NaN values!");
            ap.assert(apserv.isfinitecmatrix(b, n, m, _params), "HPDMatrixCholeskySolveM: LUA contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static bool hpdmatrixcholeskysolvemfast(complex[,] cha, int n, bool isupper, complex[,] b, int m, xparams _params)
        {
            ...
            ap.assert(n > 0, "HPDMatrixCholeskySolveMFast: N<=0");
            ap.assert(m > 0, "HPDMatrixCholeskySolveMFast: M<=0");
            ap.assert(ap.rows(cha) >= n, "HPDMatrixCholeskySolveMFast: rows(CHA)<N");
            ...
            result = true;
            for (k = 0; k <= n - 1; k++)
                if (cha[k, k].x == 0.0 && cha[k, k].y == 0.0)
                {
                    for (i = 0; i <= n - 1; i++)
                    for (j = 0; j <= m - 1; j++)
                        b[i, j] = 0.0;
        ...
        * matrix is represented by its upper or lower triangle
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void hpdmatrixcholeskysolve(complex[,] cha, int n, bool isupper, complex[] b, ref complex[] x, densesolverreport rep,
            xparams _params)
        {
            var bm = new complex[0, 0];
            var xm = new complex[0, 0];
            ...
            ap.assert(n > 0, "HPDMatrixCholeskySolve: N<=0");
            ap.assert(ap.rows(cha) >= n, "HPDMatrixCholeskySolve: rows(CHA)<N");
            ap.assert(ap.cols(cha) >= n, "HPDMatrixCholeskySolve: cols(CHA)<N");
            ap.assert(ap.len(b) >= n, "HPDMatrixCholeskySolve: length(B)<N");
            ap.assert(apserv.isfinitectrmatrix(cha, n, isupper, _params), "HPDMatrixCholeskySolve: LUA contains infinite or NaN values!");
            ap.assert(apserv.isfinitecvector(b, n, _params), "HPDMatrixCholeskySolve: B contains infinite or NaN values!");
            bm = new complex[n, 1];
            for (i_ = 0; i_ <= n - 1; i_++) bm[i_, 0] = b[i_];
        ...
        *************************************************************************/
        public static bool hpdmatrixcholeskysolvefast(complex[,] cha, int n, bool isupper, complex[] b, xparams _params)
        {
            ...
            ap.assert(n > 0, "HPDMatrixCholeskySolveFast: N<=0");
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            ap.assert(nrows > 0, "RMatrixSolveLS: NRows<=0");
            ap.assert(ncols > 0, "RMatrixSolveLS: NCols<=0");
            ap.assert(math.isfinite(threshold) && threshold >= 0, "RMatrixSolveLS: Threshold<0 or is infinite");
            ap.assert(ap.rows(a) >= nrows, "RMatrixSolveLS: rows(A)<NRows");
            ap.assert(ap.cols(a) >= ncols, "RMatrixSolveLS: cols(A)<NCols");
            ap.assert(ap.len(b) >= nrows, "RMatrixSolveLS: length(B)<NRows");
            ap.assert(apserv.apservisfinitematrix(a, nrows, ncols, _params), "RMatrixSolveLS: A contains infinite or NaN values!");
            ap.assert(apserv.isfinitevector(b, nrows, _params), "RMatrixSolveLS: B contains infinite or NaN values!");
            if (threshold == 0) threshold = 1000 * math.machineepsilon;
            ...
            for (rfs = 0; rfs <= nrfs; rfs++)
            {
                ...
                else
                {
                    ...
                    for (i = 0; i <= nrows - 1; i++)
                    {
                        for (i_ = 0; i_ <= ncols - 1; i_++) ta[i_] = a[i, i_];

                        ta[ncols] = -1;
                        for (i_ = 0; i_ <= ncols - 1; i_++) tx[i_] = x[i_];
                    ...
                    if (smallerr) terminatenexttime = true;
                }

                //
                // solve A*dx = rp
                //
                for (i = 0; i <= ncols - 1; i++) tmp[i] = 0;

                for (i = 0; i <= nsv - 1; i++) utb[i] = 0;

                for (i = 0; i <= nrows - 1; i++)
                {
                    v = rp[i];
                    for (i_ = 0; i_ <= nsv - 1; i_++) utb[i_] = utb[i_] + v * u[i, i_];
                }
                ...
                {
                    v = sutb[i];
                    for (i_ = 0; i_ <= ncols - 1; i_++) tmp[i_] = tmp[i_] + v * vt[i, i_];
                }

                //
                // update x:  x:=x+dx
                //
                for (i_ = 0; i_ <= ncols - 1; i_++) x[i_] = x[i_] + tmp[i_];
            }
        ...
        *************************************************************************/
            ...
            densesolverreport rep, xparams _params)
        {
            ...
            rep.terminationtype = 1;
            if (rep.r1 < rcond.rcondthreshold(_params) || rep.rinf < rcond.rcondthreshold(_params))
            {
                for (i = 0; i <= n - 1; i++)
                for (j = 0; j <= m - 1; j++)
                    x[i, j] = 0;
            ...
            if (havea)
            {
                for (k = 0; k <= m - 1; k++)
                {
                    ...
                    for (rfs = 0; rfs <= nrfs - 1; rfs++)
                    {
                        ...
                        //
                        smallerr = true;
                        for (i_ = 0; i_ <= n - 1; i_++) xb[i_] = x[i_, k];

                        for (i = 0; i <= n - 1; i++)
                        {
                            for (i_ = 0; i_ <= n - 1; i_++) xa[i_] = a[i, i_];
        ...
        Internal Cholesky solver
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static void spdmatrixcholeskysolveinternal(double[,] cha, int n, bool isupper, double[,] a, bool havea, double[,] b, int m,
            ref double[,] x, densesolverreport rep, xparams _params)
        {
            ...
            // prepare: check inputs, allocate space...
            //
            ap.assert(n > 0 && m > 0, "SPDMatrixCholeskySolveInternal: integrity check 9858 failed");
            x = new double[n, m];
            ...
            rep.rinf = rep.r1;
            rep.terminationtype = 1;
            if (rep.r1 < rcond.rcondthreshold(_params))
            {
                for (i = 0; i <= n - 1; i++)
                for (j = 0; j <= m - 1; j++)
                    x[i, j] = 0;
        ...
        *************************************************************************/
            ...
            densesolverreport rep, xparams _params)
        {
            ...
            for (k = 0; k <= m - 1; k++)
            {
                for (i_ = 0; i_ <= n - 1; i_++) bc[i_] = b[i_, k];

                for (i_ = 0; i_ <= n - 1; i_++) xc[i_] = x[i_, k];
                ...
                if (havea)
                {
                    ...
                    for (rfs = 0; rfs <= nrfs - 1; rfs++)
                    {
                        ...
                        //
                        smallerr = true;
                        for (i_ = 0; i_ <= n - 1; i_++) xb[i_] = xc[i_];
                        ...
                        for (i = 0; i <= n - 1; i++)
                        {
                            ...
                            y[i] = -v;
                            smallerr = smallerr && math.abscomplex(v) < 4 * verr;
                        }
                        ...
                        for (i_ = 0; i_ <= n - 1; i_++) xc[i_] = xc[i_] + y[i_];
                    }
                }
                ...
                // Post-scale result.
                //
                for (i_ = 0; i_ <= n - 1; i_++) x[i_, k] = xc[i_];
            }
        }
        ...
        *************************************************************************/
        ...
        3. condition number
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static int densesolverrfsmax(int n, double r1, double rinf, xparams _params)
        {
            var result = 0;
        ...
        3. norm-2 condition number
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static int densesolverrfsmaxv2(int n, double r2, xparams _params)
        {
            var result = 0;
        ...
        * A=PLU is well-conditioned, so no zero divisions or overflow may occur
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static void rbasiclusolve(double[,] lua, int[] p, int n, double[] xb, xparams _params)
        {
            var i = 0;
            double v = 0;
            var i_ = 0;
            ...
            {
                v = 0.0;
                for (i_ = 0; i_ <= i - 1; i_++) v += lua[i, i_] * xb[i_];
            ...
            {
                v = 0.0;
                for (i_ = i + 1; i_ <= n - 1; i_++) v += lua[i, i_] * xb[i_];
        ...
        * A is well-conditioned, so no zero divisions or overflow may occur
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static void spdbasiccholeskysolve(double[,] cha, int n, bool isupper, double[] xb, xparams _params)
        {
            var i = 0;
            double v = 0;
            var i_ = 0;
            ...
            if (isupper)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    {
                        v = xb[i];
                        for (i_ = i + 1; i_ <= n - 1; i_++) xb[i_] = xb[i_] - v * cha[i, i_];
                    }
                }
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    {
                        v = 0.0;
                        for (i_ = i + 1; i_ <= n - 1; i_++) v += cha[i, i_] * xb[i_];
            ...
            else
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    {
                        v = 0.0;
                        for (i_ = 0; i_ <= i - 1; i_++) v += cha[i, i_] * xb[i_];
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    {
                        v = xb[i];
                        for (i_ = 0; i_ <= i - 1; i_++) xb[i_] = xb[i_] - v * cha[i, i_];
                    }
                }
            }
        }
        ...
        * A=PLU is well-conditioned, so no zero divisions or overflow may occur
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static void cbasiclusolve(complex[,] lua, int[] p, int n, complex[] xb, xparams _params)
        {
            var i = 0;
            complex v = 0;
            var i_ = 0;
        ...
        * A is well-conditioned, so no zero divisions or overflow may occur
          ...
          -- ALGLIB --
             Copyright 27.01.2010 by Bochkanov Sergey
        *************************************************************************/
        private static void hpdbasiccholeskysolve(complex[,] cha, int n, bool isupper, complex[] xb, xparams _params)
        {
            var i = 0;
            complex v = 0;
            var i_ = 0;
            ...
            if (isupper)
            {
                ...
                for (i = 0; i <= n - 1; i++)
                {
                    ...
                    {
                        v = xb[i];
                        for (i_ = i + 1; i_ <= n - 1; i_++) xb[i_] = xb[i_] - v * math.conj(cha[i, i_]);
                    }
                }
            ...
            else
            {
                ...
                for (i = n - 1; i >= 0; i--)
                {
                    ...
                    {
                        v = xb[i];
                        for (i_ = 0; i_ <= i - 1; i_++) xb[i_] = xb[i_] - v * math.conj(cha[i, i_]);
                    }
                }
            }
        }
    ...
    public class iterativesparse
    {
        ...
        *************************************************************************/
            ...
            sparsesolverreport rep, xparams _params)
        {
            ...
            // Test inputs
            //
            ap.assert(n >= 1, "SparseSolveSymmetricGMRES: tried to automatically detect N from sizeof(A), got nonpositive size");
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseSolveSymmetricGMRES: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseSolveSymmetricGMRES: cols(A)!=N");
            ap.assert(ap.len(b) >= n, "SparseSolveSymmetricGMRES: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolveSymmetricGMRES: B contains NAN/INF");
            ap.assert(math.isfinite(epsf) && epsf >= 0, "SparseSolveSymmetricGMRES: EpsF<0 or infinite");
            ap.assert(maxits >= 0, "SparseSolveSymmetricGMRES: MaxIts<0");
            if (epsf == 0 && maxits == 0) epsf = 1.0E-6;
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            // Test inputs
            //
            ap.assert(n >= 1, "SparseSolveGMRES: tried to automatically detect N from sizeof(A), got nonpositive size");
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseSolveGMRES: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseSolveGMRES: cols(A)!=N");
            ap.assert(ap.len(b) >= n, "SparseSolveGMRES: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolveGMRES: B contains NAN/INF");
            ap.assert(math.isfinite(epsf) && epsf >= 0, "SparseSolveGMRES: EpsF<0 or infinite");
            ap.assert(maxits >= 0, "SparseSolveGMRES: MaxIts<0");
            if (epsf == 0 && maxits == 0) epsf = 1.0E-6;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 24.09.2021 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolvercreate(int n, sparsesolverstate state, xparams _params)
        {
            ap.assert(n >= 1, "SparseSolverCreate: N<=0");
            state.n = n;
            state.running = false;
        ...
        *************************************************************************/
        public static void sparsesolversetalgogmres(sparsesolverstate state, int k, xparams _params)
        {
            ap.assert(k >= 0, "SparseSolverSetAlgoGMRESK: K<0");
            state.algotype = 0;
            if (k == 0) k = 50;
        ...
        *************************************************************************/
        public static void sparsesolversetstartingpoint(sparsesolverstate state, double[] x, xparams _params)
        {
            ap.assert(state.n <= ap.len(x), "SparseSolverSetStartingPoint: Length(X)<N");
            ap.assert(apserv.isfinitevector(x, state.n, _params), "SparseSolverSetStartingPoint: X contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static void sparsesolversetcond(sparsesolverstate state, double epsf, int maxits, xparams _params)
        {
            ap.assert(math.isfinite(epsf) && epsf >= 0, "SparseSolverSetCond: EpsF is negative or contains infinite or NaN values");
            ap.assert(maxits >= 0, "SparseSolverSetCond: MaxIts is negative");
            if (epsf == 0 && maxits == 0)
            {
                state.epsf = 1.0E-6;
                state.maxits = 0;
        ...
        *************************************************************************/
        public static void sparsesolversolvesymmetric(sparsesolverstate state, sparse.sparsematrix a, bool isupper, double[] b, xparams _params)
        {
            ...
            // Test inputs
            //
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseSolverSolveSymmetric: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseSolverSolveSymmetric: cols(A)!=N");
            ap.assert(ap.len(b) >= n, "SparseSolverSolveSymmetric: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolverSolveSymmetric: B contains NAN/INF");
        ...
        RESULT:
          ...
          -- ALGLIB --
             Copyright 25.09.2021 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolversolve(sparsesolverstate state, sparse.sparsematrix a, double[] b, xparams _params)
        {
            var n = 0;
            ...
            // Test inputs
            //
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseSolverSolve: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseSolverSolve: cols(A)!=N");
            ap.assert(ap.len(b) >= n, "SparseSolverSolve: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolverSolve: B contains NAN/INF");
        ...
        s
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolverresults(sparsesolverstate state, ref double[] x, sparsesolverreport rep, xparams _params)
        {
            x = new double[0];
        ...
        *************************************************************************/
        public static bool sparsesolverooccontinue(sparsesolverstate state, xparams _params)
        {
            ...
            ap.assert(state.running, "SparseSolverContinue: the solver is not running");
        ...
        * RequestType=-1 means that solver reports its progress; this  request  is
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 24.09.2021 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolveroocgetrequestinfo(sparsesolverstate state, ref int requesttype, xparams _params)
        {
            requesttype = 0;

            ap.assert(state.running, "SparseSolverOOCGetRequestInfo: the solver is not running");
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 24.09.2021 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolveroocgetrequestdata1(sparsesolverstate state, ref double v, xparams _params)
        {
            v = 0;
        ...
        *************************************************************************/
        public static void sparsesolveroocsendresult(sparsesolverstate state, double[] ax, xparams _params)
        {
            ap.assert(state.running, "SparseSolverOOCSendResult: the solver is not running");
            ap.assert(state.requesttype == 0, "SparseSolverOOCSendResult: this request type does not accept replies");
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 24.09.2021 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolveroocstop(sparsesolverstate state, ref double[] x, sparsesolverreport rep, xparams _params)
        {
            x = new double[0];

            ap.assert(!state.running, "SparseSolverOOCStop: the solver is still running");
        ...
        *************************************************************************/
        ...
        Reset report fields
          ...
          -- ALGLIB --
             Copyright 26.12.2017 by Bochkanov Sergey
        *************************************************************************/
        public static void initsparsesolverreport(sparsesolverreport rep, xparams _params)
        {
        ...
        Reverse communication sparse iteration subroutine
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        private static bool sparsesolveriteration(sparsesolverstate state, xparams _params)
        {
            var result = new bool();
            var outeridx = 0;
            double res = 0;
            ...
            if (state.rstate.stage == 0) goto lbl_0;

            if (state.rstate.stage == 1) goto lbl_1;

            if (state.rstate.stage == 2) goto lbl_2;

            if (state.rstate.stage == 3) goto lbl_3;

            if (state.rstate.stage == 4) goto lbl_4;
            ...
            // GMRES?
            //
            if (state.algotype != 0) goto lbl_5;

            if (ablasf.rdotv2(state.n, state.x0, _params) != 0) goto lbl_7;
            ...
            lbl_9:
            lbl_11:
            if (!(res > 0 && (state.maxits == 0 || state.repiterationscount < state.maxits))) goto lbl_12;
            ...
            lbl_13:
            if (!fbls.fblsgmresiteration(state.gmressolver, _params)) goto lbl_14;
            ...
            if (res >= prevres * (1 - Math.Sqrt(math.machineepsilon)))
            {
                //
            ...
            return result;
            lbl_5:
            ap.assert(false, "SparseSolverIteration: integrity check failed (unexpected algo)");
            result = false;
            return result;
        ...
        *************************************************************************/
        private static void clearrequestfields(sparsesolverstate state, xparams _params)
        {
            state.requesttype = -999;
        }
        ...
        *************************************************************************/
        private static void clearreportfields(sparsesolverstate state, xparams _params)
        {
    ...
    public class lincg
    {
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void lincgcreate(int n, lincgstate state, xparams _params)
        {
            var i = 0;

            ap.assert(n > 0, "LinCGCreate: N<=0");
            state.n = n;
            state.prectype = 0;
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void lincgsetb(lincgstate state, double[] b, xparams _params)
        {
            var i_ = 0;

            ap.assert(!state.running, "LinCGSetB: you can not set B, because function LinCGIteration is running!");
            ap.assert(ap.len(b) >= state.n, "LinCGSetB: Length(B)<N");
            ap.assert(apserv.isfinitevector(b, state.n, _params), "LinCGSetB: B contains infinite or NaN values!");
            for (i_ = 0; i_ <= state.n - 1; i_++) state.b[i_] = b[i_];
        }
        ...
        *************************************************************************/
        public static void lincgsetprecunit(lincgstate state, xparams _params)
        {
            ap.assert(!state.running, "LinCGSetPrecUnit: you can not change preconditioner, because function LinCGIteration is running!");
            state.prectype = -1;
        }
        ...
        *************************************************************************/
        public static void lincgsetprecdiag(lincgstate state, xparams _params)
        {
            ap.assert(!state.running, "LinCGSetPrecDiag: you can not change preconditioner, because function LinCGIteration is running!");
            state.prectype = 0;
        }
        ...
        *************************************************************************/
        public static void lincgsetcond(lincgstate state, double epsf, int maxits, xparams _params)
        {
            ap.assert(!state.running, "LinCGSetCond: you can not change stopping criteria when LinCGIteration() is running");
            ap.assert(math.isfinite(epsf) && epsf >= 0, "LinCGSetCond: EpsF is negative or contains infinite or NaN values");
            ap.assert(maxits >= 0, "LinCGSetCond: MaxIts is negative");
            if (epsf == 0 && maxits == 0)
            {
                state.epsf = defaultprecision;
                state.maxits = maxits;
        ...
        Reverse communication version of linear CG.
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static bool lincgiteration(lincgstate state, xparams _params)
        {
            var result = new bool();
            var i = 0;
            double uvar = 0;
            ...
            if (state.rstate.stage == 5) goto lbl_5;

            if (state.rstate.stage == 6) goto lbl_6;

            if (state.rstate.stage == 7) goto lbl_7;

            //
            // Routine body
            //
            ap.assert(ap.len(state.b) > 0, "LinCGIteration: B is not initialized (you must initialize B by LinCGSetB() call");
            state.running = true;
            state.repnmv = 0;
            ...
            //
            for (i_ = 0; i_ <= state.n - 1; i_++) state.rx[i_] = state.startx[i_];

            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.rx[i_];
            ...
            // Is x0 a solution?
            //
            if (!math.isfinite(state.r2) || Math.Sqrt(state.r2) <= state.epsf * bnorm)
            {
                state.running = false;
            ...
            // Calculate Z and P
            //
            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.r[i_];
            ...
            // Calculate Alpha
            //
            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.p[i_];
            ...
            lbl_3:
            state.needvmv = false;
            if (!math.isfinite(state.vmv) || state.vmv <= 0)
            {
                //
            ...
            state.alpha = 0;
            for (i = 0; i <= state.n - 1; i++) state.alpha = state.alpha + state.r[i] * state.z[i];
            ...
            //
            for (i = 0; i <= state.n - 1; i++) state.cx[i] = state.rx[i] + state.alpha * state.p[i];
            ...
            //
            if (!(state.itsbeforerupdate == 0 || state.repiterationscount % state.itsbeforerupdate != 0)) goto lbl_12;
            ...
            //
            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.cx[i_];
            ...
            //
            v = 0;
            for (i = 0; i <= state.n - 1; i++) v = v + state.mv[i] * state.cx[i] - 2 * state.b[i] * state.cx[i];

            if (v < state.meritfunction) goto lbl_14;
            ...
            lbl_13:
            for (i_ = 0; i_ <= state.n - 1; i_++) state.rx[i_] = state.cx[i_];
            ...
            //
            state.r2 = 0;
            for (i = 0; i <= state.n - 1; i++) state.r2 = state.r2 + state.cr[i] * state.cr[i];

            //
            //output report
            //
            if (!state.xrep) goto lbl_18;
            ...
            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.cr[i_];
            ...
            lbl_7:
            state.needprec = false;
            for (i_ = 0; i_ <= state.n - 1; i_++) state.cz[i_] = state.pv[i_];
        ...
        NOTE: this function uses lightweight preconditioning -  multiplication  by
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void lincgsolvesparse(lincgstate state, sparse.sparsematrix a, bool isupper, double[] b, xparams _params)
        {
            var n = 0;
            var i = 0;
            double v = 0;
            ...
            while (lincgiteration(state, _params))
            {
                ...
                //
                if (state.needmv) sparse.sparsesmv(a, isupper, state.x, ref state.mv, _params);

                if (state.needvmv)
                {
                    sparse.sparsesmv(a, isupper, state.x, ref state.mv, _params);
                    vmv = 0.0;
                    for (i_ = 0; i_ <= state.n - 1; i_++) vmv += state.x[i_] * state.mv[i_];
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void lincgresults(lincgstate state, ref double[] x, lincgreport rep, xparams _params)
        {
            var i_ = 0;

            x = new double[0];

            ap.assert(!state.running, "LinCGResult: you can not get result, because function LinCGIteration has been launched!");
            if (ap.len(x) < state.n) x = new double[state.n];

            for (i_ = 0; i_ <= state.n - 1; i_++) x[i_] = state.rx[i_];
        ...
        *************************************************************************/
        public static void lincgsetrestartfreq(lincgstate state, int srf, xparams _params)
        {
            ap.assert(!state.running, "LinCGSetRestartFreq: you can not change restart frequency when LinCGIteration() is running");
            ap.assert(srf > 0, "LinCGSetRestartFreq: non-positive SRF");
        ...
        *************************************************************************/
        public static void lincgsetrupdatefreq(lincgstate state, int freq, xparams _params)
        {
            ap.assert(!state.running, "LinCGSetRUpdateFreq: you can not change update frequency when LinCGIteration() is running");
            ap.assert(freq >= 0, "LinCGSetRUpdateFreq: non-positive Freq");
        ...
        *************************************************************************/
        ...
        Procedure for restart function LinCGIteration
          ...
          -- ALGLIB --
             Copyright 14.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void lincgrestart(lincgstate state, xparams _params)
        {
            state.rstate.ia = new int[0 + 1];
            state.rstate.ra = new double[2 + 1];
            state.rstate.stage = -1;
        ...
        Clears request fileds (to be sure that we don't forgot to clear something)
        *************************************************************************/
        private static void clearrfields(lincgstate state, xparams _params)
        {
            state.xupdated = false;
            state.needmv = false;
            state.needmtv = false;
        ...
        Clears request fileds (to be sure that we don't forgot to clear something)
        *************************************************************************/
        private static void updateitersdata(lincgstate state, xparams _params)
        {
            state.repiterationscount = 0;
            state.repnmv = 0;
            state.repterminationtype = 0;
    ...
    public class linlsqr
    {
        ...
        NOTE: see also linlsqrcreatebuf()  for  version  which  reuses  previously
          ...
          -- ALGLIB --
             Copyright 30.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void linlsqrcreate(int m, int n, linlsqrstate state, xparams _params)
        {
            ap.assert(m > 0, "LinLSQRCreate: M<=0");
            ap.assert(n > 0, "LinLSQRCreate: N<=0");
        ...
        *************************************************************************/
        public static void linlsqrcreatebuf(int m, int n, linlsqrstate state, xparams _params)
        {
            ...
            ap.assert(m > 0, "LinLSQRCreateBuf: M<=0");
            ap.assert(n > 0, "LinLSQRCreateBuf: N<=0");
            state.m = m;
            state.n = n;
            state.prectype = 0;
            state.epsa = atol;
            ...
            for (i = 0; i <= n - 1; i++) state.rx[i] = double.NaN;

            for (i = 0; i <= m - 1; i++) state.b[i] = 0;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 30.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void linlsqrsetb(linlsqrstate state, double[] b, xparams _params)
        {
            var i = 0;

            ap.assert(!state.running, "LinLSQRSetB: you can not change B when LinLSQRIteration is running");
            ap.assert(state.m <= ap.len(b), "LinLSQRSetB: Length(B)<M");
            ap.assert(apserv.isfinitevector(b, state.m, _params), "LinLSQRSetB: B contains infinite or NaN values");
            state.bnorm2 = 0;
        ...
        *************************************************************************/
        public static void linlsqrsetprecdiag(linlsqrstate state, xparams _params)
        {
            ap.assert(!state.running, "LinLSQRSetPrecDiag: you can not change preconditioner, because function LinCGIteration is running!");
            state.prectype = 0;
        }
        ...
        *************************************************************************/
        public static void linlsqrsetlambdai(linlsqrstate state, double lambdai, xparams _params)
        {
            ap.assert(!state.running, "LinLSQRSetLambdaI: you can not set LambdaI, because function LinLSQRIteration is running");
            ap.assert(math.isfinite(lambdai) && lambdai >= 0, "LinLSQRSetLambdaI: LambdaI is infinite or NaN");
        ...
        /*************************************************************************
          ...
          -- ALGLIB --
             Copyright 30.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static bool linlsqriteration(linlsqrstate state, xparams _params)
        {
            var result = new bool();
            var summn = 0;
            double bnorm = 0;
            ...
            // Routine body
            //
            ap.assert(ap.len(state.b) > 0, "LinLSQRIteration: using non-allocated array B");
            ...
            lbl_7:
            if (!normestimator.normestimatoriteration(state.nes, _params)) goto lbl_8;

            if (!state.nes.needmv) goto lbl_9;

            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.nes.x[i_];
            ...
            lbl_0:
            state.needmv = false;
            for (i_ = 0; i_ <= state.m - 1; i_++) state.nes.mv[i_] = state.mv[i_];

            goto lbl_7;
            lbl_9:
            if (!state.nes.needmtv) goto lbl_11;

            for (i_ = 0; i_ <= state.m - 1; i_++) state.x[i_] = state.nes.x[i_];
            ...
            lbl_1:
            state.needmtv = false;
            for (i_ = 0; i_ <= state.n - 1; i_++) state.nes.mtv[i_] = state.mtv[i_];
            ...
            //
            for (i = 0; i <= state.n - 1; i++) state.rx[i] = 0;

            //
            //output first report
            //
            if (!state.xrep) goto lbl_13;
            ...
            lbl_3:
            state.needmtv = false;
            for (i = 0; i <= state.n - 1; i++) state.mtv[i] = state.mtv[i] + state.lambdai * state.ui[state.m + i];

            state.alphai = 0;
            for (i = 0; i <= state.n - 1; i++) state.alphai = state.alphai + state.mtv[i] * state.mtv[i];
            ...
            for (i = 0; i <= state.n - 1; i++) state.d[i] = 0;
            ...
            //
            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = state.vi[i_];
            ...
            lbl_4:
            state.needmv = false;
            for (i = 0; i <= state.n - 1; i++) state.mv[state.m + i] = state.lambdai * state.vi[i];
            ...
            if (state.betaip1 != 0)
            {
                ...
                for (i = 0; i <= summn - 1; i++) state.uip1[i] = state.uip1[i] / state.betaip1;
            }

            for (i_ = 0; i_ <= state.m - 1; i_++) state.x[i_] = state.uip1[i_];
            ...
            lbl_5:
            state.needmtv = false;
            for (i = 0; i <= state.n - 1; i++) state.mtv[i] = state.mtv[i] + state.lambdai * state.uip1[state.m + i];
            ...
            if (state.alphaip1 != 0)
            {
                ...
                for (i = 0; i <= state.n - 1; i++) state.vip1[i] = state.vip1[i] / state.alphaip1;
            }
            ...
            if (Math.Sqrt(state.dnorm) * state.anorm >= state.epsc)
            {
                state.running = false;
                state.repterminationtype = 7;
                result = false;
            ...
            //
            for (i = 0; i <= state.n - 1; i++) state.rx[i] = state.rx[i] + state.phii / state.rhoi * state.omegai[i];

            if (!state.xrep) goto lbl_17;
            ...
            if (state.alphaip1 * Math.Abs(state.ci) / state.anorm <= state.epsa)
            {
                //
            ...
            // ...
            //
            for (i_ = 0; i_ <= summn - 1; i_++) state.ui[i_] = state.uip1[i_];

            for (i_ = 0; i_ <= state.n - 1; i_++) state.vi[i_] = state.vip1[i_];

            for (i_ = 0; i_ <= state.n - 1; i_++) state.omegai[i_] = state.omegaip1[i_];
        ...
        NOTE: this function uses lightweight preconditioning -  multiplication  by
          ...
          -- ALGLIB --
             Copyright 30.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void linlsqrsolvesparse(linlsqrstate state, sparse.sparsematrix a, double[] b, xparams _params)
        {
            var n = 0;
            var i = 0;
            var j = 0;
            ...
            n = state.n;
            ap.assert(!state.running, "LinLSQRSolveSparse: you can not call this function when LinLSQRIteration is running");
            ap.assert(ap.len(b) >= state.m, "LinLSQRSolveSparse: Length(B)<M");
            ap.assert(apserv.isfinitevector(b, state.m, _params), "LinLSQRSolveSparse: B contains infinite or NaN values");
            ...
            if (state.prectype == 0)
            {
                ...
                //
                for (i = 0; i <= n - 1; i++) state.tmpd[i] = 0;
            ...
            while (linlsqriteration(state, _params))
            {
                if (state.needmv)
                {
                    for (i = 0; i <= n - 1; i++) state.tmpx[i] = state.tmpd[i] * state.x[i];
                ...
                if (state.needmtv)
                {
                    ...
                    for (i = 0; i <= n - 1; i++) state.mtv[i] = state.tmpd[i] * state.mtv[i];
                }
            }

            for (i = 0; i <= n - 1; i++) state.rx[i] = state.tmpd[i] * state.rx[i];
        }
        ...
        *************************************************************************/
        public static void linlsqrsetcond(linlsqrstate state, double epsa, double epsb, int maxits, xparams _params)
        {
            ap.assert(!state.running, "LinLSQRSetCond: you can not call this function when LinLSQRIteration is running");
            ap.assert(math.isfinite(epsa) && epsa >= 0, "LinLSQRSetCond: EpsA is negative, INF or NAN");
            ap.assert(math.isfinite(epsb) && epsb >= 0, "LinLSQRSetCond: EpsB is negative, INF or NAN");
            ap.assert(maxits >= 0, "LinLSQRSetCond: MaxIts is negative");
            if (epsa == 0 && epsb == 0 && maxits == 0)
            {
                state.epsa = atol;
                state.epsb = btol;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 30.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void linlsqrresults(linlsqrstate state, ref double[] x, linlsqrreport rep, xparams _params)
        {
            var i_ = 0;

            x = new double[0];

            ap.assert(!state.running, "LinLSQRResult: you can not call this function when LinLSQRIteration is running");
            if (ap.len(x) < state.n) x = new double[state.n];
        ...
        *************************************************************************/
        ...
        This function restarts LinLSQRIteration
          ...
          -- ALGLIB --
             Copyright 30.11.2011 by Bochkanov Sergey
        *************************************************************************/
        public static void linlsqrrestart(linlsqrstate state, xparams _params)
        {
            state.rstate.ia = new int[1 + 1];
            state.rstate.ra = new double[0 + 1];
            state.rstate.stage = -1;
        ...
        *************************************************************************/
        ...
        Clears request fileds (to be sure that we don't forgot to clear something)
        *************************************************************************/
        private static void clearrfields(linlsqrstate state, xparams _params)
        {
            state.xupdated = false;
            state.needmv = false;
            state.needmtv = false;
    ...
    public class directsparsesolvers
    {
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            n = sparse.sparsegetnrows(a, _params);
            ap.assert(n > 0, "SparseSPDSolveSKS: N<=0");
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseSPDSolveSKS: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseSPDSolveSKS: cols(A)!=N");
            ap.assert(ap.len(b) >= n, "SparseSPDSolveSKS: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSPDSolveSKS: B contains infinities or NANs");
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            var n = 0;
            var p = new int[0];
            var idummy = new int[0];
            var donotreusemem = 0;
            var analysis = new spchol.spcholanalysis();
            var flg = new bool();

            x = new double[0];

            n = sparse.sparsegetnrows(a, _params);
            ap.assert(n > 0, "SparseSPDSolve: N<=0");
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseSPDSolve: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseSPDSolve: cols(A)!=N");
            ap.assert(ap.len(b) >= n, "SparseSPDSolve: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSPDSolve: B contains infinities or NANs");
            iterativesparse.initsparsesolverreport(rep, _params);
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 26.12.2017 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsespdcholeskysolve(sparse.sparsematrix a, bool isupper, double[] b, ref double[] x,
            iterativesparse.sparsesolverreport rep, xparams _params)
        {
            ...
            x = new double[n];
            for (i = 0; i <= n - 1; i++)
                if (sparse.sparseget(a, i, i, _params) == 0.0)
                {
                    rep.terminationtype = -3;
                    for (i = 0; i <= n - 1; i++) x[i] = 0;
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            var sc = new double[0];
            double reg = 0;
            var e = new normestimator.normestimatorstate();
            var gmresk = 0;
            var maxits = 0;
            ...
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseSolve: B contains infinities or NANs");

            //
            // Default solver
            //
            if (solvertype == 0) solvertype = 10;
            ...
            //
            ap.assert(false, "DIRECTSPARSESOLVERS: integrity check 1038 failed");
        }
        ...
        OUTPUT PARAMETERS
          ...
          -- ALGLIB --
             Copyright 18.11.2023 by Bochkanov Sergey
        *************************************************************************/
        public static void sparsesolvelsreg(sparse.sparsematrix a, double[] b, double reg, int solvertype, ref double[] x,
            iterativesparse.sparsesolverreport rep, xparams _params)
        {
            var n = 0;
            var m = 0;
            ...
            ap.assert(m > 0, "SparseSolveLS: M<=0");
            ap.assert(n > 0, "SparseSolveLS: N<=0");
            ap.assert(math.isfinite(reg) && reg > 0, "SparseSolveLS: Reg is not finite or non-positive");
            ap.assert(solvertype == 0 || solvertype == -19 || solvertype == 10 || solvertype == 11, "SparseSolveLS: unexpected SolverType");
            ap.assert(ap.len(b) >= m, "SparseSolveLS: length(B)<M");
            ap.assert(apserv.isfinitevector(b, m, _params), "SparseSolveLS: B contains infinities or NANs");
            ...
            // unexpected solver type
            //
            ap.assert(false, "DIRECTSPARSESOLVERS: integrity check 1622 failed");
        }
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            n = sparse.sparsegetnrows(a, _params);
            ap.assert(n > 0, "SparseLUSolve: N<=0");
            ap.assert(sparse.sparsegetnrows(a, _params) == n, "SparseLUSolve: rows(A)!=N");
            ap.assert(sparse.sparsegetncols(a, _params) == n, "SparseLUSolve: cols(A)!=N");
            ap.assert(sparse.sparseiscrs(a, _params), "SparseLUSolve: A is not an SKS matrix");
            ap.assert(ap.len(b) >= n, "SparseLUSolve: length(B)<N");
            ap.assert(apserv.isfinitevector(b, n, _params), "SparseLUSolve: B contains infinities or NANs");
            ap.assert(ap.len(p) >= n, "SparseLUSolve: length(P)<N");
            ap.assert(ap.len(q) >= n, "SparseLUSolve: length(Q)<N");
            for (i = 0; i <= n - 1; i++)
            {
                ap.assert(p[i] >= i && p[i] < n, "SparseLUSolve: P is corrupted");
                ap.assert(q[i] >= i && q[i] < n, "SparseLUSolve: Q is corrupted");
            }
        ...
        *************************************************************************/
            ...
            int maxits, double[] x, iterativesparse.sparsesolverreport rep, xparams _params)
        {
            ...
            var n = 0;
            var nzaug = 0;
            var aug = new sparse.sparsematrix();
            var priorities = new int[0];
            var bx = new double[0];
            var analysis = new spchol.spcholanalysis();
            var solver = new iterativesparse.sparsesolverstate();
            var innerrep = new iterativesparse.sparsesolverreport();
            var requesttype = 0;
            var rr = new double[0];
            var q = new double[0];
            var y = new double[0];
            var priorityordering = 0;
            var donotreusememory = 0;

            ap.assert(sparse.sparseiscrs(a, _params), "SparseSolveAug: A is not stored in the CRS format");
            m = sparse.sparsegetnrows(a, _params);
            n = sparse.sparsegetncols(a, _params);
            ap.assert(math.isfinite(reg1f) && reg1f > 0, "SparseSolveAug: Reg1F is non-positive");
            ap.assert(math.isfinite(reg2f) && reg2f > 0, "SparseSolveAug: Reg2F is non-positive");
            ap.assert(math.isfinite(reg1r) && reg1r >= 0, "SparseSolveAug: Reg1R is non-positive");
            ap.assert(math.isfinite(reg2r) && reg2r >= 0, "SparseSolveAug: Reg2R is non-positive");
            ap.assert(ap.len(b) >= m, "SparseSolveAug: length(B)<N");
            ap.assert(apserv.isfinitevector(b, m, _params), "SparseSolveAug: B contains infinities or NANs");
            ap.assert(ap.len(x) >= n, "SparseSolveAug: length(X)<N");
            ...
            ap.assert(aug.ridx[n + m] == nzaug, "SparseSolveAug: integrity check 2141 failed");
            ...
            if (!spchol.spsymmanalyze(aug, priorities, 0.0, 0, 1, priorityordering, donotreusememory, analysis, _params))
                ap.assert(false, "SparseSolveAug: integrity check 4141 failed");
            ...
            while (iterativesparse.sparsesolverooccontinue(solver, _params))
            {
                ...
                ap.assert(requesttype == 0, "SPARSESOLVE: integrity check 8618 failed");
    ...
    public class nleq
    {
        ...
        * value of merit function f(x)=F[0]^2(x)+...+F[M-1]^2(x) at given point X
        ...
        3. this  algorithm  is  a  slightly  modified implementation of the method
          ...
          -- ALGLIB --
             Copyright 20.08.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void nleqcreatelm(int n, int m, double[] x, nleqstate state, xparams _params)
        {
            ap.assert(n >= 1, "NLEQCreateLM: N<1!");
            ap.assert(m >= 1, "NLEQCreateLM: M<1!");
            ap.assert(ap.len(x) >= n, "NLEQCreateLM: Length(X)<N!");
            ap.assert(apserv.isfinitevector(x, n, _params), "NLEQCreateLM: X contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static void nleqsetcond(nleqstate state, double epsf, int maxits, xparams _params)
        {
            ...
            ap.assert(epsf >= 0, "NLEQSetCond: negative EpsF!");
        ...
        *************************************************************************/
        public static void nleqsetstpmax(nleqstate state, double stpmax, xparams _params)
        {
            ...
            ap.assert(stpmax >= 0, "NLEQSetStpMax: StpMax<0!");
            state.stpmax = stpmax;
        }
        ...
        *************************************************************************/
        public static bool nleqiteration(nleqstate state, xparams _params)
        {
            ...
            for (i_ = 0; i_ <= n - 1; i_++) state.xbase[i_] = state.x[i_];

            state.fbase = state.f;
            state.fprev = math.maxrealnumber;
            if (!state.xrep) goto lbl_5;
            ...
            state.xupdated = false;
            lbl_5:
            if (state.f <= math.sqr(state.epsf))
            {
                state.repterminationtype = 1;
                result = false;
                return result;
            ...
            clearrequestfields(state, _params);
            state.needfij = true;
            for (i_ = 0; i_ <= n - 1; i_++) state.x[i_] = state.xbase[i_];
            ...
            for (i_ = 0; i_ <= n - 1; i_++) state.rightpart[i_] = -1 * state.rightpart[i_];

            //
            // Inner cycle: find good lambda
            //
            lbl_9:
            if (false) goto lbl_10;
            ...
            //
            for (i = 0; i <= n - 1; i++) state.candstep[i] = 0;
            ...
            if (state.stpmax != 0) stepnorm = Math.Min(stepnorm, state.stpmax);
            ...
            for (i_ = 0; i_ <= n - 1; i_++) state.x[i_] = state.x[i_] + stepnorm * state.candstep[i_];

            b = true;
            for (i = 0; i <= n - 1; i++)
                if (state.x[i] != state.xbase[i])
                {
                    b = false;
                    break;
                }
            ...
            //
            state.fbase = state.f;
            for (i_ = 0; i_ <= n - 1; i_++) state.xbase[i_] = state.xbase[i_] + stepnorm * state.candstep[i_];
            ...
            //
            if (Math.Sqrt(state.f) <= state.epsf) state.repterminationtype = 1;

            if (stepnorm == 0 && state.repterminationtype == 0) state.repterminationtype = -4;

            if (state.repiterationscount >= state.maxits && state.maxits > 0) state.repterminationtype = 5;

            if (state.repterminationtype != 0) goto lbl_8;
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 20.08.2009 by Bochkanov Sergey
        *************************************************************************/
        public static void nleqresults(nleqstate state, ref double[] x, nleqreport rep, xparams _params)
        {
            x = new double[0];
        ...
        *************************************************************************/
        public static void nleqresultsbuf(nleqstate state, ref double[] x, nleqreport rep, xparams _params)
        {
            ...
            for (i_ = 0; i_ <= state.n - 1; i_++) x[i_] = state.xbase[i_];
        ...
        *************************************************************************/
        public static void nleqrestartfrom(nleqstate state, double[] x, xparams _params)
        {
            ...
            ap.assert(apserv.isfinitevector(x, state.n, _params), "NLEQRestartFrom: X contains infinite or NaN values!");
            for (i_ = 0; i_ <= state.n - 1; i_++) state.x[i_] = x[i_];
        ...
        *************************************************************************/
        public static void nleqsetprotocolv1(nleqstate state, xparams _params)
        {
        }
        ...
        Clears request fileds (to be sure that we don't forgot to clear something)
        *************************************************************************/
        private static void clearrequestfields(nleqstate state, xparams _params)
        {
            state.needf = false;
            state.needfij = false;
            state.xupdated = false;
        ...
        *************************************************************************/
        private static bool increaselambda(ref double lambdav, ref double nu, double lambdaup, xparams _params)
        {
            var result = new bool();
            double lnlambda = 0;
            double lnnu = 0;
            ...
            if (lnlambda + lnlambdaup + lnnu > lnmax) return result;

            if (lnnu + Math.Log(2) > lnmax) return result;
        ...
        *************************************************************************/
        private static void decreaselambda(ref double lambdav, ref double nu, double lambdadown, xparams _params)
        {
            nu = 1;
            if (Math.Log(lambdav) + Math.Log(lambdadown) < Math.Log(math.minrealnumber))
