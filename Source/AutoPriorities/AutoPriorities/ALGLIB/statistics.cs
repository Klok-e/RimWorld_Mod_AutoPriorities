...
public partial class alglib
{
    ...
    *************************************************************************/
    ...
    public static void rankdata(double[,] xy, int npoints, int nfeatures, xparams _params)
    {
    ...
    public static void rankdata(double[,] xy, xparams _params)
    {
        int npoints;
        int nfeatures;
    ...
    *************************************************************************/
    ...
    public static void rankdatacentered(double[,] xy, int npoints, int nfeatures, xparams _params)
    {
    ...
    public static void rankdatacentered(double[,] xy, xparams _params)
    {
        int npoints;
        int nfeatures;
...
public partial class alglib
{
    public class basestat
    {
        ...
        NOTE: variance is calculated by dividing sum of squares by N-1, not N.
          ...
          -- ALGLIB --
             Copyright 06.09.2006 by Bochkanov Sergey
        *************************************************************************/
        public static void samplemoments(double[] x, int n, ref double mean, ref double variance, ref double skewness, ref double kurtosis,
            xparams _params)
        {
            var i = 0;
            double v = 0;
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "SampleMoments: X is not finite vector");
            ...
            {
                v1 = 0;
                for (i = 0; i <= n - 1; i++) v1 = v1 + math.sqr(x[i] - mean);

                v2 = 0;
                for (i = 0; i <= n - 1; i++) v2 = v2 + (x[i] - mean);
        ...
        *************************************************************************/
        ...
        Output parameters:
          ...
          -- ALGLIB --
             Copyright 06.09.2006 by Bochkanov Sergey
        *************************************************************************/
        public static void sampleadev(double[] x, int n, ref double adev, xparams _params)
        {
            var i = 0;
            double mean = 0;
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "SampleADev: X is not finite vector");
            ...
            // ADev
            //
            for (i = 0; i <= n - 1; i++) adev = adev + Math.Abs(x[i] - mean);
        ...
        Output parameters:
          ...
          -- ALGLIB --
             Copyright 06.09.2006 by Bochkanov Sergey
        *************************************************************************/
        public static void samplemedian(double[] x, int n, ref double median, xparams _params)
        {
            var i = 0;
            var ir = 0;
            var j = 0;
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "SampleMedian: X is not finite vector");
        ...
        Output parameters:
          ...
          -- ALGLIB --
             Copyright 01.03.2008 by Bochkanov Sergey
        *************************************************************************/
        public static void samplepercentile(double[] x, int n, double p, ref double v, xparams _params)
        {
            var i1 = 0;
            double t = 0;
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "SamplePercentile: X is not finite vector");
            ap.assert(math.isfinite(p), "SamplePercentile: incorrect P!");
            ap.assert(p >= 0 && p <= 1, "SamplePercentile: incorrect P!");
        ...
        *************************************************************************/
        public static double cov2(double[] x, double[] y, int n, xparams _params)
        {
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "Cov2: X is not finite vector");
            ap.assert(apserv.isfinitevector(y, n, _params), "Cov2: Y is not finite vector");
            ...
            v = 1 / (double)(n - 1);
            result = 0;
            for (i = 0; i <= n - 1; i++) result = result + v * (x[i] - xmean) * (y[i] - ymean);
        ...
        *************************************************************************/
        public static double pearsoncorr2(double[] x, double[] y, int n, xparams _params)
        {
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "PearsonCorr2: X is not finite vector");
            ap.assert(apserv.isfinitevector(y, n, _params), "PearsonCorr2: Y is not finite vector");
        ...
        *************************************************************************/
        public static double spearmancorr2(double[] x, double[] y, int n, xparams _params)
        {
            ...
            ap.assert(apserv.isfinitevector(x, n, _params), "SpearmanCorr2: X is not finite vector");
            ap.assert(apserv.isfinitevector(y, n, _params), "SpearmanCorr2: Y is not finite vector");
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void covm(double[,] x, int n, int m, ref double[,] c, xparams _params)
        {
            var i = 0;
            var j = 0;
            double v = 0;
            ...
            ap.assert(apserv.apservisfinitematrix(x, n, m, _params), "CovM: X contains infinite/NAN elements");
            ...
            for (i_ = 0; i_ <= m - 1; i_++) x0[i_] = x[0, i_];

            v = 1 / (double)n;
            for (i = 0; i <= n - 1; i++)
            {
                for (i_ = 0; i_ <= m - 1; i_++) t[i_] = t[i_] + v * x[i, i_];

                for (j = 0; j <= m - 1; j++) same[j] = same[j] && x[i, j] == x0[j];
            }
            ...
            for (i = 0; i <= n - 1; i++)
            {
                for (i_ = 0; i_ <= m - 1; i_++) x[i, i_] = x[i, i_] - t[i_];
            ...
            ablas.rmatrixsyrk(m, n, 1 / (double)(n - 1), x, 0, 0, 1, 0.0, c, 0, 0, true, _params);
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void pearsoncorrm(double[,] x, int n, int m, ref double[,] c, xparams _params)
        {
            var t = new double[0];
            var i = 0;
            var j = 0;
            ...
            ap.assert(apserv.apservisfinitematrix(x, n, m, _params), "PearsonCorrM: X contains infinite/NAN elements");
            t = new double[m];
            ...
            {
                v = t[i];
                for (j = 0; j <= m - 1; j++) c[i, j] = c[i, j] * v * t[j];
            }
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void spearmancorrm(double[,] x, int n, int m, ref double[,] c, xparams _params)
        {
            var i = 0;
            var j = 0;
            var buf = new apserv.apbuffers();
            ...
            ap.assert(apserv.apservisfinitematrix(x, n, m, _params), "SpearmanCorrM: X contains infinite/NAN elements");
            ...
            // Calculate upper half of symmetric covariance matrix
            //
            ablas.rmatrixsyrk(m, n, 1 / (double)(n - 1), xc, 0, 0, 0, 0.0, c, 0, 0, true, _params);
            ...
            {
                v = t[i];
                for (j = i; j <= m - 1; j++) c[i, j] = c[i, j] * v * t[j];
            }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void covm2(double[,] x, double[,] y, int n, int m1, int m2, ref double[,] c, xparams _params)
        {
            var i = 0;
            var j = 0;
            double v = 0;
            ...
            ap.assert(apserv.apservisfinitematrix(x, n, m1, _params), "CovM2: X contains infinite/NAN elements");
            ap.assert(ap.rows(y) >= n, "CovM2: Rows(Y)<N!");
            ap.assert(ap.cols(y) >= m2 || n == 0, "CovM2: Cols(Y)<M2!");
            ap.assert(apserv.apservisfinitematrix(y, n, m2, _params), "CovM2: X contains infinite/NAN elements");
            ...
            for (i_ = 0; i_ <= m1 - 1; i_++) x0[i_] = x[0, i_];

            v = 1 / (double)n;
            for (i = 0; i <= n - 1; i++)
            {
                for (i_ = 0; i_ <= m1 - 1; i_++) t[i_] = t[i_] + v * x[i, i_];

                for (j = 0; j <= m1 - 1; j++) samex[j] = samex[j] && x[i, j] == x0[j];
            }

            for (i = 0; i <= n - 1; i++)
            {
                for (i_ = 0; i_ <= m1 - 1; i_++) x[i, i_] = x[i, i_] - t[i_];
            ...
            for (i_ = 0; i_ <= m2 - 1; i_++) y0[i_] = y[0, i_];

            v = 1 / (double)n;
            for (i = 0; i <= n - 1; i++)
            {
                for (i_ = 0; i_ <= m2 - 1; i_++) t[i_] = t[i_] + v * y[i, i_];

                for (j = 0; j <= m2 - 1; j++) samey[j] = samey[j] && y[i, j] == y0[j];
            }

            for (i = 0; i <= n - 1; i++)
            {
                for (i_ = 0; i_ <= m2 - 1; i_++) y[i, i_] = y[i, i_] - t[i_];
            ...
            //
            ablas.rmatrixgemm(m1, m2, n, 1 / (double)(n - 1), x, 0, 0, 1, y, 0, 0, 0, 0.0, c, 0, 0, _params);
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void pearsoncorrm2(double[,] x, double[,] y, int n, int m1, int m2, ref double[,] c, xparams _params)
        {
            var i = 0;
            var j = 0;
            double v = 0;
            ...
            ap.assert(apserv.apservisfinitematrix(x, n, m1, _params), "PearsonCorrM2: X contains infinite/NAN elements");
            ap.assert(ap.rows(y) >= n, "PearsonCorrM2: Rows(Y)<N!");
            ap.assert(ap.cols(y) >= m2 || n == 0, "PearsonCorrM2: Cols(Y)<M2!");
            ap.assert(apserv.apservisfinitematrix(y, n, m2, _params), "PearsonCorrM2: X contains infinite/NAN elements");
            ...
            for (j = 0; j <= m1 - 1; j++) sx[j] = Math.Sqrt(sx[j] / (n - 1));
            ...
            for (j = 0; j <= m2 - 1; j++) sy[j] = Math.Sqrt(sy[j] / (n - 1));
            ...
            {
                v = sx[i];
                for (j = 0; j <= m2 - 1; j++) c[i, j] = c[i, j] * v * sy[j];
            }
        }
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 28.10.2010 by Bochkanov Sergey
        *************************************************************************/
        public static void spearmancorrm2(double[,] x, double[,] y, int n, int m1, int m2, ref double[,] c, xparams _params)
        {
            var i = 0;
            var j = 0;
            double v = 0;
            ...
            ap.assert(apserv.apservisfinitematrix(x, n, m1, _params), "SpearmanCorrM2: X contains infinite/NAN elements");
            ap.assert(ap.rows(y) >= n, "SpearmanCorrM2: Rows(Y)<N!");
            ap.assert(ap.cols(y) >= m2 || n == 0, "SpearmanCorrM2: Cols(Y)<M2!");
            ap.assert(apserv.apservisfinitematrix(y, n, m2, _params), "SpearmanCorrM2: X contains infinite/NAN elements");
            ...
            // calculate cross-covariance matrix
            //
            ablas.rmatrixgemm(m1, m2, n, 1 / (double)(n - 1), xc, 0, 0, 0, yc, 0, 0, 1, 0.0, c, 0, 0, _params);
        ...
        *************************************************************************/
        public static void rankdata(double[,] xy, int npoints, int nfeatures, xparams _params)
        {
            ...
            ap.assert(npoints >= 0, "RankData: NPoints<0");
            ap.assert(nfeatures >= 1, "RankData: NFeatures<1");
            ap.assert(ap.rows(xy) >= npoints, "RankData: Rows(XY)<NPoints");
            ap.assert(ap.cols(xy) >= nfeatures || npoints == 0, "RankData: Cols(XY)<NFeatures");
            ap.assert(apserv.apservisfinitematrix(xy, npoints, nfeatures, _params), "RankData: XY contains infinite/NAN elements");
            ...
            //
            basecasecost = 10000;
            if (apserv.rmul3(npoints, nfeatures, apserv.logbase2(nfeatures, _params), _params) < basecasecost)
            {
            ...
            // Parallel code
            //
            smp.ae_shared_pool_set_seed(pool, buf0);
        ...
        *************************************************************************/
        public static bool _trypexec_rankdata(double[,] xy, int npoints, int nfeatures, xparams _params)
        {
            return false;
        }
        ...
        *************************************************************************/
        ...
        Serial stub for GPL edition.
        *************************************************************************/
        public static bool _trypexec_rankdatacentered(double[,] xy, int npoints, int nfeatures, xparams _params)
        {
            return false;
        }
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            ap.assert(i1 >= i0, "RankDataRec: internal error");
            ...
            if (i1 - i0 >= 2 && problemcost > apserv.spawnlevel(_params))
            {
                im = (i1 + i0) / 2;
            ...
            //
            smp.ae_shared_pool_retrieve(pool, ref buf0);
            smp.ae_shared_pool_retrieve(pool, ref buf1);
            rankdatabasecase(xy, i0, i1, nfeatures, iscentered, buf0, buf1, _params);
            smp.ae_shared_pool_recycle(pool, ref buf0);
            smp.ae_shared_pool_recycle(pool, ref buf1);
        }
        ...
        *************************************************************************/
        ...
        OUTPUT PARAMETERS:
          ...
          -- ALGLIB --
             Copyright 18.04.2013 by Bochkanov Sergey
        *************************************************************************/
        private static void rankdatabasecase(double[,] xy, int i0, int i1, int nfeatures, bool iscentered, apserv.apbuffers buf0,
            apserv.apbuffers buf1, xparams _params)
        {
            var i = 0;
            var i_ = 0;

            ap.assert(i1 >= i0, "RankDataBasecase: internal error");
            if (ap.len(buf1.ra0) < nfeatures) buf1.ra0 = new double[nfeatures];

            for (i = i0; i <= i1 - 1; i++)
            {
                for (i_ = 0; i_ <= nfeatures - 1; i_++) buf1.ra0[i_] = xy[i, i_];

                basicstatops.rankx(buf1.ra0, nfeatures, iscentered, buf0, _params);
                for (i_ = 0; i_ <= nfeatures - 1; i_++) xy[i, i_] = buf1.ra0[i_];
            }
        }
        ...
        Serial stub for GPL edition.
        *************************************************************************/
        public static bool _trypexec_rankdatabasecase(double[,] xy, int i0, int i1, int nfeatures, bool iscentered, apserv.apbuffers buf0,
            apserv.apbuffers buf1, xparams _params)
        {
            return false;
        }
    ...
    public class correlationtests
    {
        ...
        Output parameters:
          ...
          -- ALGLIB --
             Copyright 09.04.2007 by Bochkanov Sergey
        *************************************************************************/
        public static void pearsoncorrelationsignificance(double r, int n, ref double bothtails, ref double lefttail, ref double righttail,
            xparams _params)
        {
            double t = 0;
            double p = 0;
        ...
        *************************************************************************/
        ...
        Tail(S, 5)
        *************************************************************************/
        private static double spearmantail5(double s, xparams _params)
        {
            double result = 0;
        ...
        Tail(S, 6)
        *************************************************************************/
        private static double spearmantail6(double s, xparams _params)
        {
            double result = 0;
        ...
        Tail(S, 7)
        *************************************************************************/
        private static double spearmantail7(double s, xparams _params)
        {
            double result = 0;
        ...
        Tail(S, 8)
        *************************************************************************/
        private static double spearmantail8(double s, xparams _params)
        {
            double result = 0;
        ...
        Tail(S, 9)
        *************************************************************************/
        private static double spearmantail9(double s, xparams _params)
        {
            double result = 0;
        ...
        *************************************************************************/
        private static double spearmantail(double t, int n, xparams _params)
        {
            double result = 0;
    ...
    public class jarquebera
    {
        ...
        from table values.
          ...
          -- ALGLIB --
             Copyright 09.04.2007 by Bochkanov Sergey
        *************************************************************************/
        public static void jarqueberatest(double[] x, int n, ref double p, xparams _params)
        {
            double s = 0;
        ...
        private static void jarqueberastatistic(double[] x, int n, ref double s, xparams _params)
        {
            var i = 0;
            double v = 0;
            double v1 = 0;
            ...
            // Statistic
            //
            s = n / (double)6 * (math.sqr(skewness) + math.sqr(kurtosis) / 4);
        }


        private static double jarqueberaapprox(int n, double s, xparams _params)
        {
            double result = 0;
            var vx = new double[0];
            var vy = new double[0];
            ...
            if (n >= 5 && n <= 20)
            {
                if (n == 5) result = Math.Exp(jbtbl5(x, _params));

                if (n == 6) result = Math.Exp(jbtbl6(x, _params));

                if (n == 7) result = Math.Exp(jbtbl7(x, _params));

                if (n == 8) result = Math.Exp(jbtbl8(x, _params));

                if (n == 9) result = Math.Exp(jbtbl9(x, _params));

                if (n == 10) result = Math.Exp(jbtbl10(x, _params));

                if (n == 11) result = Math.Exp(jbtbl11(x, _params));

                if (n == 12) result = Math.Exp(jbtbl12(x, _params));

                if (n == 13) result = Math.Exp(jbtbl13(x, _params));

                if (n == 14) result = Math.Exp(jbtbl14(x, _params));

                if (n == 15) result = Math.Exp(jbtbl15(x, _params));

                if (n == 16) result = Math.Exp(jbtbl16(x, _params));

                if (n == 17) result = Math.Exp(jbtbl17(x, _params));

                if (n == 18) result = Math.Exp(jbtbl18(x, _params));

                if (n == 19) result = Math.Exp(jbtbl19(x, _params));

                if (n == 20) result = Math.Exp(jbtbl20(x, _params));
            ...
            if (n > 1401)
            {
                result = -(0.5 * x) + (jbtbl1401(x, _params) + 0.5 * x) * Math.Sqrt(1401 / (double)n);
                if (result > 0) result = 0;
        ...
        private static double jbtbl5(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl6(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl7(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl8(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl9(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl16(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl17(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl18(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl19(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl20(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl50(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl65(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl130(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl200(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl301(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl501(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl701(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static double jbtbl1401(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        private static void jbcheb(double x, double c, ref double tj, ref double tj1, ref double r, xparams _params)
        {
            double t = 0;
    ...
    public class variancetests
    {
        ...
        Output parameters:
          ...
          -- ALGLIB --
             Copyright 19.09.2006 by Bochkanov Sergey
        *************************************************************************/
        public static void ftest(double[] x, int n, double[] y, int m, ref double bothtails, ref double lefttail, ref double righttail,
            xparams _params)
        {
            var i = 0;
            double xmean = 0;
            ...
            //
            xmean = 0;
            for (i = 0; i <= n - 1; i++) xmean = xmean + x[i];

            xmean = xmean / n;
            ymean = 0;
            for (i = 0; i <= m - 1; i++) ymean = ymean + y[i];
            ...
            //
            xvar = 0;
            for (i = 0; i <= n - 1; i++) xvar = xvar + math.sqr(x[i] - xmean);

            xvar = xvar / (n - 1);
            yvar = 0;
            for (i = 0; i <= m - 1; i++) yvar = yvar + math.sqr(y[i] - ymean);
    ...
    public class wsr
    {
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            while (i <= ns - 1)
            {
                ...
                for (k = i; k <= j - 1; k++) r[k] = 1 + (i + j - 1) / (double)2;
        ...
        *************************************************************************/
        private static void wcheb(double x, double c, ref double tj, ref double tj1, ref double r, xparams _params)
        {
            double t = 0;
        ...
        Tail(S, 5)
        *************************************************************************/
        private static double w5(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 6)
        *************************************************************************/
        private static double w6(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 7)
        *************************************************************************/
        private static double w7(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 8)
        *************************************************************************/
        private static double w8(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 9)
        *************************************************************************/
        private static double w9(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 10)
        *************************************************************************/
        private static double w10(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 11)
        *************************************************************************/
        private static double w11(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 12)
        *************************************************************************/
        private static double w12(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 13)
        *************************************************************************/
        private static double w13(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 14)
        *************************************************************************/
        private static double w14(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 15)
        *************************************************************************/
        private static double w15(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 16)
        *************************************************************************/
        private static double w16(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 17)
        *************************************************************************/
        private static double w17(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 18)
        *************************************************************************/
        private static double w18(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 19)
        *************************************************************************/
        private static double w19(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
        ...
        Tail(S, 20)
        *************************************************************************/
        private static double w20(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
            ...
            if (w >= 105) r = -6.787e-01;

            if (w == 104) r = -7.078e-01;

            if (w == 103) r = -7.378e-01;

            if (w == 102) r = -7.686e-01;

            if (w == 101) r = -8.004e-01;

            if (w == 100) r = -8.330e-01;
        ...
        Tail(S, 21)
        *************************************************************************/
        private static double w21(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
            ...
            if (w >= 115) r = -6.931e-01;

            if (w == 114) r = -7.207e-01;

            if (w == 113) r = -7.489e-01;

            if (w == 112) r = -7.779e-01;

            if (w == 111) r = -8.077e-01;

            if (w == 110) r = -8.383e-01;

            if (w == 109) r = -8.697e-01;

            if (w == 108) r = -9.018e-01;

            if (w == 107) r = -9.348e-01;

            if (w == 106) r = -9.685e-01;

            if (w == 105) r = -1.003e+00;

            if (w == 104) r = -1.039e+00;

            if (w == 103) r = -1.075e+00;

            if (w == 102) r = -1.112e+00;

            if (w == 101) r = -1.150e+00;

            if (w == 100) r = -1.189e+00;
        ...
        Tail(S, 22)
        *************************************************************************/
        private static double w22(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
            ...
            if (w >= 126) r = -6.931e-01;

            if (w == 125) r = -7.189e-01;

            if (w == 124) r = -7.452e-01;

            if (w == 123) r = -7.722e-01;

            if (w == 122) r = -7.999e-01;

            if (w == 121) r = -8.283e-01;

            if (w == 120) r = -8.573e-01;

            if (w == 119) r = -8.871e-01;

            if (w == 118) r = -9.175e-01;

            if (w == 117) r = -9.486e-01;

            if (w == 116) r = -9.805e-01;

            if (w == 115) r = -1.013e+00;

            if (w == 114) r = -1.046e+00;

            if (w == 113) r = -1.080e+00;

            if (w == 112) r = -1.115e+00;

            if (w == 111) r = -1.151e+00;

            if (w == 110) r = -1.187e+00;

            if (w == 109) r = -1.224e+00;

            if (w == 108) r = -1.262e+00;

            if (w == 107) r = -1.301e+00;

            if (w == 106) r = -1.340e+00;

            if (w == 105) r = -1.381e+00;

            if (w == 104) r = -1.422e+00;

            if (w == 103) r = -1.464e+00;

            if (w == 102) r = -1.506e+00;

            if (w == 101) r = -1.550e+00;

            if (w == 100) r = -1.594e+00;
        ...
        Tail(S, 23)
        *************************************************************************/
        private static double w23(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
            ...
            if (w >= 138) r = -6.813e-01;

            if (w == 137) r = -7.051e-01;

            if (w == 136) r = -7.295e-01;

            if (w == 135) r = -7.544e-01;

            if (w == 134) r = -7.800e-01;

            if (w == 133) r = -8.061e-01;

            if (w == 132) r = -8.328e-01;

            if (w == 131) r = -8.601e-01;

            if (w == 130) r = -8.880e-01;

            if (w == 129) r = -9.166e-01;

            if (w == 128) r = -9.457e-01;

            if (w == 127) r = -9.755e-01;

            if (w == 126) r = -1.006e+00;

            if (w == 125) r = -1.037e+00;

            if (w == 124) r = -1.069e+00;

            if (w == 123) r = -1.101e+00;

            if (w == 122) r = -1.134e+00;

            if (w == 121) r = -1.168e+00;

            if (w == 120) r = -1.202e+00;

            if (w == 119) r = -1.237e+00;

            if (w == 118) r = -1.273e+00;

            if (w == 117) r = -1.309e+00;

            if (w == 116) r = -1.347e+00;

            if (w == 115) r = -1.384e+00;

            if (w == 114) r = -1.423e+00;

            if (w == 113) r = -1.462e+00;

            if (w == 112) r = -1.502e+00;

            if (w == 111) r = -1.543e+00;

            if (w == 110) r = -1.585e+00;

            if (w == 109) r = -1.627e+00;

            if (w == 108) r = -1.670e+00;

            if (w == 107) r = -1.714e+00;

            if (w == 106) r = -1.758e+00;

            if (w == 105) r = -1.804e+00;

            if (w == 104) r = -1.850e+00;

            if (w == 103) r = -1.897e+00;

            if (w == 102) r = -1.944e+00;

            if (w == 101) r = -1.993e+00;

            if (w == 100) r = -2.042e+00;
        ...
        Tail(S, 24)
        *************************************************************************/
        private static double w24(double s, xparams _params)
        {
            double result = 0;
            var w = 0;
            double r = 0;
            ...
            if (w >= 150) r = -6.820e-01;

            if (w == 149) r = -7.044e-01;

            if (w == 148) r = -7.273e-01;

            if (w == 147) r = -7.507e-01;

            if (w == 146) r = -7.746e-01;

            if (w == 145) r = -7.990e-01;

            if (w == 144) r = -8.239e-01;

            if (w == 143) r = -8.494e-01;

            if (w == 142) r = -8.754e-01;

            if (w == 141) r = -9.020e-01;

            if (w == 140) r = -9.291e-01;

            if (w == 139) r = -9.567e-01;

            if (w == 138) r = -9.849e-01;

            if (w == 137) r = -1.014e+00;

            if (w == 136) r = -1.043e+00;

            if (w == 135) r = -1.073e+00;

            if (w == 134) r = -1.103e+00;

            if (w == 133) r = -1.135e+00;

            if (w == 132) r = -1.166e+00;

            if (w == 131) r = -1.198e+00;

            if (w == 130) r = -1.231e+00;

            if (w == 129) r = -1.265e+00;

            if (w == 128) r = -1.299e+00;

            if (w == 127) r = -1.334e+00;

            if (w == 126) r = -1.369e+00;

            if (w == 125) r = -1.405e+00;

            if (w == 124) r = -1.441e+00;

            if (w == 123) r = -1.479e+00;

            if (w == 122) r = -1.517e+00;

            if (w == 121) r = -1.555e+00;

            if (w == 120) r = -1.594e+00;

            if (w == 119) r = -1.634e+00;

            if (w == 118) r = -1.675e+00;

            if (w == 117) r = -1.716e+00;

            if (w == 116) r = -1.758e+00;

            if (w == 115) r = -1.800e+00;

            if (w == 114) r = -1.844e+00;

            if (w == 113) r = -1.888e+00;

            if (w == 112) r = -1.932e+00;

            if (w == 111) r = -1.978e+00;

            if (w == 110) r = -2.024e+00;

            if (w == 109) r = -2.070e+00;

            if (w == 108) r = -2.118e+00;

            if (w == 107) r = -2.166e+00;

            if (w == 106) r = -2.215e+00;

            if (w == 105) r = -2.265e+00;

            if (w == 104) r = -2.316e+00;

            if (w == 103) r = -2.367e+00;

            if (w == 102) r = -2.419e+00;

            if (w == 101) r = -2.472e+00;

            if (w == 100) r = -2.526e+00;
        ...
        Tail(S, 25)
        *************************************************************************/
        private static double w25(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 26)
        *************************************************************************/
        private static double w26(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 27)
        *************************************************************************/
        private static double w27(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 28)
        *************************************************************************/
        private static double w28(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 29)
        *************************************************************************/
        private static double w29(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 30)
        *************************************************************************/
        private static double w30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 40)
        *************************************************************************/
        private static double w40(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 60)
        *************************************************************************/
        private static double w60(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 120)
        *************************************************************************/
        private static double w120(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 200)
        *************************************************************************/
        private static double w200(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S,N), S>=0
        *************************************************************************/
        private static double wsigma(double s, int n, xparams _params)
        {
            double result = 0;
            double f0 = 0;
            double f1 = 0;
            ...
            result = 0;
            if (n == 5) result = w5(s, _params);

            if (n == 6) result = w6(s, _params);

            if (n == 7) result = w7(s, _params);

            if (n == 8) result = w8(s, _params);

            if (n == 9) result = w9(s, _params);

            if (n == 10) result = w10(s, _params);

            if (n == 11) result = w11(s, _params);

            if (n == 12) result = w12(s, _params);

            if (n == 13) result = w13(s, _params);

            if (n == 14) result = w14(s, _params);

            if (n == 15) result = w15(s, _params);

            if (n == 16) result = w16(s, _params);

            if (n == 17) result = w17(s, _params);

            if (n == 18) result = w18(s, _params);

            if (n == 19) result = w19(s, _params);

            if (n == 20) result = w20(s, _params);

            if (n == 21) result = w21(s, _params);

            if (n == 22) result = w22(s, _params);

            if (n == 23) result = w23(s, _params);

            if (n == 24) result = w24(s, _params);

            if (n == 25) result = w25(s, _params);

            if (n == 26) result = w26(s, _params);

            if (n == 27) result = w27(s, _params);

            if (n == 28) result = w28(s, _params);

            if (n == 29) result = w29(s, _params);

            if (n == 30) result = w30(s, _params);
    ...
    public class mannwhitneyu
    {
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            for (i = 0; i <= tiecount - 1; i++) tmp = tmp - tiesize[i] * (math.sqr(tiesize[i]) - 1) / 12;
        ...
        Sequential Chebyshev interpolation.
        *************************************************************************/
        private static void ucheb(double x, double c, ref double tj, ref double tj1, ref double r, xparams _params)
        {
            double t = 0;
        ...
        *************************************************************************/
        private static double uninterpolate(double p1, double p2, double p3, int n, xparams _params)
        {
            double result = 0;
            double t1 = 0;
            double t2 = 0;
        ...
        Tail(0, N1, N2)
        *************************************************************************/
        private static double usigma000(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(0.75, N1, N2)
        *************************************************************************/
        private static double usigma075(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(1.5, N1, N2)
        *************************************************************************/
        private static double usigma150(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(2.25, N1, N2)
        *************************************************************************/
        private static double usigma225(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(3.0, N1, N2)
        *************************************************************************/
        private static double usigma300(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(3.33, N1, N2)
        *************************************************************************/
        private static double usigma333(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(3.66, N1, N2)
        *************************************************************************/
        private static double usigma367(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(4.0, N1, N2)
        *************************************************************************/
        private static double usigma400(int n1, int n2, xparams _params)
        {
            double result = 0;
            double p1 = 0;
            double p2 = 0;
        ...
        Tail(S, 5, 5)
        *************************************************************************/
        private static double utbln5n5(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 6)
        *************************************************************************/
        private static double utbln5n6(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 7)
        *************************************************************************/
        private static double utbln5n7(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 8)
        *************************************************************************/
        private static double utbln5n8(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 9)
        *************************************************************************/
        private static double utbln5n9(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 10)
        *************************************************************************/
        private static double utbln5n10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 11)
        *************************************************************************/
        private static double utbln5n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 12)
        *************************************************************************/
        private static double utbln5n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 13)
        *************************************************************************/
        private static double utbln5n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 14)
        *************************************************************************/
        private static double utbln5n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 15)
        *************************************************************************/
        private static double utbln5n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 16)
        *************************************************************************/
        private static double utbln5n16(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 17)
        *************************************************************************/
        private static double utbln5n17(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 18)
        *************************************************************************/
        private static double utbln5n18(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 19)
        *************************************************************************/
        private static double utbln5n19(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 20)
        *************************************************************************/
        private static double utbln5n20(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 21)
        *************************************************************************/
        private static double utbln5n21(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 22)
        *************************************************************************/
        private static double utbln5n22(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 23)
        *************************************************************************/
        private static double utbln5n23(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 24)
        *************************************************************************/
        private static double utbln5n24(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 25)
        *************************************************************************/
        private static double utbln5n25(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 26)
        *************************************************************************/
        private static double utbln5n26(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 27)
        *************************************************************************/
        private static double utbln5n27(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 28)
        *************************************************************************/
        private static double utbln5n28(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 29)
        *************************************************************************/
        private static double utbln5n29(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 30)
        *************************************************************************/
        private static double utbln5n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 5, 100)
        *************************************************************************/
        private static double utbln5n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 6)
        *************************************************************************/
        private static double utbln6n6(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 7)
        *************************************************************************/
        private static double utbln6n7(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 8)
        *************************************************************************/
        private static double utbln6n8(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 9)
        *************************************************************************/
        private static double utbln6n9(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 10)
        *************************************************************************/
        private static double utbln6n10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 11)
        *************************************************************************/
        private static double utbln6n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 12)
        *************************************************************************/
        private static double utbln6n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 13)
        *************************************************************************/
        private static double utbln6n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 14)
        *************************************************************************/
        private static double utbln6n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 15)
        *************************************************************************/
        private static double utbln6n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 30)
        *************************************************************************/
        private static double utbln6n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 6, 100)
        *************************************************************************/
        private static double utbln6n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 7)
        *************************************************************************/
        private static double utbln7n7(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 8)
        *************************************************************************/
        private static double utbln7n8(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 9)
        *************************************************************************/
        private static double utbln7n9(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 10)
        *************************************************************************/
        private static double utbln7n10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 11)
        *************************************************************************/
        private static double utbln7n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 12)
        *************************************************************************/
        private static double utbln7n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 13)
        *************************************************************************/
        private static double utbln7n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 14)
        *************************************************************************/
        private static double utbln7n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 15)
        *************************************************************************/
        private static double utbln7n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 30)
        *************************************************************************/
        private static double utbln7n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 7, 100)
        *************************************************************************/
        private static double utbln7n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 8)
        *************************************************************************/
        private static double utbln8n8(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 9)
        *************************************************************************/
        private static double utbln8n9(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 10)
        *************************************************************************/
        private static double utbln8n10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 11)
        *************************************************************************/
        private static double utbln8n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 12)
        *************************************************************************/
        private static double utbln8n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 13)
        *************************************************************************/
        private static double utbln8n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 14)
        *************************************************************************/
        private static double utbln8n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 15)
        *************************************************************************/
        private static double utbln8n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 30)
        *************************************************************************/
        private static double utbln8n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 8, 100)
        *************************************************************************/
        private static double utbln8n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 9)
        *************************************************************************/
        private static double utbln9n9(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 10)
        *************************************************************************/
        private static double utbln9n10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 11)
        *************************************************************************/
        private static double utbln9n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 12)
        *************************************************************************/
        private static double utbln9n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 13)
        *************************************************************************/
        private static double utbln9n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 14)
        *************************************************************************/
        private static double utbln9n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 15)
        *************************************************************************/
        private static double utbln9n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 30)
        *************************************************************************/
        private static double utbln9n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 9, 100)
        *************************************************************************/
        private static double utbln9n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 10)
        *************************************************************************/
        private static double utbln10n10(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 11)
        *************************************************************************/
        private static double utbln10n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 12)
        *************************************************************************/
        private static double utbln10n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 13)
        *************************************************************************/
        private static double utbln10n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 14)
        *************************************************************************/
        private static double utbln10n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 15)
        *************************************************************************/
        private static double utbln10n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 30)
        *************************************************************************/
        private static double utbln10n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 10, 100)
        *************************************************************************/
        private static double utbln10n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 11)
        *************************************************************************/
        private static double utbln11n11(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 12)
        *************************************************************************/
        private static double utbln11n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 13)
        *************************************************************************/
        private static double utbln11n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 14)
        *************************************************************************/
        private static double utbln11n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 15)
        *************************************************************************/
        private static double utbln11n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 30)
        *************************************************************************/
        private static double utbln11n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 11, 100)
        *************************************************************************/
        private static double utbln11n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 12, 12)
        *************************************************************************/
        private static double utbln12n12(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 12, 13)
        *************************************************************************/
        private static double utbln12n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 12, 14)
        *************************************************************************/
        private static double utbln12n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 12, 15)
        *************************************************************************/
        private static double utbln12n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 12, 30)
        *************************************************************************/
        private static double utbln12n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 12, 100)
        *************************************************************************/
        private static double utbln12n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 13, 13)
        *************************************************************************/
        private static double utbln13n13(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 13, 14)
        *************************************************************************/
        private static double utbln13n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 13, 15)
        *************************************************************************/
        private static double utbln13n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 13, 30)
        *************************************************************************/
        private static double utbln13n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 13, 100)
        *************************************************************************/
        private static double utbln13n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 14, 14)
        *************************************************************************/
        private static double utbln14n14(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 14, 15)
        *************************************************************************/
        private static double utbln14n15(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 14, 30)
        *************************************************************************/
        private static double utbln14n30(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, 14, 100)
        *************************************************************************/
        private static double utbln14n100(double s, xparams _params)
        {
            double result = 0;
            double x = 0;
            double tj = 0;
        ...
        Tail(S, N1, N2)
        *************************************************************************/
        private static double usigma(double s, int n1, int n2, xparams _params)
        {
            double result = 0;
            double f0 = 0;
            double f1 = 0;
            ...
            if (Math.Min(n1, n2) == 5)
            {
                if (Math.Max(n1, n2) == 5) result = utbln5n5(s, _params);

                if (Math.Max(n1, n2) == 6) result = utbln5n6(s, _params);

                if (Math.Max(n1, n2) == 7) result = utbln5n7(s, _params);

                if (Math.Max(n1, n2) == 8) result = utbln5n8(s, _params);

                if (Math.Max(n1, n2) == 9) result = utbln5n9(s, _params);

                if (Math.Max(n1, n2) == 10) result = utbln5n10(s, _params);

                if (Math.Max(n1, n2) == 11) result = utbln5n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln5n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln5n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln5n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln5n15(s, _params);

                if (Math.Max(n1, n2) == 16) result = utbln5n16(s, _params);

                if (Math.Max(n1, n2) == 17) result = utbln5n17(s, _params);

                if (Math.Max(n1, n2) == 18) result = utbln5n18(s, _params);

                if (Math.Max(n1, n2) == 19) result = utbln5n19(s, _params);

                if (Math.Max(n1, n2) == 20) result = utbln5n20(s, _params);

                if (Math.Max(n1, n2) == 21) result = utbln5n21(s, _params);

                if (Math.Max(n1, n2) == 22) result = utbln5n22(s, _params);

                if (Math.Max(n1, n2) == 23) result = utbln5n23(s, _params);

                if (Math.Max(n1, n2) == 24) result = utbln5n24(s, _params);

                if (Math.Max(n1, n2) == 25) result = utbln5n25(s, _params);

                if (Math.Max(n1, n2) == 26) result = utbln5n26(s, _params);

                if (Math.Max(n1, n2) == 27) result = utbln5n27(s, _params);

                if (Math.Max(n1, n2) == 28) result = utbln5n28(s, _params);

                if (Math.Max(n1, n2) == 29) result = utbln5n29(s, _params);
            ...
            if (Math.Min(n1, n2) == 6)
            {
                if (Math.Max(n1, n2) == 6) result = utbln6n6(s, _params);

                if (Math.Max(n1, n2) == 7) result = utbln6n7(s, _params);

                if (Math.Max(n1, n2) == 8) result = utbln6n8(s, _params);

                if (Math.Max(n1, n2) == 9) result = utbln6n9(s, _params);

                if (Math.Max(n1, n2) == 10) result = utbln6n10(s, _params);

                if (Math.Max(n1, n2) == 11) result = utbln6n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln6n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln6n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln6n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln6n15(s, _params);
            ...
            if (Math.Min(n1, n2) == 7)
            {
                if (Math.Max(n1, n2) == 7) result = utbln7n7(s, _params);

                if (Math.Max(n1, n2) == 8) result = utbln7n8(s, _params);

                if (Math.Max(n1, n2) == 9) result = utbln7n9(s, _params);

                if (Math.Max(n1, n2) == 10) result = utbln7n10(s, _params);

                if (Math.Max(n1, n2) == 11) result = utbln7n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln7n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln7n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln7n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln7n15(s, _params);
            ...
            if (Math.Min(n1, n2) == 8)
            {
                if (Math.Max(n1, n2) == 8) result = utbln8n8(s, _params);

                if (Math.Max(n1, n2) == 9) result = utbln8n9(s, _params);

                if (Math.Max(n1, n2) == 10) result = utbln8n10(s, _params);

                if (Math.Max(n1, n2) == 11) result = utbln8n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln8n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln8n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln8n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln8n15(s, _params);
            ...
            if (Math.Min(n1, n2) == 9)
            {
                if (Math.Max(n1, n2) == 9) result = utbln9n9(s, _params);

                if (Math.Max(n1, n2) == 10) result = utbln9n10(s, _params);

                if (Math.Max(n1, n2) == 11) result = utbln9n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln9n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln9n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln9n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln9n15(s, _params);
            ...
            {
                if (Math.Max(n1, n2) == 10) result = utbln10n10(s, _params);

                if (Math.Max(n1, n2) == 11) result = utbln10n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln10n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln10n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln10n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln10n15(s, _params);
            ...
            {
                if (Math.Max(n1, n2) == 11) result = utbln11n11(s, _params);

                if (Math.Max(n1, n2) == 12) result = utbln11n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln11n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln11n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln11n15(s, _params);
            ...
            {
                if (Math.Max(n1, n2) == 12) result = utbln12n12(s, _params);

                if (Math.Max(n1, n2) == 13) result = utbln12n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln12n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln12n15(s, _params);
            ...
            {
                if (Math.Max(n1, n2) == 13) result = utbln13n13(s, _params);

                if (Math.Max(n1, n2) == 14) result = utbln13n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln13n15(s, _params);
            ...
            {
                if (Math.Max(n1, n2) == 14) result = utbln14n14(s, _params);

                if (Math.Max(n1, n2) == 15) result = utbln14n15(s, _params);
    ...
    public class stest
    {
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            for (i = 0; i <= n - 1; i++)
            {
                if (x[i] > median) gtcnt = gtcnt + 1;

                if (x[i] != median) necnt = necnt + 1;
            }
    ...
    public class studentttests
    {
        ...
        NOTE: this function correctly handles degenerate cases:
          ...
          -- ALGLIB --
             Copyright 08.09.2006 by Bochkanov Sergey
        *************************************************************************/
        public static void studentttest1(double[] x, int n, double mean, ref double bothtails, ref double lefttail, ref double righttail,
            xparams _params)
        {
            var i = 0;
            double xmean = 0;
            ...
            {
                v1 = 0;
                for (i = 0; i <= n - 1; i++) v1 = v1 + math.sqr(x[i] - xmean);

                v2 = 0;
                for (i = 0; i <= n - 1; i++) v2 = v2 + (x[i] - xmean);
        ...
        *************************************************************************/
            ...
            xparams _params)
        {
            ...
            if (n + m > 2)
            {
                for (i = 0; i <= n - 1; i++) s = s + math.sqr(x[i] - xmean);

                for (i = 0; i <= m - 1; i++) s = s + math.sqr(y[i] - ymean);

                s = Math.Sqrt(s * (1 / (double)n + 1 / (double)m) / (n + m - 2));
            }
